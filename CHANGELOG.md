...
- The mbeddr search tool was improved: It can now also search languages, the project and globally. It also got options for approximate searching with an error distance, and matching the case. The UI was also improved.
