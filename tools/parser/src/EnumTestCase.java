		...
		astTranslationUnit.accept(new ASTVisitor(true) {
			...
			public int visit(IASTDeclaration x) {
				...
				if(IASTSimpleDeclaration.class.isInstance(x)){
					...
					//Enum Specification
					if(IASTEnumerationSpecifier.class.isInstance(simpleDeclaration.getDeclSpecifier())){
						IASTEnumerationSpecifier enumSpec = (IASTEnumerationSpecifier) simpleDeclaration.getDeclSpecifier();
						System.out.println(enumSpec.getName());
						for(IASTEnumerator enumerator : enumSpec.getEnumerators()){
							StringBuilder enumString = new StringBuilder();
							enumString.append(enumerator.getName());
							if(enumerator.getValue()!=null){
								
								//value can be CASTLiteralExpression or CASTBinaryExpression
								enumString.append( "=" + enumerator.getValue().getClass().getName());
								enumString.append("(" + enumerator.getValue().isLValue() +  ")");
							}
							System.out.print(enumString +" ");
