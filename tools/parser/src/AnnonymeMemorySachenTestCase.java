...
public class AnnonymeMemorySachenTestCase extends TestCase {
 ...
 * 	  union {
	    struct {
	      volatile int WDTCTL_L;
	      volatile int WDTCTL_H;
	      union {
	    	  volatile int WDTCTL_L2;
	    	  volatile int WDTCTL_H2;
	      };
	    };
	    volatile int WDTCTL;
	  };
 */
		...
		content.append(" 		volatile int WDTCTL_L;\n");
		content.append(" 		volatile int WDTCTL_H;\n");
		content.append("		union { \n");
		content.append("			volatile int WDTCTL_L2; \n");
		content.append(" 			volatile int WDTCTL_H2;\n");
		content.append("		};\n");
		content.append("	}; \n");	
		content.append("volatile int WDTCTL; \n");
		content.append("}; \n");
