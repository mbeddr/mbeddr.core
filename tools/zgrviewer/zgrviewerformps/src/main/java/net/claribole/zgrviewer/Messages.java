 ...
 * 
 *   $Id: Messages.java 4628 2011-10-19 10:59:16Z epietrig $
 */ 
...
public class Messages {
    ...
    public static final String PM_FILE = "Rendering...";
    ...
    public static final Point2D.Double[] mainMenuLabelOffsets = {new Point2D.Double(0, 0),
    	new Point2D.Double(0, 0),new Point2D.Double(0, 0), new Point2D.Double(0, -10)};
    ...
    public static final String[] fileMenuLabels = {PM_OPENCIRCOSVG, PM_OPENDOTSVG,
					    PM_OPENNEATOSVG, PM_OPENTWOPISVG};
    public static final Point2D.Double[] fileMenuLabelOffsets = {new Point2D.Double(0, 0), new Point2D.Double(0, 0),
