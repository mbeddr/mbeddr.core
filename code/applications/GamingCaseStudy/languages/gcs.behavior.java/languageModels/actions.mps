...
<model modelUID="r:0bae2136-8084-4816-bf95-5d3c8da6c3e5(gcs.behavior.java.actions)">
  ...
  <roots>
    ...
    <node type="tpdg.NodeSubstituteActions" typeId="tpdg.1112056943463" id="6252690454507665898">
      <property name="name" nameId="tpck.1169194664001" value="makeValueFromExpression" />
    </node>
  </roots>
  ...
  <root id="6252690454507665898">
    <node role="actionsBuilder" roleId="tpdg.1112058057696" type="tpdg.NodeSubstituteActionsBuilder" typeId="tpdg.1112058030570" id="6252690454507665899">
      <link role="applicableConcept" roleId="tpdg.1112058088712" targetNodeId="qk4j.9051107737456901641" resolveInfo="Value" />
      <node role="part" roleId="tpdg.1177324142645" type="tpdg.AddMenuPart" typeId="tpdg.1177323996388" id="6252690454507665901">
        <link role="concept" roleId="tpdg.1177333551023" targetNodeId="qk4j.9051107737456901641" resolveInfo="Value" />
        <node role="part" roleId="tpdg.1177333559040" type="tpdg.WrapperSubstituteMenuPart" typeId="tpdg.1177402519659" id="6252690454507665902">
          <link role="wrappedConcept" roleId="tpdg.1177402731616" targetNodeId="tpee.1068431790191" resolveInfo="Expression" />
          <node role="wrapperBlock" roleId="tpdg.1177402719158" type="tpdg.QueryFunction_SubstituteWrapper" typeId="tpdg.1177402571666" id="6252690454507665903">
            <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="6252690454507665904">
              <node role="statement" roleId="tpee.1068581517665" type="tpee.LocalVariableDeclarationStatement" typeId="tpee.1068581242864" id="6252690454507665905">
                <node role="localVariableDeclaration" roleId="tpee.1068581242865" type="tpee.LocalVariableDeclaration" typeId="tpee.1068581242863" id="6252690454507665906">
                  <property name="name" nameId="tpck.1169194664001" value="ev" />
                  <node role="type" roleId="tpee.5680397130376446158" type="tp25.SNodeType" typeId="tp25.1138055754698" id="6252690454507665907">
                    <link role="concept" roleId="tp25.1138405853777" targetNodeId="o2lk.6252690454507665893" resolveInfo="ExpressionValue" />
                  </node>
                  <node role="initializer" roleId="tpee.1068431790190" type="tpee.GenericNewExpression" typeId="tpee.1145552977093" id="6252690454507665909">
                    <node role="creator" roleId="tpee.1145553007750" type="tp25.SNodeCreator" typeId="tp25.1180636770613" id="6252690454507665910">
                      <node role="createdType" roleId="tp25.1180636770616" type="tp25.SNodeType" typeId="tp25.1138055754698" id="6252690454507665911">
                        <link role="concept" roleId="tp25.1138405853777" targetNodeId="o2lk.6252690454507665893" resolveInfo="ExpressionValue" />
                      </node>
                    </node>
                  </node>
              ...
              <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="6252690454507665913">
                <node role="expression" roleId="tpee.1068580123156" type="tpee.AssignmentExpression" typeId="tpee.1068498886294" id="6252690454507665962">
                  <node role="rValue" roleId="tpee.1068498886297" type="tpdg.ConceptFunctionParameter_nodeToWrap" typeId="tpdg.1177402641904" id="6252690454507665972" />
                  <node role="lValue" roleId="tpee.1068498886295" type="tpee.DotExpression" typeId="tpee.1197027756228" id="6252690454507665935">
                    <node role="operand" roleId="tpee.1197027771414" type="tpee.LocalVariableReference" typeId="tpee.1068581242866" id="6252690454507665914">
                      <link role="variableDeclaration" roleId="tpee.1068581517664" targetNodeId="6252690454507665906" resolveInfo="ev" />
                    </node>
                    <node role="operation" roleId="tpee.1197027833540" type="tp25.SLinkAccess" typeId="tp25.1138056143562" id="6252690454507665940">
                      <link role="link" roleId="tp25.1138056516764" targetNodeId="o2lk.6252690454507665894" />
                    </node>
                  </node>
                </node>
              </node>
              <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="6252690454507665974">
                <node role="expression" roleId="tpee.1068580123156" type="tpee.LocalVariableReference" typeId="tpee.1068581242866" id="6252690454507665975">
                  <link role="variableDeclaration" roleId="tpee.1068581517664" targetNodeId="6252690454507665906" resolveInfo="ev" />
                </node>
              </node>
            </node>
