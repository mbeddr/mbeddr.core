...
<model modelUID="r:67845f5a-2bc2-49dc-a52e-1a21b8705707(gcs.behavior.java.constraints)">
  ...
  <roots>
    ...
    <node type="tp1t.ConceptConstraints" typeId="tp1t.1213093968558" id="5710945123077824121">
      <link role="concept" roleId="tp1t.1213093996982" targetNodeId="o2lk.5710945123077823872" resolveInfo="SubjectExpression" />
    </node>
  </roots>
  ...
  <root id="5710945123077824121">
    <node role="canBeChild" roleId="tp1t.1213106463729" type="tp1t.ConstraintFunction_CanBeAChild" typeId="tp1t.1202989531578" id="5710945123077824122">
      <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="5710945123077824123">
        <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="5710945123077824124">
          <node role="expression" roleId="tpee.1068580123156" type="tpee.DotExpression" typeId="tpee.1197027756228" id="5710945123077824179">
            <node role="operand" roleId="tpee.1197027771414" type="tpee.DotExpression" typeId="tpee.1197027756228" id="5710945123077824146">
              <node role="operand" roleId="tpee.1197027771414" type="tp1t.ConstraintFunctionParameter_parentNode" typeId="tp1t.1202989658459" id="5710945123077824125" />
              <node role="operation" roleId="tpee.1197027833540" type="tp25.Node_GetAncestorOperation" typeId="tp25.1171407110247" id="5710945123077824152">
                <node role="parameter" roleId="tp25.1144104376918" type="tp25.OperationParm_Concept" typeId="tp25.1144101972840" id="5710945123077824153">
                  <node role="conceptArgument" roleId="tp25.1207343664468" type="tp25.RefConcept_Reference" typeId="tp25.1177026924588" id="5710945123077824156">
                    <link role="conceptDeclaration" roleId="tp25.1177026940964" targetNodeId="qk4j.5710945123077618075" resolveInfo="Reaction" />
                  </node>
                </node>
                <node role="parameter" roleId="tp25.1144104376918" type="tp25.OperationParm_Inclusion" typeId="tp25.1144100932627" id="5710945123077824158" />
              </node>
            </node>
            <node role="operation" roleId="tpee.1197027833540" type="tp25.Node_IsNotNullOperation" typeId="tp25.1172008320231" id="5710945123077824185" />
          </node>
        </node>
      </node>
    </node>
