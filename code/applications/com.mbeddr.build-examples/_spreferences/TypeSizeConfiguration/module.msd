...
<solution name="com.mbeddr.build-examples.__spreferences.TypeSizeConfiguration" uuid="~_PreferencesModule#com.mbeddr.build-examples.__spreferences.TypeSizeConfiguration" moduleVersion="0" compileInMPS="true">
  <models>
