...
<solution name="com.mbeddr.build-examples.__spreferences.CodeReviewPreferences" uuid="~_PreferencesModule#com.mbeddr.build-examples.__spreferences.CodeReviewPreferences" moduleVersion="0">
  <models>
