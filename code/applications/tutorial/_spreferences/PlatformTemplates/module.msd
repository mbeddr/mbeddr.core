...
<solution name="tutorial.__spreferences.PlatformTemplates" uuid="~_PreferencesModule#tutorial.__spreferences.PlatformTemplates" moduleVersion="0" compileInMPS="true">
  <models>
