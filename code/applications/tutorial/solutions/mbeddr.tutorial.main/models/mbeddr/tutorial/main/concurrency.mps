...
<model ref="r:72d1365c-e40d-4315-b1a2-56c542f334f3(mbeddr.tutorial.main.concurrency)">
  ...
  <node concept="N3F5e" id="73GSrjdv3PC">
    ...
    <node concept="N3Fnx" id="73GSrjdv4bA" role="N3F5h">
      <property role="TrG5h" value="main" />
      <property role="2OOxQR" value="true" />
      <node concept="3XIRFW" id="73GSrjdv4bC" role="3XIRFX">
        <node concept="2BFjQ_" id="73GSrjdv4bK" role="3XIRFZ">
          <node concept="3rBj6X" id="73GSrjdv5kI" role="2BFjQA">
            <node concept="3cM6IN" id="73GSrjdv5lA" role="3cM6Hi">
              <ref role="3cM6IK" node="4hMIGYxmNE9" resolve="eventsTest" />
            </node>
            <node concept="3cM6IN" id="73GSrjdv5nm" role="3cM6Hi">
              <ref role="3cM6IK" node="1zeZsIba3xT" resolve="queueTest" />
            </node>
          </node>
        </node>
      </node>
      <node concept="26Vqph" id="73GSrjdv4bE" role="2C2TGm">
        <property role="2caQfQ" value="false" />
        <property role="2c7vTL" value="false" />
      </node>
      <node concept="19RgSI" id="73GSrjdv4bF" role="1UOdpc">
        <property role="TrG5h" value="argc" />
        <node concept="26Vqph" id="73GSrjdv4bG" role="2C2TGm">
          <property role="2caQfQ" value="false" />
          <property role="2c7vTL" value="false" />
        </node>
      </node>
      <node concept="19RgSI" id="73GSrjdv4bH" role="1UOdpc">
        <property role="TrG5h" value="argv" />
        <node concept="3J0A42" id="73GSrjdv4bI" role="2C2TGm">
          <property role="2caQfQ" value="false" />
          <property role="2c7vTL" value="false" />
          <node concept="Pu267" id="73GSrjdv4bJ" role="2umbIo">
            <property role="2caQfQ" value="false" />
            <property role="2c7vTL" value="false" />
          </node>
        </node>
