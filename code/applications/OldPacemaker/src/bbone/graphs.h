...
#define ATRIAL_SENSE_PLOT_RED   0.0
#define ATRIAL_SENSE_PLOT_GREEN 0.1 
#define ATRIAL_SENSE_PLOT_BLUE  0.8

#define VENTRICLE_SENSE_PLOT_RED   0.0 
#define VENTRICLE_SENSE_PLOT_GREEN 0.8 
#define VENTRICLE_SENSE_PLOT_BLUE  0.1

#define ATRIAL_GENERATE_PLOT_RED   0.0 
#define ATRIAL_GENERATE_PLOT_GREEN 0.1 
#define ATRIAL_GENERATE_PLOT_BLUE  0.8

#define VENTRICLE_GENERATE_PLOT_RED   0.0 
#define VENTRICLE_GENERATE_PLOT_GREEN 0.8 
#define VENTRICLE_GENERATE_PLOT_BLUE  0.1
