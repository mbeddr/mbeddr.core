...
<solution name="Pacemaker_verified" uuid="aa033d8e-00f9-405c-bdb3-6e8891bf2a2c" compileInMPS="true">
  <models>
    <modelRoot path="${solution_descriptor}/models" />
  </models>
  <sourcePath />
  <dependencies>
    <dependency reexport="false">6c9c8730-67ba-490e-a12d-428d02d7787f(Pacemaker.main)</dependency>
  </dependencies>
  <usedLanguages>
