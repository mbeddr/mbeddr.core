 ...
 *  _and_ the '**src**' folder - in which the project sources (3 subdirectories for each enviroment : 2 for PIC and 1 for BeagleBone) reside.

# Where to now ?
- - -
If you want to reproduce our result, we highly recomand reading the doc's folder.
