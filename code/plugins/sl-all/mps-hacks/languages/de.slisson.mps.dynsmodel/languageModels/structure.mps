...
<model ref="r:e741f24c-b119-4028-811f-9d3e95ed2551(de.slisson.mps.dynsmodel.structure)">
  ...
  <node concept="1TIwiD" id="7q7LIEyzauR">
    ...
    <node concept="1TJgyi" id="7q7LIEyAvC3" role="1TKVEl">
      <property role="TrG5h" value="genuineRole" />
      <ref role="AX2Wp" to="tpck:fKAOsGN" resolve="string" />
    </node>
    <node concept="1TJgyi" id="7q7LIEyzavQ" role="1TKVEl">
      <property role="TrG5h" value="typeFqName" />
      <ref role="AX2Wp" to="tpck:fKAOsGN" resolve="string" />
    </node>
    <node concept="1TJgyi" id="7q7LIEy_iMT" role="1TKVEl">
      <property role="TrG5h" value="isReference" />
      <ref role="AX2Wp" to="tpck:fKAQMTB" resolve="boolean" />
    </node>
    <node concept="PrWs8" id="7q7LIEyzavF" role="PzmwI">
      <ref role="PrY4T" to="tpee:hqOqG0K" resolve="IOperation" />
    </node>
  </node>
</model>
