...
<model ref="r:bbc16425-cfa0-4315-9fbd-122b8e55d6af(de.itemis.mps.editor.math.java.actions)">
  ...
  <imports>
    ...
    <import index="9hps" ref="r:bc7365b7-68e1-49fb-97fe-dd599a24afe5(de.itemis.mps.editor.math.java.editor)" />
  </imports>
  <registry>
      ...
      <node concept="3UNGvq" id="4Ajzui6RoTa" role="8Wnug">
        ...
        <node concept="tYCnQ" id="4Ajzui6RoUL" role="_1QTJ">
          ...
          <node concept="Cmt7Y" id="4Ajzui6RoUN" role="uz6Si">
            ...
            <node concept="xBawi" id="4iNiUqGz3xs" role="lGtFl">
              <ref role="xBaxx" to="9hps:4iNiUqGz3wT" />
            </node>
          </node>
        </node>
        <node concept="xBawi" id="4iNiUqGz3wS" role="lGtFl">
          <ref role="xBaxx" to="9hps:4iNiUqGz3wN" resolve="Expression_default_TransformMenu_Contribution" />
        </node>
      </node>
    </node>
  </node>
