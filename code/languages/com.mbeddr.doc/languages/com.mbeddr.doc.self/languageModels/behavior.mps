...
<model ref="r:92aadbd2-6705-46d9-9465-2defe0014409(com.mbeddr.doc.self.behavior)">
  ...
  <node concept="13h7C7" id="7$DvC4gQTVO">
    <ref role="13h7C2" to="z5ox:5$bT90ZcZti" resolve="SectionAsImageParagraph" />
    <node concept="13i0hz" id="7$DvC4gQTVR" role="13h7CS">
      <property role="TrG5h" value="uniqueName" />
      <node concept="3Tm1VV" id="7$DvC4gQTVS" role="1B3o_S" />
      <node concept="17QB3L" id="7$DvC4gQTVV" role="3clF45" />
      <node concept="3clFbS" id="7$DvC4gQTVU" role="3clF47">
        <node concept="3clFbF" id="7$DvC4gQTVW" role="3cqZAp">
          <node concept="3cpWs3" id="7$DvC4gQTWi" role="3clFbG">
            ...
            <node concept="Xl_RD" id="7$DvC4gQTVX" role="3uHU7B">
    ...
    <node concept="13hLZK" id="7$DvC4gQTVP" role="13h7CW">
      <node concept="3clFbS" id="7$DvC4gQTVQ" role="2VODD2" />
    </node>
  </node>
</model>
