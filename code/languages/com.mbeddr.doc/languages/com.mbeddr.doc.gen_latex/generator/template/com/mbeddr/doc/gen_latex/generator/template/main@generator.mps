...
<model modelUID="r:64ab5fae-7c1b-4d46-84f7-7027407a369b(com.mbeddr.doc.gen_latex.generator.template.main@generator)">
  ...
  <root type="tpf8.MappingConfiguration" typeId="tpf8.1095416546421" id="4457500422381351721" nodeInfo="ig">
    <property name="name" nameId="tpck.1169194664001" value="main" />
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="4457500422381362076" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.3350625596579911728" resolveInfo="Document" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="4457500422381362078" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="4457500422381362080" nodeInfo="ng">
          <property name="text" value="dummy" />
          <node role="smodelAttribute" type="tpf8.CopySrcListMacro" typeId="tpf8.1114729360583" id="4457500422381362082" nodeInfo="ln">
            <node role="sourceNodesQuery" roleId="tpf8.1168278589236" type="tpf8.SourceSubstituteMacro_SourceNodesQuery" typeId="tpf8.1167951910403" id="4457500422381362085" nodeInfo="in">
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="6165313375056119270" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.6165313375056119251" resolveInfo="CodeParagraph" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="6165313375056119272" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.LineList" id="4755612053022145919" nodeInfo="ng">
          <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="4755612053022293059" nodeInfo="ng" />
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="4755612053022145920" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="4755612053022145921" nodeInfo="ng">
              <property name="command" value="begin" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="4755612053022145922" nodeInfo="ng">
                <property name="text" value="lstlisting" />
              </node>
              <node role="options2" type=".com.mbeddr.doc.latex.structure.TextWord" id="4755612053022145923" nodeInfo="ng">
                <property name="text" value="language=mbeddr" />
                <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="4755612053022145924" nodeInfo="ln">
                  <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
                  <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
                  <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="4755612053022145925" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="6165313375056119274" nodeInfo="ng">
            <property name="text" value="text" />
            <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="6165313375056119284" nodeInfo="ln">
              <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
              <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381360575/4457500422381360577" />
              <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="6165313375056119287" nodeInfo="in">
                <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="6165313375056119288" nodeInfo="sn">
                  <node role="statement" roleId="tpee.1068581517665" type="tpee.IfStatement" typeId="tpee.1068580123159" id="5110473669965931313" nodeInfo="nn">
                    <node role="ifTrue" roleId="tpee.1068580123161" type="tpee.StatementList" typeId="tpee.1068580123136" id="5110473669965931316" nodeInfo="sn">
                      <node role="statement" roleId="tpee.1068581517665" type="tpee.ReturnStatement" typeId="tpee.1068581242878" id="5110473669965959907" nodeInfo="nn">
                        <node role="expression" roleId="tpee.1068581517676" type="tpee.StaticMethodCall" typeId="tpee.1081236700937" id="620304030112502832" nodeInfo="nn">
                          <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="81x8.620304030112432298" resolveInfo="escapeInListings" />
                          <link role="classConcept" roleId="tpee.1144433194310" targetNodeId="81x8.2042272859105555512" resolveInfo="LatexEscapeHelper" />
                          <node role="actualArgument" roleId="tpee.1068499141038" type="tpee.DotExpression" typeId="tpee.1197027756228" id="620304030112502833" nodeInfo="nn">
                            <node role="operand" roleId="tpee.1197027771414" type="tpee.DotExpression" typeId="tpee.1197027756228" id="620304030112502834" nodeInfo="nn">
                              <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="620304030112502835" nodeInfo="nn" />
                              <node role="operation" roleId="tpee.1197027833540" type="tp25.SPropertyAccess" typeId="tp25.1138056022639" id="620304030112502836" nodeInfo="nn">
                                <link role="property" roleId="tp25.1138056395725" targetNodeId="2c95.6165313375056119252" resolveInfo="text" />
                              </node>
                            </node>
                            <node role="operation" roleId="tpee.1197027833540" type="tpee.InstanceMethodCallOperation" typeId="tpee.1202948039474" id="620304030112502837" nodeInfo="nn">
                    ...
                    <node role="condition" roleId="tpee.1068580123160" type="tpee.DotExpression" typeId="tpee.1197027756228" id="5110473669965950294" nodeInfo="nn">
                      <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="5110473669965931332" nodeInfo="nn" />
                      <node role="operation" roleId="tpee.1197027833540" type="tp25.SPropertyAccess" typeId="tp25.1138056022639" id="5110473669965959889" nodeInfo="nn">
                        <link role="property" roleId="tp25.1138056395725" targetNodeId="2c95.5110473669965928545" resolveInfo="trim" />
                      </node>
                    </node>
                  </node>
                  <node role="statement" roleId="tpee.1068581517665" type="tpee.ReturnStatement" typeId="tpee.1068581242878" id="5110473669965959968" nodeInfo="nn">
                    <node role="expression" roleId="tpee.1068581517676" type="tpee.StaticMethodCall" typeId="tpee.1081236700937" id="620304030112505309" nodeInfo="nn">
                      <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="81x8.620304030112432298" resolveInfo="escapeInListings" />
                      <link role="classConcept" roleId="tpee.1144433194310" targetNodeId="81x8.2042272859105555512" resolveInfo="LatexEscapeHelper" />
                      <node role="actualArgument" roleId="tpee.1068499141038" type="tpee.DotExpression" typeId="tpee.1197027756228" id="620304030112505310" nodeInfo="nn">
                        <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="620304030112505311" nodeInfo="nn" />
                        <node role="operation" roleId="tpee.1197027833540" type="tp25.SPropertyAccess" typeId="tp25.1138056022639" id="620304030112505312" nodeInfo="nn">
                          <link role="property" roleId="tp25.1138056395725" targetNodeId="2c95.6165313375056119252" resolveInfo="text" />
                        </node>
                      </node>
                    </node>
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="4755612053022145982" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="4755612053022145983" nodeInfo="ng">
              <property name="command" value="end" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="4755612053022145984" nodeInfo="ng">
                <property name="text" value="lstlisting" />
              </node>
            </node>
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="4755612053022293061" nodeInfo="ng" />
        </node>
      </node>
    </node>
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="5378658552263133575" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.5378658552262903588" resolveInfo="Item" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="5378658552263133577" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.WordLine" id="5378658552263133579" nodeInfo="ng">
          <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="5378658552263133580" nodeInfo="ng">
            <property name="command" value="item" />
          </node>
          <node role="words" type=".com.mbeddr.doc.latex.structure.TextWord" id="5378658552263133582" nodeInfo="ng">
            <property name="text" value="text" />
            <node role="smodelAttribute" type="tpf8.CopySrcNodeMacro" typeId="tpf8.1114706874351" id="5378658552263133584" nodeInfo="ln">
              <node role="sourceNodeQuery" roleId="tpf8.1168024447342" type="tpf8.SourceSubstituteMacro_SourceNodeQuery" typeId="tpf8.1168024337012" id="5378658552263133587" nodeInfo="in">
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="5378658552263133551" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.5378658552262893169" resolveInfo="ItemList" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="5378658552263133553" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.LineList" id="5378658552263133555" nodeInfo="ng">
          <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="5785245534400445355" nodeInfo="ng" />
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="5378658552263133557" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="5378658552263133558" nodeInfo="ng">
              <property name="command" value="begin" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="5378658552263133559" nodeInfo="ng">
                <property name="text" value="itemize" />
              </node>
            </node>
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5378658552263133564" nodeInfo="ng">
            <property name="text" value="item" />
            <node role="smodelAttribute" type="tpf8.CopySrcListMacro" typeId="tpf8.1114729360583" id="5378658552263133566" nodeInfo="ln">
              <node role="sourceNodesQuery" roleId="tpf8.1168278589236" type="tpf8.SourceSubstituteMacro_SourceNodesQuery" typeId="tpf8.1167951910403" id="5378658552263133569" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="5378658552263133560" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="5378658552263133561" nodeInfo="ng">
              <property name="command" value="end" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="5378658552263133562" nodeInfo="ng">
                <property name="text" value="itemize" />
              </node>
            </node>
          </node>
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="4457500422381890599" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.4457500422381890585" resolveInfo="CompositeWord" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="4457500422381890602" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.WordList" id="4457500422381890604" nodeInfo="ng">
          <node role="words" type=".com.mbeddr.doc.latex.structure.TextWord" id="4457500422381890606" nodeInfo="ng">
            <property name="text" value="word" />
            <node role="smodelAttribute" type="tpf8.CopySrcListMacro" typeId="tpf8.1114729360583" id="4457500422381890608" nodeInfo="ln">
              <node role="sourceNodesQuery" roleId="tpf8.1168278589236" type="tpf8.SourceSubstituteMacro_SourceNodesQuery" typeId="tpf8.1167951910403" id="4457500422381890611" nodeInfo="in">
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="4457500422381390712" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.3350625596580108709" resolveInfo="SectRefWord" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="4457500422381390714" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.WordList" id="4457500422381390716" nodeInfo="ng">
          <node role="words" type=".com.mbeddr.doc.latex.structure.TextWord" id="4457500422381390718" nodeInfo="ng">
            <property name="text" value="Sect." />
            <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="4457500422381390800" nodeInfo="ln">
              <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
              <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
              <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="4457500422381390801" nodeInfo="in">
          ...
          <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="4457500422381390721" nodeInfo="ng">
            <property name="command" value="ref" />
            <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="4457500422381390722" nodeInfo="ng">
              <property name="text" value="word" />
              <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="4457500422381390723" nodeInfo="ln">
                <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
                <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
                <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="4457500422381390724" nodeInfo="in">
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="4457500422381390783" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.6386504476136420159" resolveInfo="ImgRefWord" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="4457500422381390784" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.WordList" id="4457500422381390785" nodeInfo="ng">
          <node role="words" type=".com.mbeddr.doc.latex.structure.TextWord" id="4457500422381390786" nodeInfo="ng">
            <property name="text" value="Fig." />
          </node>
          <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="4457500422381390787" nodeInfo="ng">
            <property name="command" value="ref" />
            <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="4457500422381390788" nodeInfo="ng">
              <property name="text" value="word" />
              <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="4457500422381390789" nodeInfo="ln">
                <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
                <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
                <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="4457500422381390790" nodeInfo="in">
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="2181941881726542427" nodeInfo="lg">
      ...
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="2181941881726565757" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.CommandWord" id="2181941881726854988" nodeInfo="ng">
          <property name="command" value="href" />
          <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="2181941881726854989" nodeInfo="ng">
            <property name="text" value="linkToMbeddr" />
            <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="2181941881726854990" nodeInfo="ln">
              <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
              <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
              <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="2181941881726854991" nodeInfo="in">
                <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="2181941881726854992" nodeInfo="sn">
                  <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="2181941881723697378" nodeInfo="nn">
                    <node role="expression" roleId="tpee.1068580123156" type="tpee.StaticMethodCall" typeId="tpee.1081236700937" id="2181941881723703837" nodeInfo="nn">
                      ...
                      <node role="actualArgument" roleId="tpee.1068499141038" type="tpee.DotExpression" typeId="tpee.1197027756228" id="2181941881726413637" nodeInfo="nn">
                        <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="2181941881726413104" nodeInfo="nn" />
                        <node role="operation" roleId="tpee.1197027833540" type="tp25.Node_ConceptMethodCall" typeId="tp25.1179409122411" id="2181941881726417356" nodeInfo="nn">
          ...
          <node role="args2" type=".com.mbeddr.doc.latex.structure.TextWord" id="2181941881726856807" nodeInfo="ng">
            <property name="text" value="text" />
            <node role="smodelAttribute" type="tpf8.CopySrcNodeMacro" typeId="tpf8.1114706874351" id="2181941881726856808" nodeInfo="ln">
              <node role="sourceNodeQuery" roleId="tpf8.1168024447342" type="tpf8.SourceSubstituteMacro_SourceNodeQuery" typeId="tpf8.1168024337012" id="2181941881726856809" nodeInfo="in">
                <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="2181941881726856810" nodeInfo="sn">
                  <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="2181941881726142594" nodeInfo="nn">
                    <node role="expression" roleId="tpee.1068580123156" type="tpee.StaticMethodCall" typeId="tpee.1081236700937" id="2181941881726432082" nodeInfo="nn">
                      ...
                      <node role="actualArgument" roleId="tpee.1068499141038" type="tpee.DotExpression" typeId="tpee.1197027756228" id="2181941881726432083" nodeInfo="nn">
                        <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="2181941881726432084" nodeInfo="nn" />
                        <node role="operation" roleId="tpee.1197027833540" type="tp25.Node_ConceptMethodCall" typeId="tp25.1179409122411" id="2181941881726433196" nodeInfo="nn">
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="2918313337036143551" nodeInfo="lg">
      <property name="applyToConceptInheritors" nameId="tpf8.1167272244852" value="true" />
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.6955693250238922838" resolveInfo="CodeRefWord" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="2918313337036143552" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.CommandWord" id="2918313337036143553" nodeInfo="ng">
          <property name="command" value="href" />
          <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="2918313337036143554" nodeInfo="ng">
            <property name="text" value="linkToMbeddr" />
            <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="2918313337036143555" nodeInfo="ln">
              <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
              <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="2918313337036143556" nodeInfo="in">
                <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="2918313337036143557" nodeInfo="sn">
                  <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="2918313337036143558" nodeInfo="nn">
                    <node role="expression" roleId="tpee.1068580123156" type="tpee.StaticMethodCall" typeId="tpee.1081236700937" id="2918313337036143559" nodeInfo="nn">
                      <link role="classConcept" roleId="tpee.1144433194310" targetNodeId="abz6.209357004266279224" resolveInfo="MbeddrURLHelper" />
                      <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="abz6.209357004266323887" resolveInfo="createURLForNode" />
                      <node role="actualArgument" roleId="tpee.1068499141038" type="tpee.DotExpression" typeId="tpee.1197027756228" id="2918313337036143560" nodeInfo="nn">
                        <node role="operand" roleId="tpee.1197027771414" type="tpcw.ConceptFunctionParameter_operationContext" typeId="tpcw.1161622753914" id="2918313337036143561" nodeInfo="nn" />
                        <node role="operation" roleId="tpee.1197027833540" type="tpee.InstanceMethodCallOperation" typeId="tpee.1202948039474" id="2918313337036143562" nodeInfo="nn">
                          <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="cu2c.~IOperationContext%dgetProject()%cjetbrains%dmps%dproject%dProject" resolveInfo="getProject" />
                        </node>
                      </node>
                      <node role="actualArgument" roleId="tpee.1068499141038" type="s4al.ApplicationID" typeId="s4al.3379970138993099772" id="2918313337036143563" nodeInfo="ng">
                        <link role="requestHandler" roleId="s4al.3379970138993099791" targetNodeId="abz6.8564455257661324548" resolveInfo="NodeOpenRequest" />
                      </node>
                      <node role="actualArgument" roleId="tpee.1068499141038" type="tpee.DotExpression" typeId="tpee.1197027756228" id="2918313337036514011" nodeInfo="nn">
                        <node role="operand" roleId="tpee.1197027771414" type="tpee.DotExpression" typeId="tpee.1197027756228" id="2918313337036143564" nodeInfo="nn">
                          <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="2918313337036143565" nodeInfo="nn" />
                          <node role="operation" roleId="tpee.1197027833540" type="tp25.SLinkAccess" typeId="tp25.1138056143562" id="2918313337036492741" nodeInfo="nn">
                            <link role="link" roleId="tp25.1138056516764" targetNodeId="2c95.6955693250238922839" />
                          </node>
                        </node>
                        <node role="operation" roleId="tpee.1197027833540" type="tp25.Node_ConceptMethodCall" typeId="tp25.1179409122411" id="2918313337036515893" nodeInfo="nn">
          ...
          <node role="args2" type=".com.mbeddr.doc.latex.structure.TextWord" id="2918313337036143567" nodeInfo="ng">
            <property name="text" value="text" />
            <node role="smodelAttribute" type="tpf8.CopySrcNodeMacro" typeId="tpf8.1114706874351" id="2918313337036143568" nodeInfo="ln">
              <node role="sourceNodeQuery" roleId="tpf8.1168024447342" type="tpf8.SourceSubstituteMacro_SourceNodeQuery" typeId="tpf8.1168024337012" id="2918313337036143569" nodeInfo="in">
                <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="2918313337036143570" nodeInfo="sn">
                  <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="2918313337036143571" nodeInfo="nn">
                    <node role="expression" roleId="tpee.1068580123156" type="tpee.StaticMethodCall" typeId="tpee.1081236700937" id="2918313337036143572" nodeInfo="nn">
                      <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="tbr6.6165313375055666180" resolveInfo="createTextFromSingleString" />
                      <link role="classConcept" roleId="tpee.1144433194310" targetNodeId="tbr6.6165313375055634598" resolveInfo="RichTextUtil" />
                      <node role="actualArgument" roleId="tpee.1068499141038" type="tpee.DotExpression" typeId="tpee.1197027756228" id="2918313337036518698" nodeInfo="nn">
                        <node role="operand" roleId="tpee.1197027771414" type="tpee.DotExpression" typeId="tpee.1197027756228" id="2918313337036143573" nodeInfo="nn">
                          <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="2918313337036143574" nodeInfo="nn" />
                          <node role="operation" roleId="tpee.1197027833540" type="tp25.SLinkAccess" typeId="tp25.1138056143562" id="2918313337036517576" nodeInfo="nn">
                            <link role="link" roleId="tp25.1138056516764" targetNodeId="2c95.6955693250238922839" />
                          </node>
                        </node>
                        <node role="operation" roleId="tpee.1197027833540" type="tp25.Node_ConceptMethodCall" typeId="tp25.1179409122411" id="2918313337036519980" nodeInfo="nn">
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="2642765975833266421" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.2642765975832553408" resolveInfo="AttachmentWord" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="2642765975833266422" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.WordList" id="2642765975833266423" nodeInfo="ng">
          <node role="words" type=".com.mbeddr.doc.latex.structure.TextWord" id="2642765975833266424" nodeInfo="ng">
            <property name="text" value="Attachment" />
          </node>
          <node role="words" type=".com.mbeddr.doc.latex.structure.TextWord" id="2642765975833310019" nodeInfo="ng">
            <property name="text" value="path" />
            <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="2642765975833342412" nodeInfo="ln">
              <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
              <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
              <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="2642765975833342413" nodeInfo="in">
                <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="2642765975833342414" nodeInfo="sn">
                  <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="2642765975833343113" nodeInfo="nn">
                    <node role="expression" roleId="tpee.1068580123156" type="tpee.DotExpression" typeId="tpee.1197027756228" id="2728443031451699033" nodeInfo="nn">
                      <node role="operand" roleId="tpee.1197027771414" type="tpee.DotExpression" typeId="tpee.1197027756228" id="2642765975833363709" nodeInfo="nn">
                        <node role="operand" roleId="tpee.1197027771414" type="tpee.DotExpression" typeId="tpee.1197027756228" id="2642765975833353718" nodeInfo="nn">
                          <node role="operand" roleId="tpee.1197027771414" type="tpee.DotExpression" typeId="tpee.1197027756228" id="2642765975833343889" nodeInfo="nn">
                            <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="2642765975833343112" nodeInfo="nn" />
                            <node role="operation" roleId="tpee.1197027833540" type="tp25.SLinkAccess" typeId="tp25.1138056143562" id="2642765975833350157" nodeInfo="nn">
                              <link role="link" roleId="tp25.1138056516764" targetNodeId="2c95.2642765975832553413" />
                            </node>
                          </node>
                          <node role="operation" roleId="tpee.1197027833540" type="tp25.SLinkAccess" typeId="tp25.1138056143562" id="2728443031451691220" nodeInfo="nn">
                            <link role="link" roleId="tp25.1138056516764" targetNodeId="2c95.6386504476136521409" />
                          </node>
                        </node>
                        <node role="operation" roleId="tpee.1197027833540" type="tp25.SLinkAccess" typeId="tp25.1138056143562" id="2728443031451695020" nodeInfo="nn">
                          <link role="link" roleId="tp25.1138056516764" targetNodeId="2c95.2642765975824057986" />
                        </node>
                      </node>
                      <node role="operation" roleId="tpee.1197027833540" type="tp25.Node_ConceptMethodCall" typeId="tp25.1179409122411" id="2728443031451703753" nodeInfo="nn">
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="4457500422381572000" nodeInfo="lg">
      ...
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="4457500422381572001" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.CommandWord" id="4457500422381572002" nodeInfo="ng">
          <property name="command" value="ic" />
          <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="4457500422381572003" nodeInfo="ng">
            <property name="text" value="text" />
            <node role="smodelAttribute" type="tpf8.CopySrcNodeMacro" typeId="tpf8.1114706874351" id="5378658552263204988" nodeInfo="ln">
              <node role="sourceNodeQuery" roleId="tpf8.1168024447342" type="tpf8.SourceSubstituteMacro_SourceNodeQuery" typeId="tpf8.1168024337012" id="5378658552263204991" nodeInfo="in">
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="4208238404723613280" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.4208238404723595132" resolveInfo="UrlFormattedText" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="4208238404723613281" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.CommandWord" id="4208238404723613282" nodeInfo="ng">
          <property name="command" value="url" />
          <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="4208238404723613283" nodeInfo="ng">
            <property name="text" value="text" />
            <node role="smodelAttribute" type="tpf8.CopySrcNodeMacro" typeId="tpf8.1114706874351" id="4208238404723613284" nodeInfo="ln">
              <node role="sourceNodeQuery" roleId="tpf8.1168024447342" type="tpf8.SourceSubstituteMacro_SourceNodeQuery" typeId="tpf8.1168024337012" id="4208238404723613285" nodeInfo="in">
                <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="4208238404723613286" nodeInfo="sn">
                  <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="4208238404723613287" nodeInfo="nn">
                    <node role="expression" roleId="tpee.1068580123156" type="tpee.DotExpression" typeId="tpee.1197027756228" id="4208238404723613288" nodeInfo="nn">
                      <node role="operation" roleId="tpee.1197027833540" type="tp25.SLinkAccess" typeId="tp25.1138056143562" id="4208238404723613289" nodeInfo="nn">
                        <link role="link" roleId="tp25.1138056516764" targetNodeId="2c95.6165313375055797477" />
                      </node>
                      <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="4208238404723613290" nodeInfo="nn" />
                    </node>
                  </node>
                </node>
              </node>
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="2728443031451677103" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.2728443031450669962" resolveInfo="FootnoteWord" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="2728443031451677104" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.CommandWord" id="2728443031451677105" nodeInfo="ng">
          <property name="command" value="footnote" />
          <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="2728443031451677106" nodeInfo="ng">
            <property name="text" value="text" />
            <node role="smodelAttribute" type="tpf8.CopySrcNodeMacro" typeId="tpf8.1114706874351" id="2728443031451677107" nodeInfo="ln">
              <node role="sourceNodeQuery" roleId="tpf8.1168024447342" type="tpf8.SourceSubstituteMacro_SourceNodeQuery" typeId="tpf8.1168024337012" id="2728443031451677108" nodeInfo="in">
                <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="2728443031451677109" nodeInfo="sn">
                  <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="2728443031451677110" nodeInfo="nn">
                    <node role="expression" roleId="tpee.1068580123156" type="tpee.DotExpression" typeId="tpee.1197027756228" id="2728443031451677111" nodeInfo="nn">
                      <node role="operation" roleId="tpee.1197027833540" type="tp25.SLinkAccess" typeId="tp25.1138056143562" id="2728443031451689638" nodeInfo="nn">
                        <link role="link" roleId="tp25.1138056516764" targetNodeId="2c95.2728443031450670151" />
                      </node>
                      <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="2728443031451677113" nodeInfo="nn" />
                    </node>
                  </node>
                </node>
              </node>
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="4400783559374141875" nodeInfo="lg">
      ...
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="4400783559374141876" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.CommandWord" id="4400783559374141877" nodeInfo="ng">
          <property name="command" value="emph" />
          <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="4400783559374141878" nodeInfo="ng">
            <property name="text" value="text" />
            <node role="smodelAttribute" type="tpf8.CopySrcNodeMacro" typeId="tpf8.1114706874351" id="4400783559374141879" nodeInfo="ln">
              <node role="sourceNodeQuery" roleId="tpf8.1168024447342" type="tpf8.SourceSubstituteMacro_SourceNodeQuery" typeId="tpf8.1168024337012" id="4400783559374141880" nodeInfo="in">
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="620304030119283261" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.620304030119138923" resolveInfo="BoldFormattedText" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="620304030119283262" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.CommandWord" id="620304030119283263" nodeInfo="ng">
          <property name="command" value="textbf" />
          <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="620304030119283264" nodeInfo="ng">
            <property name="text" value="text" />
            <node role="smodelAttribute" type="tpf8.CopySrcNodeMacro" typeId="tpf8.1114706874351" id="620304030119283265" nodeInfo="ln">
              <node role="sourceNodeQuery" roleId="tpf8.1168024447342" type="tpf8.SourceSubstituteMacro_SourceNodeQuery" typeId="tpf8.1168024337012" id="620304030119283266" nodeInfo="in">
                <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="620304030119283267" nodeInfo="sn">
                  <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="620304030119283268" nodeInfo="nn">
                    <node role="expression" roleId="tpee.1068580123156" type="tpee.DotExpression" typeId="tpee.1197027756228" id="620304030119283269" nodeInfo="nn">
                      <node role="operation" roleId="tpee.1197027833540" type="tp25.SLinkAccess" typeId="tp25.1138056143562" id="620304030119283270" nodeInfo="nn">
                        <link role="link" roleId="tp25.1138056516764" targetNodeId="2c95.6165313375055797477" />
                      </node>
                      <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="620304030119283271" nodeInfo="nn" />
                    </node>
                  </node>
                </node>
              </node>
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="6165313375055774363" nodeInfo="lg">
      ...
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="6165313375055774364" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.WordList" id="6165313375055774378" nodeInfo="ng">
          <node role="words" type=".com.mbeddr.doc.latex.structure.TextWord" id="6165313375055774379" nodeInfo="ng">
            <property name="text" value="$" />
          </node>
          <node role="words" type=".com.mbeddr.doc.latex.structure.TextWord" id="6165313375055774381" nodeInfo="ng">
            <property name="text" value="formula" />
            <node role="smodelAttribute" type="tpf8.CopySrcNodeMacro" typeId="tpf8.1114706874351" id="6165313375055774419" nodeInfo="ln">
              <node role="sourceNodeQuery" roleId="tpf8.1168024447342" type="tpf8.SourceSubstituteMacro_SourceNodeQuery" typeId="tpf8.1168024337012" id="6165313375055774422" nodeInfo="in">
          ...
          <node role="words" type=".com.mbeddr.doc.latex.structure.TextWord" id="6165313375055774383" nodeInfo="ng">
            <property name="text" value="$" />
          </node>
        </node>
      </node>
    </node>
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="4457500422381390674" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="87nw.2557074442922438156" resolveInfo="Word" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="4457500422381390676" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.TextWord" id="4457500422381390679" nodeInfo="ng">
          <property name="text" value="word" />
          <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="4457500422381390680" nodeInfo="ln">
            <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
            <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
            <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="4457500422381390681" nodeInfo="in">
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="4457500422381375439" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.6386504476136263187" resolveInfo="ImageParagraph" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="4457500422381375441" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.LineList" id="4457500422381368863" nodeInfo="ng">
          <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="4457500422381430839" nodeInfo="ng" />
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="4457500422381374948" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="4457500422381375430" nodeInfo="ng">
              <property name="command" value="begin" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="4457500422381390525" nodeInfo="ng">
                <property name="text" value="figure" />
              </node>
              <node role="options2" type=".com.mbeddr.doc.latex.structure.TextWord" id="4457500422381512862" nodeInfo="ng">
                <property name="text" value="h" />
              </node>
            </node>
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="4755612053022724589" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="4755612053022724590" nodeInfo="ng">
              <property name="command" value="begin" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="4755612053022724591" nodeInfo="ng">
                <property name="text" value="center" />
              </node>
            </node>
            <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="8730648445434174387" nodeInfo="ln">
              <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="8730648445434174388" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.LineList" id="8730648445434174360" nodeInfo="ng">
            <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="4755612053022719653" nodeInfo="ln">
              <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="4755612053022719654" nodeInfo="in">
            ...
            <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="4755612053022719649" nodeInfo="ng">
              <property name="text" value="\fbox {" />
            </node>
            <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="8730648445434174363" nodeInfo="ng">
              <property name="text" value="\begin{minipage}{0.96\columnwidth}" />
            </node>
            <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="4317007310193554584" nodeInfo="ng">
              <property name="text" value="\begin{center}" />
              <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="4317007310193554586" nodeInfo="ln">
                <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="4317007310193554587" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="4457500422381375437" nodeInfo="ng">
            <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="4317007310193475984" nodeInfo="ln">
              <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="4317007310193475985" nodeInfo="in">
            ...
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="4317007310193515926" nodeInfo="ng">
              <property name="command" value="scalegraphics" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="4317007310193515927" nodeInfo="ng">
                <property name="text" value="text" />
                <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="4317007310193515928" nodeInfo="ln">
                  <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
                  <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
                  <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="4317007310193515929" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="4317007310193475956" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="4317007310193475957" nodeInfo="ng">
              <property name="command" value="includegraphics" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="4317007310193475958" nodeInfo="ng">
                <property name="text" value="text" />
                <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="4317007310193475959" nodeInfo="ln">
                  <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
                  <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
                  <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="4317007310193475960" nodeInfo="in">
              ...
              <node role="options1" type=".com.mbeddr.doc.latex.structure.TextWord" id="4317007310193475973" nodeInfo="ng">
                <property name="text" value="sizespec" />
                <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="4317007310193475974" nodeInfo="ln">
                  <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
                  <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
                  <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="4317007310193475975" nodeInfo="in">
            ...
            <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="4317007310193515943" nodeInfo="ln">
              <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="4317007310193515944" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.LineList" id="8730648445434174365" nodeInfo="ng">
            <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="4755612053022719686" nodeInfo="ln">
              <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="4755612053022719687" nodeInfo="in">
            ...
            <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="4317007310193554619" nodeInfo="ng">
              <property name="text" value="\end{center}" />
              <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="4317007310193554620" nodeInfo="ln">
                <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="4317007310193554621" nodeInfo="in">
            ...
            <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="4755612053022719651" nodeInfo="ng">
              <property name="text" value="\end{minipage}" />
            </node>
            <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="8730648445434174367" nodeInfo="ng">
              <property name="text" value="}" />
            </node>
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="4755612053022724592" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="4755612053022724593" nodeInfo="ng">
              <property name="command" value="end" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="4755612053022724594" nodeInfo="ng">
                <property name="text" value="center" />
              </node>
            </node>
            <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="8730648445434174420" nodeInfo="ln">
              <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="8730648445434174421" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="4755612053022722927" nodeInfo="ng">
            <property name="text" value="\vspace{-3mm}" />
            <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="4755612053022722929" nodeInfo="ln">
              <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="4755612053022722930" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="4457500422381380661" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="4457500422381380662" nodeInfo="ng">
              <property name="command" value="caption" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.WordList" id="4457500422381390633" nodeInfo="ng">
                <node role="words" type=".com.mbeddr.doc.latex.structure.TextWord" id="4457500422381390634" nodeInfo="ng">
                  <property name="text" value="word" />
                  <node role="smodelAttribute" type="tpf8.CopySrcNodeMacro" typeId="tpf8.1114706874351" id="4457500422381390639" nodeInfo="ln">
                    <node role="sourceNodeQuery" roleId="tpf8.1168024447342" type="tpf8.SourceSubstituteMacro_SourceNodeQuery" typeId="tpf8.1168024337012" id="4457500422381390642" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="4457500422381380622" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="4457500422381380623" nodeInfo="ng">
              <property name="command" value="label" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="4457500422381390621" nodeInfo="ng">
                <property name="text" value="label" />
                <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="4457500422381390622" nodeInfo="ln">
                  <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
                  <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
                  <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="4457500422381390625" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="4457500422381375432" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="4457500422381375433" nodeInfo="ng">
              <property name="command" value="end" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="4457500422381390524" nodeInfo="ng">
                <property name="text" value="figure" />
              </node>
            </node>
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="4457500422381430836" nodeInfo="ng" />
        </node>
      </node>
    </node>
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="5785245534399659138" nodeInfo="lg">
      ...
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="5785245534399659139" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.LineList" id="5785245534399659140" nodeInfo="ng">
          <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="5785245534399659141" nodeInfo="ng" />
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="5785245534399659142" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="5785245534399659143" nodeInfo="ng">
              <property name="command" value="begin" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="5785245534399659144" nodeInfo="ng">
                <property name="text" value="figure" />
              </node>
              <node role="options2" type=".com.mbeddr.doc.latex.structure.TextWord" id="5785245534399659145" nodeInfo="ng">
                <property name="text" value="h" />
              </node>
            </node>
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534399659165" nodeInfo="ng">
            <property name="text" value="\begin{minipage}{0.96\columnwidth}" />
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534399883830" nodeInfo="ng">
            <property name="text" value="\begin{center}" />
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534400876497" nodeInfo="ng">
            <property name="text" value="\footnotesize" />
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534399659264" nodeInfo="ng">
            <property name="text" value="\begin{tabular}{l|l}" />
            <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="5785245534399752013" nodeInfo="ln">
              <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
              <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381360575/4457500422381360577" />
              <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="5785245534399752014" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534399659267" nodeInfo="ng">
            <property name="text" value="row" />
            <node role="smodelAttribute" type="tpf8.CopySrcListMacro" typeId="tpf8.1114729360583" id="5785245534399659269" nodeInfo="ln">
              <node role="sourceNodesQuery" roleId="tpf8.1168278589236" type="tpf8.SourceSubstituteMacro_SourceNodesQuery" typeId="tpf8.1167951910403" id="5785245534399659272" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="8903209210859236701" nodeInfo="ng">
            <property name="text" value="\hline" />
            <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="8903209210859236702" nodeInfo="ln">
              <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="8903209210859236703" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534399659265" nodeInfo="ng">
            <property name="text" value="\end{tabular}" />
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534400876496" nodeInfo="ng">
            <property name="text" value="\normalsize" />
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534399883831" nodeInfo="ng">
            <property name="text" value="\end{center}" />
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534399659201" nodeInfo="ng">
            <property name="text" value="\end{minipage}" />
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="5785245534399659221" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="5785245534399659222" nodeInfo="ng">
              <property name="command" value="caption" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.WordList" id="5785245534399659223" nodeInfo="ng">
                <node role="words" type=".com.mbeddr.doc.latex.structure.TextWord" id="5785245534399659224" nodeInfo="ng">
                  <property name="text" value="word" />
                  <node role="smodelAttribute" type="tpf8.CopySrcNodeMacro" typeId="tpf8.1114706874351" id="5785245534399659225" nodeInfo="ln">
                    <node role="sourceNodeQuery" roleId="tpf8.1168024447342" type="tpf8.SourceSubstituteMacro_SourceNodeQuery" typeId="tpf8.1168024337012" id="5785245534399659226" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="5785245534399659232" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="5785245534399659233" nodeInfo="ng">
              <property name="command" value="label" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="5785245534399659234" nodeInfo="ng">
                <property name="text" value="label" />
                <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="5785245534399659235" nodeInfo="ln">
                  <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
                  <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
                  <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="5785245534399659236" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="5785245534399659242" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="5785245534399659243" nodeInfo="ng">
              <property name="command" value="end" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="5785245534399659244" nodeInfo="ng">
                <property name="text" value="figure" />
              </node>
            </node>
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="5785245534399659245" nodeInfo="ng" />
        </node>
      </node>
    </node>
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="5785245534399940700" nodeInfo="lg">
      ...
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="5785245534399940701" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.LineList" id="5785245534399940702" nodeInfo="ng">
          <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="5785245534399940703" nodeInfo="ng" />
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534400951437" nodeInfo="ng">
            <property name="text" value="\vspace{3mm}" />
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534400942138" nodeInfo="ng">
            <property name="text" value="\noindent" />
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534400944786" nodeInfo="ng">
            <property name="text" value="\begin{minipage}{0.96\columnwidth}" />
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534400876494" nodeInfo="ng">
            <property name="text" value="\footnotesize" />
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534399940710" nodeInfo="ng">
            <property name="text" value="\begin{tabular}{l|l}" />
            <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="5785245534399940711" nodeInfo="ln">
              <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
              <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381360575/4457500422381360577" />
              <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="5785245534399940712" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534399940740" nodeInfo="ng">
            <property name="text" value="row" />
            <node role="smodelAttribute" type="tpf8.CopySrcListMacro" typeId="tpf8.1114729360583" id="5785245534399940741" nodeInfo="ln">
              <node role="sourceNodesQuery" roleId="tpf8.1168278589236" type="tpf8.SourceSubstituteMacro_SourceNodesQuery" typeId="tpf8.1167951910403" id="5785245534399940742" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="8903209210859236713" nodeInfo="ng">
            <property name="text" value="\hline" />
            <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="8903209210859236714" nodeInfo="ln">
              <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="8903209210859236715" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534399940748" nodeInfo="ng">
            <property name="text" value="\end{tabular}" />
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534400876495" nodeInfo="ng">
            <property name="text" value="\normalsize" />
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534400944787" nodeInfo="ng">
            <property name="text" value="\end{minipage}" />
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="5785245534400887089" nodeInfo="ng" />
        </node>
      </node>
    </node>
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="5785245534399659278" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.5185579450379471854" resolveInfo="TableRow" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="5785245534399659279" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.LineList" id="5785245534399742828" nodeInfo="ng">
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534399742830" nodeInfo="ng">
            <property name="text" value="\hline" />
            <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="5785245534399742832" nodeInfo="ln">
              <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="5785245534399742833" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="5785245534399659324" nodeInfo="ng">
            <property name="separator" value=" &amp; " />
            <property name="end" value="\\" />
            <node role="words" type=".com.mbeddr.doc.latex.structure.TextWord" id="5785245534399666535" nodeInfo="ng">
              <property name="text" value="node" />
              <node role="smodelAttribute" type="tpf8.CopySrcListMacro" typeId="tpf8.1114729360583" id="5785245534399666537" nodeInfo="ln">
                <node role="sourceNodesQuery" roleId="tpf8.1168278589236" type="tpf8.SourceSubstituteMacro_SourceNodesQuery" typeId="tpf8.1167951910403" id="5785245534399666540" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5785245534399742865" nodeInfo="ng">
            <property name="text" value="\hline" />
            <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="5785245534399742866" nodeInfo="ln">
              <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="5785245534399742867" nodeInfo="in">
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="5785245534399666548" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.5185579450379471862" resolveInfo="StringTableCell" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineSwitch_RuleConsequence" typeId="tpf8.1195158154974" id="5785245534399666620" nodeInfo="lg">
        <node role="case" roleId="tpf8.1195158408710" type="tpf8.InlineSwitch_Case" typeId="tpf8.1195158388553" id="5785245534399666622" nodeInfo="ng">
          <node role="conditionFunction" roleId="tpf8.1195158608805" type="tpf8.BaseMappingRule_Condition" typeId="tpf8.1167168920554" id="5785245534399666623" nodeInfo="in">
          ...
          <node role="caseConsequence" roleId="tpf8.1195158637244" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="5785245534399666550" nodeInfo="lg">
            <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.CommandWord" id="5785245534399666666" nodeInfo="ng">
              <property name="command" value="textbf" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="5785245534399666554" nodeInfo="ng">
                <property name="text" value="word" />
                <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="5785245534399666557" nodeInfo="ln">
                  <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
                  <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
                  <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="5785245534399666560" nodeInfo="in">
        ...
        <node role="defaultConsequence" roleId="tpf8.1195158241124" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="5785245534399666656" nodeInfo="lg">
          <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.TextWord" id="5785245534399666657" nodeInfo="ng">
            <property name="text" value="word" />
            <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="5785245534399666658" nodeInfo="ln">
              <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
              <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
              <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="5785245534399666659" nodeInfo="in">
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="5785245534400277712" nodeInfo="lg">
      ...
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="5785245534400277740" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.TextWord" id="5785245534400277743" nodeInfo="ng">
          <property name="text" value="word" />
          <node role="smodelAttribute" type="tpf8.CopySrcNodeMacro" typeId="tpf8.1114706874351" id="5785245534400277745" nodeInfo="ln">
            <node role="sourceNodeQuery" roleId="tpf8.1168024447342" type="tpf8.SourceSubstituteMacro_SourceNodeQuery" typeId="tpf8.1168024337012" id="5785245534400277748" nodeInfo="in">
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="4457500422381390478" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.3350625596580064455" resolveInfo="Section" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineSwitch_RuleConsequence" typeId="tpf8.1195158154974" id="5185579450379302187" nodeInfo="lg">
        <node role="case" roleId="tpf8.1195158408710" type="tpf8.InlineSwitch_Case" typeId="tpf8.1195158388553" id="5185579450379302199" nodeInfo="ng">
          <node role="conditionFunction" roleId="tpf8.1195158608805" type="tpf8.BaseMappingRule_Condition" typeId="tpf8.1167168920554" id="5185579450379302200" nodeInfo="in">
            <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="5185579450379302201" nodeInfo="sn">
              <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="4208238404731940011" nodeInfo="nn">
                <node role="expression" roleId="tpee.1068580123156" type="tpee.OrExpression" typeId="tpee.1080223426719" id="4208238404731943224" nodeInfo="nn">
                  <node role="leftExpression" roleId="tpee.1081773367580" type="tpee.ParenthesizedExpression" typeId="tpee.1079359253375" id="4208238404731941471" nodeInfo="nn">
                    <node role="expression" roleId="tpee.1079359253376" type="tpee.AndExpression" typeId="tpee.1080120340718" id="4208238404731941472" nodeInfo="nn">
                      <node role="rightExpression" roleId="tpee.1081773367579" type="tpee.LessThanOrEqualsExpression" typeId="tpee.1153422305557" id="4208238404731949638" nodeInfo="nn">
                        <node role="leftExpression" roleId="tpee.1081773367580" type="tpee.DotExpression" typeId="tpee.1197027756228" id="4208238404731949641" nodeInfo="nn">
                          <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="4208238404731949642" nodeInfo="nn" />
                          <node role="operation" roleId="tpee.1197027833540" type="tp25.Node_ConceptMethodCall" typeId="tp25.1179409122411" id="4208238404731949643" nodeInfo="nn">
                            <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="4gky.5185579450379205811" resolveInfo="nestingLevel" />
                          </node>
                        </node>
                        <node role="rightExpression" roleId="tpee.1081773367579" type="tpee.IntegerConstant" typeId="tpee.1068580320020" id="4208238404731949640" nodeInfo="nn">
                          <property name="value" nameId="tpee.1068580320021" value="3" />
                        </node>
                      </node>
                      <node role="leftExpression" roleId="tpee.1081773367580" type="tpee.DotExpression" typeId="tpee.1197027756228" id="4208238404731941478" nodeInfo="nn">
                        <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="4208238404731941479" nodeInfo="nn" />
                        <node role="operation" roleId="tpee.1197027833540" type="tp25.Node_ConceptMethodCall" typeId="tp25.1179409122411" id="4208238404731941480" nodeInfo="nn">
                          <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="4gky.4208238404731878237" resolveInfo="isInChapter" />
                        </node>
                      </node>
                    </node>
                  </node>
                  <node role="rightExpression" roleId="tpee.1081773367579" type="tpee.ParenthesizedExpression" typeId="tpee.1079359253375" id="4208238404731944443" nodeInfo="nn">
                    <node role="expression" roleId="tpee.1079359253376" type="tpee.AndExpression" typeId="tpee.1080120340718" id="4208238404731944444" nodeInfo="nn">
                      <node role="rightExpression" roleId="tpee.1081773367579" type="tpee.LessThanOrEqualsExpression" typeId="tpee.1153422305557" id="4208238404731948159" nodeInfo="nn">
                        <node role="leftExpression" roleId="tpee.1081773367580" type="tpee.DotExpression" typeId="tpee.1197027756228" id="4208238404731948162" nodeInfo="nn">
                          <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="4208238404731948163" nodeInfo="nn" />
                          <node role="operation" roleId="tpee.1197027833540" type="tp25.Node_ConceptMethodCall" typeId="tp25.1179409122411" id="4208238404731948164" nodeInfo="nn">
                            <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="4gky.5185579450379205811" resolveInfo="nestingLevel" />
                          </node>
                        </node>
                        <node role="rightExpression" roleId="tpee.1081773367579" type="tpee.IntegerConstant" typeId="tpee.1068580320020" id="4208238404731948161" nodeInfo="nn">
                          <property name="value" nameId="tpee.1068580320021" value="2" />
                        </node>
                      </node>
                      <node role="leftExpression" roleId="tpee.1081773367580" type="tpee.NotExpression" typeId="tpee.1081516740877" id="4208238404731945706" nodeInfo="nn">
                        <node role="expression" roleId="tpee.1081516765348" type="tpee.DotExpression" typeId="tpee.1197027756228" id="4208238404731945708" nodeInfo="nn">
                          <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="4208238404731945709" nodeInfo="nn" />
                          <node role="operation" roleId="tpee.1197027833540" type="tp25.Node_ConceptMethodCall" typeId="tp25.1179409122411" id="4208238404731945710" nodeInfo="nn">
                            <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="4gky.4208238404731878237" resolveInfo="isInChapter" />
                          </node>
                        </node>
                      </node>
          ...
          <node role="caseConsequence" roleId="tpf8.1195158637244" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="5185579450379302147" nodeInfo="lg">
            <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.LineList" id="5185579450379302148" nodeInfo="ng">
              <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="5185579450379302149" nodeInfo="ng" />
              <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="5185579450379302150" nodeInfo="ng">
                <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="5185579450379302151" nodeInfo="ng">
                  <property name="command" value="section" />
                  <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="5185579450379302152" nodeInfo="ng">
                    <property name="text" value="text" />
                    <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="5185579450379302153" nodeInfo="ln">
                      <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
                      <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
                      <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="5185579450379302154" nodeInfo="in">
                  ...
                  <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="5185579450379302215" nodeInfo="ln">
                    <property name="propertyName" nameId="tpck.1757699476691236117" value="command" />
                    <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364333/4457500422381364335" />
                    <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="5185579450379302216" nodeInfo="in">
                      <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="5185579450379302217" nodeInfo="sn">
                        <node role="statement" roleId="tpee.1068581517665" type="tpee.LocalVariableDeclarationStatement" typeId="tpee.1068581242864" id="4208238404731974176" nodeInfo="nn">
                          <node role="localVariableDeclaration" roleId="tpee.1068581242865" type="tpee.LocalVariableDeclaration" typeId="tpee.1068581242863" id="4208238404731974177" nodeInfo="nr">
                            <property name="name" nameId="tpck.1169194664001" value="el" />
                            <node role="type" roleId="tpee.5680397130376446158" type="tpee.IntegerType" typeId="tpee.1070534370425" id="4208238404731974175" nodeInfo="in" />
                            <node role="initializer" roleId="tpee.1068431790190" type="tpee.DotExpression" typeId="tpee.1197027756228" id="4208238404731974178" nodeInfo="nn">
                              <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="4208238404731974179" nodeInfo="nn" />
                              <node role="operation" roleId="tpee.1197027833540" type="tp25.Node_ConceptMethodCall" typeId="tp25.1179409122411" id="4208238404731974180" nodeInfo="nn">
                                <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="4gky.5185579450379205811" resolveInfo="nestingLevel" />
                              </node>
                            </node>
                          </node>
                        </node>
                        <node role="statement" roleId="tpee.1068581517665" type="tpee.IfStatement" typeId="tpee.1068580123159" id="4208238404731976698" nodeInfo="nn">
                          <node role="ifTrue" roleId="tpee.1068580123161" type="tpee.StatementList" typeId="tpee.1068580123136" id="4208238404731976701" nodeInfo="sn">
                            <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="4208238404731997143" nodeInfo="nn">
                              <node role="expression" roleId="tpee.1068580123156" type="tpee.AssignmentExpression" typeId="tpee.1068498886294" id="4208238404731998640" nodeInfo="nn">
                                <node role="rValue" roleId="tpee.1068498886297" type="tpee.MinusExpression" typeId="tpee.1068581242869" id="4208238404732000661" nodeInfo="nn">
                                  <node role="rightExpression" roleId="tpee.1081773367579" type="tpee.IntegerConstant" typeId="tpee.1068580320020" id="4208238404732000666" nodeInfo="nn">
                                    <property name="value" nameId="tpee.1068580320021" value="1" />
                                  </node>
                                  <node role="leftExpression" roleId="tpee.1081773367580" type="tpee.VariableReference" typeId="tpee.1068498886296" id="4208238404731999162" nodeInfo="nn">
                                    <link role="variableDeclaration" roleId="tpee.1068581517664" targetNodeId="4208238404731974177" resolveInfo="el" />
                                  </node>
                                </node>
                                <node role="lValue" roleId="tpee.1068498886295" type="tpee.VariableReference" typeId="tpee.1068498886296" id="4208238404731997142" nodeInfo="nn">
                                  <link role="variableDeclaration" roleId="tpee.1068581517664" targetNodeId="4208238404731974177" resolveInfo="el" />
                                </node>
                              </node>
                            </node>
                          </node>
                          <node role="condition" roleId="tpee.1068580123160" type="tpee.DotExpression" typeId="tpee.1197027756228" id="4208238404731978328" nodeInfo="nn">
                            <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="4208238404731977725" nodeInfo="nn" />
                            <node role="operation" roleId="tpee.1197027833540" type="tp25.Node_ConceptMethodCall" typeId="tp25.1179409122411" id="4208238404731982737" nodeInfo="nn">
                              <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="4gky.4208238404731878237" resolveInfo="isInChapter" />
                            </node>
                          </node>
                        </node>
                        <node role="statement" roleId="tpee.1068581517665" type="tpee.SwitchStatement" typeId="tpee.1163670490218" id="5185579450379302218" nodeInfo="nn">
                          <node role="expression" roleId="tpee.1163670766145" type="tpee.VariableReference" typeId="tpee.1068498886296" id="4208238404731974181" nodeInfo="nn">
                            <link role="variableDeclaration" roleId="tpee.1068581517664" targetNodeId="4208238404731974177" resolveInfo="el" />
                          </node>
              ...
              <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="5185579450379302160" nodeInfo="ng">
                <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="5185579450379302161" nodeInfo="ng">
                  <property name="command" value="label" />
                  <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="5185579450379302162" nodeInfo="ng">
                    <property name="text" value="label" />
                    <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="5185579450379302163" nodeInfo="ln">
                      <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
                      <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
                      <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="5185579450379302164" nodeInfo="in">
              ...
              <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="5185579450379302170" nodeInfo="ng" />
              <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5185579450379302171" nodeInfo="ng">
                <property name="text" value="dummy" />
                <node role="smodelAttribute" type="tpf8.CopySrcListMacro" typeId="tpf8.1114729360583" id="5185579450379302172" nodeInfo="ln">
                  <node role="sourceNodesQuery" roleId="tpf8.1168278589236" type="tpf8.SourceSubstituteMacro_SourceNodesQuery" typeId="tpf8.1167951910403" id="5185579450379302173" nodeInfo="in">
        ...
        <node role="defaultConsequence" roleId="tpf8.1195158241124" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="5185579450379302189" nodeInfo="lg">
          <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.LineList" id="3126418051240317973" nodeInfo="ng">
            <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="3126418051240317974" nodeInfo="ng" />
            <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="3126418051240317975" nodeInfo="ng">
              <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="3126418051240318035" nodeInfo="ng">
                <property name="command" value="parhead" />
                <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="3126418051240318038" nodeInfo="ng">
                  <property name="text" value="text" />
                  <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="3126418051240318039" nodeInfo="ln">
                    <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
                    <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
                    <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="3126418051240318042" nodeInfo="in">
              ...
              <node role="words" type=".com.mbeddr.doc.latex.structure.TextWord" id="5779127112631538518" nodeInfo="ng">
                <property name="text" value="dummy" />
                <node role="smodelAttribute" type="tpf8.CopySrcListMacro" typeId="tpf8.1114729360583" id="5779127112631538520" nodeInfo="ln">
                  <node role="sourceNodesQuery" roleId="tpf8.1168278589236" type="tpf8.SourceSubstituteMacro_SourceNodesQuery" typeId="tpf8.1167951910403" id="5779127112631538523" nodeInfo="in">
            ...
            <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="3126418051240318020" nodeInfo="ng" />
          </node>
        </node>
      </node>
    </node>
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="4208238404730204044" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.4208238404730191274" resolveInfo="Chapter" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="4208238404730204055" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.LineList" id="4208238404730204056" nodeInfo="ng">
          <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="4208238404730204057" nodeInfo="ng" />
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="4208238404730204058" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="4208238404730204059" nodeInfo="ng">
              <property name="command" value="chapter" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="4208238404730204060" nodeInfo="ng">
                <property name="text" value="text" />
                <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="4208238404730204061" nodeInfo="ln">
                  <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
                  <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
                  <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="4208238404730204062" nodeInfo="in">
                    <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="4208238404730204063" nodeInfo="sn">
                      <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="4208238404730204064" nodeInfo="nn">
                        <node role="expression" roleId="tpee.1068580123156" type="tpee.StaticMethodCall" typeId="tpee.1081236700937" id="4208238404730204065" nodeInfo="nn">
                          <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="81x8.2042272859105555518" resolveInfo="escape" />
                          <link role="classConcept" roleId="tpee.1144433194310" targetNodeId="81x8.2042272859105555512" resolveInfo="LatexEscapeHelper" />
                          <node role="actualArgument" roleId="tpee.1068499141038" type="tpee.DotExpression" typeId="tpee.1197027756228" id="4208238404730204066" nodeInfo="nn">
                            <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="4208238404730204067" nodeInfo="nn" />
                            <node role="operation" roleId="tpee.1197027833540" type="tp25.SPropertyAccess" typeId="tp25.1138056022639" id="4208238404730204068" nodeInfo="nn">
                              <link role="property" roleId="tp25.1138056395725" targetNodeId="2c95.3350625596580064225" resolveInfo="text" />
                            </node>
                          </node>
                        </node>
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="4208238404730204094" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="4208238404730204095" nodeInfo="ng">
              <property name="command" value="label" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="4208238404730204096" nodeInfo="ng">
                <property name="text" value="label" />
                <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="4208238404730204097" nodeInfo="ln">
                  <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
                  <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
                  <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="4208238404730204098" nodeInfo="in">
                    <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="4208238404730204099" nodeInfo="sn">
                      <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="4208238404730204100" nodeInfo="nn">
                        <node role="expression" roleId="tpee.1068580123156" type="tpee.DotExpression" typeId="tpee.1197027756228" id="4208238404730204101" nodeInfo="nn">
                          <node role="operation" roleId="tpee.1197027833540" type="tp25.Node_ConceptMethodCall" typeId="tp25.1179409122411" id="4208238404730204102" nodeInfo="nn">
                            <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="4gky.3350625596580280320" resolveInfo="qualifiedName" />
                          </node>
                          <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="4208238404730204103" nodeInfo="nn" />
                        </node>
                      </node>
                    </node>
                  </node>
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="4208238404730204104" nodeInfo="ng" />
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="4208238404730204105" nodeInfo="ng">
            <property name="text" value="dummy" />
            <node role="smodelAttribute" type="tpf8.CopySrcListMacro" typeId="tpf8.1114729360583" id="4208238404730204106" nodeInfo="ln">
              <node role="sourceNodesQuery" roleId="tpf8.1168278589236" type="tpf8.SourceSubstituteMacro_SourceNodesQuery" typeId="tpf8.1167951910403" id="4208238404730204107" nodeInfo="in">
                <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="4208238404730204108" nodeInfo="sn">
                  <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="4208238404730204109" nodeInfo="nn">
                    <node role="expression" roleId="tpee.1068580123156" type="tpee.DotExpression" typeId="tpee.1197027756228" id="4208238404730204110" nodeInfo="nn">
                      <node role="operation" roleId="tpee.1197027833540" type="tp25.SLinkListAccess" typeId="tp25.1138056282393" id="4208238404730204111" nodeInfo="nn">
                        <link role="link" roleId="tp25.1138056546658" targetNodeId="2c95.3350625596580064250" />
                      </node>
                      <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="4208238404730204112" nodeInfo="nn" />
                    </node>
                  </node>
                </node>
              </node>
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="3126418051240157755" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.3126418051240156265" resolveInfo="Invisble" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="3126418051240157832" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.LineList" id="3126418051240157835" nodeInfo="ng">
          <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="3126418051240157839" nodeInfo="ng" />
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="3126418051240157815" nodeInfo="ng">
            <property name="text" value="dummy" />
            <node role="smodelAttribute" type="tpf8.CopySrcListMacro" typeId="tpf8.1114729360583" id="3126418051240157816" nodeInfo="ln">
              <node role="sourceNodesQuery" roleId="tpf8.1168278589236" type="tpf8.SourceSubstituteMacro_SourceNodesQuery" typeId="tpf8.1167951910403" id="3126418051240157817" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="3126418051240157841" nodeInfo="ng" />
        </node>
      </node>
    </node>
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="6386504476136446960" nodeInfo="lg">
      ...
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="6386504476136446961" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.WordList" id="4457500422381390649" nodeInfo="ng">
          <node role="words" type=".com.mbeddr.doc.latex.structure.TextWord" id="4457500422381390650" nodeInfo="ng">
            <property name="text" value="word" />
          </node>
          <node role="smodelAttribute" type="tpf8.CopySrcNodeMacro" typeId="tpf8.1114706874351" id="4457500422381390652" nodeInfo="ln">
            <node role="sourceNodeQuery" roleId="tpf8.1168024447342" type="tpf8.SourceSubstituteMacro_SourceNodeQuery" typeId="tpf8.1168024337012" id="4457500422381390655" nodeInfo="in">
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="6386504476136240799" nodeInfo="lg">
      ...
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="6386504476136240800" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.WordList" id="4457500422381434581" nodeInfo="ng">
          <node role="words" type=".com.mbeddr.doc.latex.structure.TextWord" id="4457500422381433370" nodeInfo="ng">
            <property name="text" value="word" />
            <node role="smodelAttribute" type="tpf8.CopySrcListMacro" typeId="tpf8.1114729360583" id="4457500422381433372" nodeInfo="ln">
              <node role="sourceNodesQuery" roleId="tpf8.1168278589236" type="tpf8.SourceSubstituteMacro_SourceNodesQuery" typeId="tpf8.1167951910403" id="4457500422381433375" nodeInfo="in">
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="6386504476136436028" nodeInfo="lg">
      ...
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="6386504476136436029" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.LineList" id="4457500422381425973" nodeInfo="ng">
          <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="4457500422381430828" nodeInfo="ng" />
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="4755612053022326356" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="4755612053022326357" nodeInfo="ng">
              <property name="command" value="noindent" />
            </node>
            <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="4755612053022326359" nodeInfo="ln">
              <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="4755612053022326360" nodeInfo="in">
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="4457500422381434583" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.TextWord" id="4457500422381434584" nodeInfo="ng">
              <property name="text" value="word" />
              <node role="smodelAttribute" type="tpf8.CopySrcNodeMacro" typeId="tpf8.1114706874351" id="4457500422381434586" nodeInfo="ln">
                <node role="sourceNodeQuery" roleId="tpf8.1168024447342" type="tpf8.SourceSubstituteMacro_SourceNodeQuery" typeId="tpf8.1168024337012" id="4457500422381434589" nodeInfo="in">
      ...
      <node role="conditionFunction" roleId="tpf8.1167169362365" type="tpf8.BaseMappingRule_Condition" typeId="tpf8.1167168920554" id="5185579450379304182" nodeInfo="in">
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="5185579450379304238" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.3350625596580089586" resolveInfo="TextParagraph" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="5185579450379304239" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.LineList" id="5185579450379304240" nodeInfo="ng">
          <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="5185579450379304241" nodeInfo="ng" />
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="5185579450379304242" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="5185579450379304279" nodeInfo="ng">
              <property name="command" value="parhead" />
              <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="5185579450379304280" nodeInfo="ng">
                <property name="text" value="text" />
                <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="5185579450379304291" nodeInfo="ln">
                  <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
                  <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
                  <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="5185579450379304292" nodeInfo="in">
            ...
            <node role="words" type=".com.mbeddr.doc.latex.structure.TextWord" id="5185579450379304255" nodeInfo="ng">
              <property name="text" value="word" />
              <node role="smodelAttribute" type="tpf8.CopySrcNodeMacro" typeId="tpf8.1114706874351" id="5185579450379304256" nodeInfo="ln">
                <node role="sourceNodeQuery" roleId="tpf8.1168024447342" type="tpf8.SourceSubstituteMacro_SourceNodeQuery" typeId="tpf8.1168024337012" id="5185579450379304257" nodeInfo="in">
      ...
      <node role="conditionFunction" roleId="tpf8.1167169362365" type="tpf8.BaseMappingRule_Condition" typeId="tpf8.1167168920554" id="5185579450379304263" nodeInfo="in">
    ...
    <node role="reductionMappingRule" roleId="tpf8.1167328349397" type="tpf8.Reduction_MappingRule" typeId="tpf8.1167327847730" id="949722786950626151" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1167169349424" targetNodeId="2c95.7992580511422656150" resolveInfo="GreyBoxParagraph" />
      <node role="ruleConsequence" roleId="tpf8.1169672767469" type="tpf8.InlineTemplate_RuleConsequence" typeId="tpf8.1177093525992" id="949722786950626152" nodeInfo="lg">
        <node role="templateNode" roleId="tpf8.1177093586806" type=".com.mbeddr.doc.latex.structure.LineList" id="949722786950626153" nodeInfo="ng">
          <node role="lines" type=".com.mbeddr.doc.latex.structure.EmptyLine" id="949722786950626154" nodeInfo="ng" />
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="949722786950626155" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="949722786950626156" nodeInfo="ng">
              <property name="command" value="noindent" />
            </node>
            <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="949722786950626157" nodeInfo="ln">
              <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="949722786950626158" nodeInfo="in">
                <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="949722786950626159" nodeInfo="sn">
                  <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="949722786950626160" nodeInfo="nn">
                    <node role="expression" roleId="tpee.1068580123156" type="tpee.DotExpression" typeId="tpee.1197027756228" id="949722786950626161" nodeInfo="nn">
                      <node role="operand" roleId="tpee.1197027771414" type="tpee.DotExpression" typeId="tpee.1197027756228" id="949722786950626162" nodeInfo="nn">
                        <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="949722786950626163" nodeInfo="nn" />
                        <node role="operation" roleId="tpee.1197027833540" type="tp25.Node_GetPrevSiblingOperation" typeId="tp25.1143511969223" id="949722786950626164" nodeInfo="nn" />
                      </node>
                      <node role="operation" roleId="tpee.1197027833540" type="tp25.Node_IsInstanceOfOperation" typeId="tp25.1139621453865" id="949722786950626165" nodeInfo="nn">
                        <node role="conceptArgument" roleId="tp25.1177027386292" type="tp25.RefConcept_Reference" typeId="tp25.1177026924588" id="949722786950626166" nodeInfo="nn">
                          <link role="conceptDeclaration" roleId="tp25.1177026940964" targetNodeId="2c95.4755612053022326353" resolveInfo="IInterspersed" />
                        </node>
                      </node>
                    </node>
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="949722786950672565" nodeInfo="ng">
            <property name="text" value="\greyboxnote{" />
          </node>
          <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="949722786950626167" nodeInfo="ng">
            <node role="words" type=".com.mbeddr.doc.latex.structure.TextWord" id="949722786950626168" nodeInfo="ng">
              <property name="text" value="word" />
              <node role="smodelAttribute" type="tpf8.CopySrcNodeMacro" typeId="tpf8.1114706874351" id="949722786950626169" nodeInfo="ln">
                <node role="sourceNodeQuery" roleId="tpf8.1168024447342" type="tpf8.SourceSubstituteMacro_SourceNodeQuery" typeId="tpf8.1168024337012" id="949722786950626170" nodeInfo="in">
                  <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="949722786950626171" nodeInfo="sn">
                    <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="949722786950626172" nodeInfo="nn">
                      <node role="expression" roleId="tpee.1068580123156" type="tpee.DotExpression" typeId="tpee.1197027756228" id="949722786950626173" nodeInfo="nn">
                        <node role="operation" roleId="tpee.1197027833540" type="tp25.SLinkAccess" typeId="tp25.1138056143562" id="949722786950659757" nodeInfo="nn">
                          <link role="link" roleId="tp25.1138056516764" targetNodeId="2c95.7992580511422656152" />
                        </node>
                        <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="949722786950626175" nodeInfo="nn" />
                      </node>
                    </node>
                  </node>
                </node>
          ...
          <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="949722786950676067" nodeInfo="ng">
            <property name="text" value="}" />
          </node>
        </node>
      </node>
    ...
    <node role="rootMappingRule" roleId="tpf8.1167514678247" type="tpf8.Root_MappingRule" typeId="tpf8.1167514355419" id="4457500422381352770" nodeInfo="lg">
      ...
      <node role="conditionFunction" roleId="tpf8.1167169362365" type="tpf8.BaseMappingRule_Condition" typeId="tpf8.1167168920554" id="4457500422381352888" nodeInfo="in">
    ...
    <node role="rootMappingRule" roleId="tpf8.1167514678247" type="tpf8.Root_MappingRule" typeId="tpf8.1167514355419" id="2293093897292837046" nodeInfo="lg">
      ...
      <node role="conditionFunction" roleId="tpf8.1167169362365" type="tpf8.BaseMappingRule_Condition" typeId="tpf8.1167168920554" id="2293093897292837047" nodeInfo="in">
    ...
    <node role="condition" roleId="tpf8.7830515785164764091" type="tpf8.MappingConfiguration_Condition" typeId="tpf8.7830515785164762753" id="4457500422381355301" nodeInfo="in">
    ...
    <node role="preMappingScript" roleId="tpf8.1195502100749" type="tpf8.MappingScriptReference" typeId="tpf8.1195502151594" id="4457500422381375576" nodeInfo="lg">
      <link role="mappingScript" roleId="tpf8.1195502167610" targetNodeId="6386504476136566047" resolveInfo="storeExportInDocument" />
    </node>
  </root>
  <root type=".com.mbeddr.doc.latex.structure.LatexDocument" id="4457500422381352771" nodeInfo="ng">
    <property name="name" value="map_DocumentExport" />
    <property name="documentClass" value="cls" />
    <node role="contents" type=".com.mbeddr.doc.latex.structure.WordLine" id="126932837435349039" nodeInfo="ng">
      <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="126932837435349040" nodeInfo="ng">
        <property name="command" value="maketitle" />
      </node>
    </node>
    <node role="contents" type=".com.mbeddr.doc.latex.structure.LineList" id="126932837435352113" nodeInfo="ng">
      <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="126932837435352114" nodeInfo="ng">
        <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="126932837435352115" nodeInfo="ng">
          <property name="command" value="begin" />
          <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="126932837435352116" nodeInfo="ng">
            <property name="text" value="abstract" />
          </node>
        </node>
      </node>
      <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="126932837435368491" nodeInfo="ng">
        <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="126932837435368492" nodeInfo="ng">
          <property name="command" value="noindent" />
        </node>
      </node>
      <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="9186986816326867705" nodeInfo="ng">
        <node role="words" type=".com.mbeddr.doc.latex.structure.TextWord" id="9186986816326867706" nodeInfo="ng">
          <property name="text" value="word" />
          <node role="smodelAttribute" type="tpf8.CopySrcListMacro" typeId="tpf8.1114729360583" id="9186986816326867708" nodeInfo="ln">
            <node role="sourceNodesQuery" roleId="tpf8.1168278589236" type="tpf8.SourceSubstituteMacro_SourceNodesQuery" typeId="tpf8.1167951910403" id="9186986816326867709" nodeInfo="in">
      ...
      <node role="lines" type=".com.mbeddr.doc.latex.structure.WordLine" id="126932837435352117" nodeInfo="ng">
        <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="126932837435352118" nodeInfo="ng">
          <property name="command" value="end" />
          <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="126932837435352119" nodeInfo="ng">
            <property name="text" value="abstract" />
          </node>
        </node>
      </node>
      <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="126932837435352133" nodeInfo="ln">
        <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="126932837435352134" nodeInfo="in">
    ...
    <node role="contents" type=".com.mbeddr.doc.latex.structure.LineList" id="5185579450379343885" nodeInfo="ng">
      <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="5185579450379315421" nodeInfo="ln">
        <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="5185579450379315422" nodeInfo="in">
      ...
      <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5185579450379315419" nodeInfo="ng">
        <property name="text" value="\newpage" />
      </node>
      <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5185579450379343887" nodeInfo="ng">
        <property name="text" value="\tableofcontents" />
      </node>
    </node>
    <node role="contents" type=".com.mbeddr.doc.latex.structure.LineList" id="5185579450379343888" nodeInfo="ng">
      <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="5185579450379343889" nodeInfo="ln">
        <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="5185579450379343890" nodeInfo="in">
      ...
      <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5185579450379343899" nodeInfo="ng">
        <property name="text" value="\newpage" />
      </node>
      <node role="lines" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5185579450379343900" nodeInfo="ng">
        <property name="text" value="\listoffigures" />
      </node>
    </node>
    <node role="contents" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="5185579450379343904" nodeInfo="ng">
      <property name="text" value="\newpage" />
      <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="5185579450379343906" nodeInfo="ln">
        <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="5185579450379343907" nodeInfo="in">
    ...
    <node role="smodelAttribute" type="tpf8.RootTemplateAnnotation" typeId="tpf8.1168619357332" id="4457500422381352772" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1168619429071" targetNodeId="2c95.3350625596580256366" resolveInfo="DocumentExport" />
    </node>
    <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="4457500422381352773" nodeInfo="ln">
      <property name="propertyName" nameId="tpck.1757699476691236117" value="documentClass" />
      <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381350412/4457500422381350415" />
      <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="4457500422381352776" nodeInfo="in">
    ...
    <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="4457500422381359950" nodeInfo="ln">
      ...
      <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="4457500422381359953" nodeInfo="in">
    ...
    <node role="contents" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="4457500422381362065" nodeInfo="ng">
      <property name="text" value="dummyLine" />
      <node role="smodelAttribute" type="tpf8.CopySrcNodeMacro" typeId="tpf8.1114706874351" id="6165313375056051076" nodeInfo="ln">
        <node role="sourceNodeQuery" roleId="tpf8.1168024447342" type="tpf8.SourceSubstituteMacro_SourceNodeQuery" typeId="tpf8.1168024337012" id="6165313375056051077" nodeInfo="in">
    ...
    <node role="prologs" type=".com.mbeddr.doc.latex.structure.WordLine" id="4755612053022230707" nodeInfo="ng">
      <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="4755612053022230708" nodeInfo="ng">
        <property name="command" value="input" />
        <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="4755612053022230709" nodeInfo="ng">
          <property name="text" value="prolog" />
          <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="4755612053022230710" nodeInfo="ln">
            <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
            <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
            <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="4755612053022230711" nodeInfo="in">
    ...
    <node role="prologs" type=".com.mbeddr.doc.latex.structure.WordLine" id="126932837435349026" nodeInfo="ng">
      <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="126932837435349027" nodeInfo="ng">
        <property name="command" value="title" />
        <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="126932837435349028" nodeInfo="ng">
          <property name="text" value="title" />
          <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="126932837435349029" nodeInfo="ln">
            <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
            <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
            <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="126932837435349032" nodeInfo="in">
    ...
    <node role="prologs" type=".com.mbeddr.doc.latex.structure.WordLine" id="126932837435390990" nodeInfo="ng">
      <node role="words" type=".com.mbeddr.doc.latex.structure.CommandWord" id="126932837435390991" nodeInfo="ng">
        <property name="command" value="author" />
        <node role="args" type=".com.mbeddr.doc.latex.structure.TextWord" id="126932837435390992" nodeInfo="ng">
          <property name="text" value="authorstring" />
          <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="126932837435390993" nodeInfo="ln">
            <property name="propertyName" nameId="tpck.1757699476691236117" value="text" />
            <property name="propertyId" nameId="tpck.1341860900487648621" value="f8f68d92-c6d2-44b3-8d63-c00ade75ec86/4457500422381364540/4457500422381364541" />
            <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="126932837435390994" nodeInfo="in">
                                          ...
                                          <node role="expression" roleId="tpee.1079359253376" type="tpee.EqualsExpression" typeId="tpee.1068580123152" id="126932837435392314" nodeInfo="nn">
                                            <node role="leftExpression" roleId="tpee.1081773367580" type="tpee.DotExpression" typeId="tpee.1197027756228" id="126932837435467324" nodeInfo="nn">
                                              <node role="operation" roleId="tpee.1197027833540" type="tp2q.GetIndexOfOperation" typeId="tp2q.1171391069720" id="126932837435467329" nodeInfo="nn">
                                                <node role="argument" roleId="tp2q.540871147943773366" type="tpee.ParameterReference" typeId="tpee.1068581242874" id="126932837435467331" nodeInfo="nn">
                                                  <link role="variableDeclaration" roleId="tpee.1068581517664" targetNodeId="126932837435392072" resolveInfo="it" />
                                                </node>
                                              </node>
      ...
      <node role="smodelAttribute" type="tpf8.IfMacro" typeId="tpf8.1118773211870" id="126932837435392402" nodeInfo="ln">
        <node role="conditionFunction" roleId="tpf8.1167945861827" type="tpf8.IfMacro_Condition" typeId="tpf8.1167945743726" id="126932837435392403" nodeInfo="in">
  ...
  <root type=".com.mbeddr.doc.latex.structure.LatexIncludable" id="2293093897292837056" nodeInfo="ng">
    <property name="name" value="map_IncludableExport" />
    <node role="contents" type=".com.mbeddr.doc.latex.structure.SimpleTextualLine" id="2293093897292826286" nodeInfo="ng">
      <property name="text" value="dummyLine" />
      <node role="smodelAttribute" type="tpf8.CopySrcNodeMacro" typeId="tpf8.1114706874351" id="2293093897292826287" nodeInfo="ln">
        <node role="sourceNodeQuery" roleId="tpf8.1168024447342" type="tpf8.SourceSubstituteMacro_SourceNodeQuery" typeId="tpf8.1168024337012" id="2293093897292826288" nodeInfo="in">
    ...
    <node role="smodelAttribute" type="tpf8.RootTemplateAnnotation" typeId="tpf8.1168619357332" id="2293093897292837057" nodeInfo="lg">
      <link role="applicableConcept" roleId="tpf8.1168619429071" targetNodeId="2c95.6068976060904007493" resolveInfo="IncludableExport" />
    </node>
    <node role="smodelAttribute" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="2293093897292837058" nodeInfo="ln">
      <property name="propertyName" nameId="tpck.1757699476691236117" value="name" />
      <property name="propertyId" nameId="tpck.1341860900487648621" value="ceab5195-25ea-4f22-9b92-103b95ca8c0c/1169194658468/1169194664001" />
      <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="2293093897292837059" nodeInfo="in">
