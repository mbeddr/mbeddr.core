...
<model ref="r:9e71b142-f269-4237-8701-257cbfe7c45f(test.ex.com.mbeddr.cpp.errorHandling)">
  ...
  <node concept="2v9HqL" id="4o2nsMgBpPh">
    ...
    <node concept="2eOfOl" id="4o2nsMgBpPF" role="2ePNbc">
      ...
      <node concept="2v9HqM" id="3e4PW89KKcG" role="2eOfOg">
        <ref role="2v9HqP" node="4WhfN3ocL2A" resolve="TryCatch" />
      </node>
    </node>
