...
<model ref="r:bc3abdeb-d2a0-419a-bc0b-40994deb926a(test.debugging.ext.statemachines.stepover)">
  ...
  <node concept="2v9HqL" id="3_UUdaFlgP0">
    ...
    <node concept="2eOfOl" id="3_UUdaFlgP4" role="2ePNbc">
      ...
      <node concept="1l1$C7" id="4JZ_DSxxThm" role="1kZvWc">
        <property role="TrG5h" value="any" />
      </node>
    </node>
    <node concept="2AWWZL" id="3uHGTbhzFJE" role="2AWWZH">
