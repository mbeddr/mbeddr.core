...
<model ref="r:b4d22c13-e9f7-41ae-b47e-f000e0a49da8(test.debugging.core.opaque@tests)">
  ...
  <node concept="N3F5e" id="2ZsiEc0Hz">
    ...
    <node concept="N3Fnx" id="2ZsiEc0H$" role="N3F5h">
      <property role="TrG5h" value="main" />
      <property role="2OOxQR" value="true" />
      <node concept="3XIRFW" id="2ZsiEc0H_" role="3XIRFX">
        <node concept="2BFjQ_" id="2ZsiEc0HA" role="3XIRFZ">
          <node concept="3rBj6X" id="2ZsiEc0HB" role="2BFjQA">
            <node concept="3cM6IN" id="2ZsiEc0HC" role="3cM6Hi">
              <ref role="3cM6IK" node="2ZsiEc0HK" resolve="testCase1" />
            </node>
          </node>
        </node>
      </node>
      <node concept="26Vqph" id="2ZsiEc0HD" role="2C2TGm">
        <property role="2caQfQ" value="false" />
        <property role="2c7vTL" value="false" />
      </node>
    </node>
