...
<solution name="com.mbeddr.debugger.tests.__spreferences.PlatformTemplates" uuid="~_PreferencesModule#com.mbeddr.debugger.tests.__spreferences.PlatformTemplates" moduleVersion="0" compileInMPS="true">
  <models>
