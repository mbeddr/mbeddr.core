...
<solution name="com.mbeddr.mpsutil.soot.runtime" uuid="31de6f10-3ed5-48f3-9246-5d637e71195c" moduleVersion="0" pluginKind="PLUGIN_OTHER" compileInMPS="true">
  <models>
    <modelRoot contentPath="${module}" type="default">
      <sourceRoot location="models" />
    </modelRoot>
    <modelRoot contentPath="${module}/lib" type="java_classes">
      <sourceRoot location="heros-trunk.jar" />
      <sourceRoot location="jamsin-trunk.jar" />
      <sourceRoot location="soot-trunk.jar" />
    </modelRoot>
  </models>
  <stubModelEntries>
    <stubModelEntry path="${module}/lib/heros-trunk.jar" />
    <stubModelEntry path="${module}/lib/jamsin-trunk.jar" />
    <stubModelEntry path="${module}/lib/soot-trunk.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
    ...
    <dependency reexport="true">85836058-a162-41d7-bb1d-52e99d873f28(jetbrains.mps.ide.vcs.core)</dependency>
