...
<model modelUID="r:4256640a-6763-428e-be83-493e9ca6d58d(com.mbeddr.analyses.base.unittests.editor)" version="0">
  ...
  <root type="tpc2.ConceptEditorDeclaration" typeId="tpc2.1071666914219" id="2331667280820016343" nodeInfo="ng">
    ...
    <node role="cellModel" roleId="tpc2.1080736633877" type="tpc2.CellModel_Collection" typeId="tpc2.1073389446423" id="5738929523990223193" nodeInfo="nn">
      <node role="childCellModel" roleId="tpc2.1073389446424" type="tpc2.CellModel_Constant" typeId="tpc2.1073389577006" id="5738929523990223195" nodeInfo="nn">
        <property name="text" nameId="tpc2.1073389577007" value="concepts not instantiated in the current model" />
      </node>
      <node role="childCellModel" roleId="tpc2.1073389446424" type="tpc2.CellModel_Collection" typeId="tpc2.1073389446423" id="5738929523990223203" nodeInfo="nn">
        <node role="styleItem" roleId="tpc2.1219418656006" type="tpc2.SelectableStyleSheetItem" typeId="tpc2.1186414928363" id="5738929523990223205" nodeInfo="nn">
          <property name="flag" nameId="tpc2.1186414551515" value="false" />
        </node>
        <node role="childCellModel" roleId="tpc2.1073389446424" type="tpc2.CellModel_Indent" typeId="tpc2.1198256887712" id="5738929523990223215" nodeInfo="ng" />
        <node role="childCellModel" roleId="tpc2.1073389446424" type="tpc2.CellModel_Constant" typeId="tpc2.1073389577006" id="5738929523990223221" nodeInfo="nn">
          <property name="text" nameId="tpc2.1073389577007" value="languages of interest:" />
        </node>
        <node role="childCellModel" roleId="tpc2.1073389446424" type="tpc2.CellModel_RefNodeList" typeId="tpc2.1073390211982" id="5738929523990223253" nodeInfo="ng">
          <property name="separatorText" nameId="tpc2.1140524450557" value="," />
          <link role="relationDeclaration" roleId="tpc2.1140103550593" targetNodeId="1b9n.5738929523990223251" />
          <node role="cellLayout" roleId="tpc2.1140524464360" type="tpc2.CellLayout_Indent" typeId="tpc2.1237303669825" id="5738929523990223254" nodeInfo="nn" />
        </node>
        <node role="cellLayout" roleId="tpc2.1106270802874" type="tpc2.CellLayout_Indent" typeId="tpc2.1237303669825" id="5738929523990223208" nodeInfo="nn" />
      </node>
      <node role="cellLayout" roleId="tpc2.1106270802874" type="tpc2.CellLayout_Vertical" typeId="tpc2.1106270571710" id="5738929523990223196" nodeInfo="nn" />
    </node>
  </root>
  ...
  <root type="tpc2.ConceptEditorDeclaration" typeId="tpc2.1071666914219" id="5738929523990223246" nodeInfo="ng">
    <property name="virtualPackage" nameId="tpck.1193676396447" value="assessment" />
    <link role="conceptDeclaration" roleId="tpc2.1166049300910" targetNodeId="1b9n.5738929523990223229" resolveInfo="LanguagePrefix" />
    <node role="cellModel" roleId="tpc2.1080736633877" type="tpc2.CellModel_Property" typeId="tpc2.1073389658414" id="5738929523990223248" nodeInfo="ng">
      <link role="relationDeclaration" roleId="tpc2.1140103550593" targetNodeId="1b9n.5738929523990223239" resolveInfo="prefix" />
    </node>
  </root>
</model>
