...
<model ref="r:7b785558-f1d8-4dff-b197-3cb9a830d892(test.analyses.cbmc.testcode.dummy@tests)">
  ...
  <node concept="3s_ewN" id="51$t$RVCl7a">
    <property role="3s_ewP" value="DummyTestCase" />
    <node concept="3Tm1VV" id="51$t$RVCl7b" role="1B3o_S" />
    <node concept="3s_gsd" id="51$t$RVCl7c" role="3s_ewO">
