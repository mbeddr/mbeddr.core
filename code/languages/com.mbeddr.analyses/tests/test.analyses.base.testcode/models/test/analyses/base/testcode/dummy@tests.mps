...
<model ref="r:91e0e3e8-a98b-4d43-8f13-0db47f3b1060(test.analyses.base.testcode.dummy@tests)">
  ...
  <node concept="3s_ewN" id="7xB2TTpC3hw">
    <property role="3s_ewP" value="DummyTestCase" />
    <node concept="3Tm1VV" id="7xB2TTpC3hx" role="1B3o_S" />
    <node concept="3s_gsd" id="7xB2TTpC3hy" role="3s_ewO">
