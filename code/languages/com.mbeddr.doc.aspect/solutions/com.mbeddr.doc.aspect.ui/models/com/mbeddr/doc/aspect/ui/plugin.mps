    ...
    <node concept="2XrIbr" id="7NPCd7DGkBv" role="2XNbBy">
      ...
      <node concept="3clFbS" id="7NPCd7DGkBx" role="3clF47">
        ...
        <node concept="3SKdUt" id="18EYPZeyV5H" role="3cqZAp">
          <node concept="3SKdUq" id="18EYPZeyV5J" role="3SKWNk">
            <property role="3SKdUp" value="show the concept doc content if no node is selected" />
          </node>
        </node>
        <node concept="3SKdUt" id="18EYPZeyVn$" role="3cqZAp">
          <node concept="3SKdUq" id="18EYPZeyVnA" role="3SKWNk">
            <property role="3SKdUp" value="or if the language of the selected node's concept has doc aspect" />
          </node>
        </node>
            ...
            <node concept="3clFbJ" id="18EYPZeyjbg" role="3cqZAp">
              <node concept="3clFbS" id="18EYPZeyjbi" role="3clFbx">
                <node concept="3SKdUt" id="18EYPZeCo5L" role="3cqZAp">
                  <node concept="3SKdUq" id="18EYPZeCo5N" role="3SKWNk">
                    <property role="3SKdUp" value="use the low-level API (and ignore the type system error) because this is the only way to set the open flag" />
                  </node>
                </node>
        ...
        <node concept="3SKdUt" id="18EYPZeyUCE" role="3cqZAp">
          <node concept="3SKdUq" id="18EYPZeyUCG" role="3SKWNk">
            <property role="3SKdUp" value="always show the node doc content" />
          </node>
        </node>
        ...
        <node concept="3SKdUt" id="18EYPZeDKVY" role="3cqZAp">
          <node concept="3SKdUq" id="18EYPZeDKW0" role="3SKWNk">
            <property role="3SKdUp" value="make sure that we preserve the state of the tool" />
          </node>
        </node>
          ...
          <node concept="9aQIb" id="7NPCd7DET$n" role="9aQIa">
            <node concept="3clFbS" id="7NPCd7DET$o" role="9aQI4">
              ...
              <node concept="3SKdUt" id="7NPCd7DEHWN" role="3cqZAp">
                <node concept="3SKdUq" id="7NPCd7DEHWP" role="3SKWNk">
                  <property role="3SKdUp" value="show documentation for node" />
                </node>
              </node>
              ...
              <node concept="3SKdUt" id="11K_5nNfofo" role="3cqZAp">
                <node concept="3SKdUq" id="11K_5nNfofp" role="3SKWNk">
                  <property role="3SKdUp" value="show documentation for concept" />
                </node>
              </node>
              ...
              <node concept="3SKdUt" id="7NPCd7DFoFV" role="3cqZAp">
                <node concept="3SKdUq" id="7NPCd7DFoFX" role="3SKWNk">
                  <property role="3SKdUp" value="give priority to concept doc, so set the respective content last" />
                </node>
              </node>
