...
<model modelUID="r:74f3485b-068f-405b-85fa-67fceedd8b59(test.ex.core.reporting)">
  ...
  <roots>
    <node type=".com.mbeddr.core.modules.structure.ImplementationModule" id="6209278014151030839">
      <property name="name" value="ReportingTest" />
    </node>
    <node type="mj1l.TypeSizeConfiguration" typeId="mj1l.3335993110369795380" id="6209278014151030840" />
    <node type=".com.mbeddr.core.buildconfig.structure.BuildConfiguration" id="6209278014151077417" />
  </roots>
  <root id="6209278014151030839">
    <node role="contents" type=".com.mbeddr.core.util.structure.MessageDefinitionTable" id="6209278014151030888">
    ...
    <node role="contents" type=".com.mbeddr.core.modules.structure.EmptyModuleContent" id="2187572410167375340">
      <property name="name" value="empty_1342350652000_2" />
    </node>
    <node role="contents" type=".com.mbeddr.core.unittest.structure.TestCase" id="6209278014151035904">
      ...
      <node role="body" type="c4fa.StatementList" typeId="c4fa.4185783222026475861" id="6209278014151035906">
        <node role="statements" roleId="c4fa.4185783222026475862" type=".com.mbeddr.core.util.structure.ReportStatement" id="4094831577251207314">
        ...
        <node role="statements" roleId="c4fa.4185783222026475862" type=".com.mbeddr.core.unittest.structure.AssertStatement" id="6209278014151047338">
    ...
    <node role="contents" type=".com.mbeddr.core.modules.structure.EmptyModuleContent" id="2187572410167375339">
      <property name="name" value="empty_1342350650291_1" />
    </node>
    <node role="contents" type=".com.mbeddr.core.unittest.structure.TestCase" id="2187572410167375346">
      <property name="exported" value="true" />
      ...
      <node role="body" type="c4fa.StatementList" typeId="c4fa.4185783222026475861" id="2187572410167375348">
        ...
        <node role="statements" roleId="c4fa.4185783222026475862" type="c4fa.LocalVariableDeclaration" typeId="c4fa.4185783222026475238" id="2187572410167375381">
          ...
          <node role="init" roleId="c4fa.4185783222026502647" type=".com.mbeddr.core.util.structure.LogExpression" id="2187572410167375386">
            <property name="contextNodeIdD" value="2187572410167375386" />
            <node role="expression" type="c4fa.LocalVarRef" typeId="c4fa.2093108837558113914" id="2187572410167375384">
        ...
        <node role="statements" roleId="c4fa.4185783222026475862" type="c4fa.LocalVariableDeclaration" typeId="c4fa.4185783222026475238" id="2187572410167375388">
          ...
          <node role="init" roleId="c4fa.4185783222026502647" type=".com.mbeddr.core.util.structure.LogExpression" id="2187572410167376691">
            ...
            <node role="expression" type="mj1l.PlusExpression" typeId="mj1l.5763383285156373013" id="2187572410167375395">
              <node role="right" roleId="mj1l.8860443239512128065" type=".com.mbeddr.core.util.structure.LogExpression" id="2187572410167852363">
                ...
                <node role="expression" type="c4fa.LocalVarRef" typeId="c4fa.2093108837558113914" id="2187572410167375398">
                  <link role="var" roleId="c4fa.2093108837558124071" targetNodeId="2187572410167375376" resolveInfo="x" />
                </node>
              </node>
        ...
        <node role="statements" roleId="c4fa.4185783222026475862" type="c4fa.LocalVariableDeclaration" typeId="c4fa.4185783222026475238" id="2187572410167376693">
          ...
          <node role="init" roleId="c4fa.4185783222026502647" type="mj1l.MultiExpression" typeId="mj1l.5763383285156373020" id="2187572410167376699">
            <node role="right" roleId="mj1l.8860443239512128065" type=".com.mbeddr.core.util.structure.LogExpression" id="2187572410167376703">
              ...
              <node role="expression" type="c4fa.LocalVarRef" typeId="c4fa.2093108837558113914" id="2187572410167376702">
                <link role="var" roleId="c4fa.2093108837558124071" targetNodeId="2187572410167375376" resolveInfo="x" />
              </node>
            </node>
    ...
    <node role="contents" type=".com.mbeddr.core.modules.structure.EmptyModuleContent" id="2187572410167375342">
      <property name="name" value="empty_1342350655584_4" />
    </node>
    <node role="contents" type=".com.mbeddr.core.modules.structure.Function" id="6209278014151035908">
      <property name="name" value="main" />
      <property name="exported" value="true" />
      <node role="body" type="c4fa.StatementList" typeId="c4fa.4185783222026475861" id="6209278014151035909">
        <node role="statements" roleId="c4fa.4185783222026475862" type=".com.mbeddr.core.modules.structure.ReturnStatement" id="6209278014151035918">
          <node role="expression" type=".com.mbeddr.core.unittest.structure.ExecuteTestExpression" id="6209278014151035919">
      ...
      <node role="type" type="mj1l.Int32tType" typeId="mj1l.8463282783691618440" id="6209278014151035911" />
      <node role="arguments" type=".com.mbeddr.core.modules.structure.Argument" id="6209278014151035912">
        <property name="name" value="argc" />
        <node role="type" type="mj1l.Int32tType" typeId="mj1l.8463282783691618440" id="6209278014151035913" />
      </node>
      <node role="arguments" type=".com.mbeddr.core.modules.structure.Argument" id="6209278014151035914">
        <property name="name" value="argv" />
        <node role="type" type="yq40.ArrayType" typeId="yq40.5679441017214012545" id="6209278014151035915">
  ...
  <root id="6209278014151077417">
    <node role="binaries" type=".com.mbeddr.core.buildconfig.structure.Executable" id="6209278014151077418">
      <property name="name" value="Reporting" />
      <property name="isTest" value="true" />
      <node role="referencedModules" type=".com.mbeddr.core.buildconfig.structure.ModuleRef" id="6209278014151077419">
        <link role="module" targetNodeId="6209278014151030839" resolveInfo="ReportingTest" />
      </node>
    </node>
    <node role="target" type=".com.mbeddr.core.buildconfig.structure.DesktopPlatform" id="4459718605982730226">
      <property name="compiler" value="gcc" />
      <property name="compilerOptions" value="-std=c99" />
      <property name="debugOptions" value="-g" />
    </node>
    <node role="configurationItems" type=".com.mbeddr.core.util.structure.ReportingConfiguration" id="4459718605982730227">
