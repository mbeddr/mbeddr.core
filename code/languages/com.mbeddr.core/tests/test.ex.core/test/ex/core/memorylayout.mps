...
<model modelUID="r:2234c69a-bcf9-475a-8036-7d8a47dffbe3(test.ex.core.memorylayout)">
  ...
  <root id="1730914748330744337">
    ...
    <node role="contents" roleId="x27k.6437088627575722833" type="x27k.EmptyModuleContent" typeId="x27k.8934095934011938595" id="1730914748330839731">
      <property name="name" nameId="tpck.1169194664001" value="empty_1334839643384_1" />
    </node>
