...
<model modelUID="r:2234c69a-bcf9-475a-8036-7d8a47dffbe3(test.ex.core.memorylayout)">
  ...
  <roots>
    <node type=".com.mbeddr.core.modules.structure.ImplementationModule" id="1730914748330744337">
      <property name="name" value="MemoryLayoutTest" />
    </node>
    <node type="mj1l.TypeSizeConfiguration" typeId="mj1l.3335993110369795380" id="1730914748330744338" />
    <node type=".com.mbeddr.core.buildconfig.structure.BuildConfiguration" id="1730914748330862720" />
  </roots>
  <root id="1730914748330744337">
    <node role="contents" type="nbyu.NVMLayoutSpec" typeId="nbyu.1730914748330889914" id="1730914748330802572">
    ...
    <node role="contents" type=".com.mbeddr.core.modules.structure.EmptyModuleContent" id="7663814905233551951">
      <property name="name" value="empty_1334843942149_1" />
    </node>
    <node role="contents" type="nbyu.NVMLayoutSpec" typeId="nbyu.1730914748330889914" id="7663814905233551942">
    ...
    <node role="contents" type=".com.mbeddr.core.modules.structure.EmptyModuleContent" id="1730914748330827605">
      <property name="name" value="empty_1334839498337_1" />
    </node>
    <node role="contents" type=".com.mbeddr.core.unittest.structure.TestCase" id="1730914748330862766">
      ...
      <node role="body" type="c4fa.StatementList" typeId="c4fa.4185783222026475861" id="1730914748330839734">
        ...
        <node role="statements" roleId="c4fa.4185783222026475862" type="c4fa.LocalVariableDeclaration" typeId="c4fa.4185783222026475238" id="3536225861349780292">
          ...
          <node role="type" roleId="mj1l.318113533128716676" type="mj1l.UnsignedInt8tType" typeId="mj1l.8463282783691618461" id="236363977594764397">
        ...
        <node role="statements" roleId="c4fa.4185783222026475862" type=".com.mbeddr.core.unittest.structure.AssertStatement" id="1730914748330888250">
    ...
    <node role="contents" type=".com.mbeddr.core.modules.structure.EmptyModuleContent" id="1730914748330862752">
      <property name="name" value="empty_1334840190877_1" />
    </node>
    <node role="contents" type=".com.mbeddr.core.modules.structure.Function" id="1730914748330862754">
      <property name="name" value="main" />
      <property name="exported" value="true" />
      <node role="body" type="c4fa.StatementList" typeId="c4fa.4185783222026475861" id="1730914748330862755">
        <node role="statements" roleId="c4fa.4185783222026475862" type=".com.mbeddr.core.modules.structure.ReturnStatement" id="1730914748330862757">
          <node role="expression" type=".com.mbeddr.core.unittest.structure.ExecuteTestExpression" id="1730914748330862768">
      ...
      <node role="type" type="mj1l.Int32tType" typeId="mj1l.8463282783691618440" id="1730914748330862759" />
      <node role="arguments" type=".com.mbeddr.core.modules.structure.Argument" id="1730914748330862760">
        <property name="name" value="argc" />
        <node role="type" type="mj1l.Int32tType" typeId="mj1l.8463282783691618440" id="1730914748330862761" />
      </node>
      <node role="arguments" type=".com.mbeddr.core.modules.structure.Argument" id="1730914748330862762">
        <property name="name" value="argv" />
        <node role="type" type="yq40.ArrayType" typeId="yq40.5679441017214012545" id="1730914748330862763">
    ...
    <node role="contents" type=".com.mbeddr.core.modules.structure.EmptyModuleContent" id="1730914748330827607">
      <property name="name" value="empty_1334839498617_3" />
    </node>
    <node role="contents" type=".com.mbeddr.core.modules.structure.EmptyModuleContent" id="1730914748330827608">
      <property name="name" value="empty_1334839498770_4" />
    </node>
    <node role="contents" type=".com.mbeddr.core.modules.structure.EmptyModuleContent" id="1730914748330827609">
      <property name="name" value="empty_1334839498874_5" />
    </node>
  </root>
  ...
  <root id="1730914748330862720">
    <node role="target" type=".com.mbeddr.core.buildconfig.structure.DesktopPlatform" id="1730914748330862721">
      <property name="compiler" value="gcc" />
      <property name="compilerOptions" value="-std=c99" />
      <property name="debugOptions" value="-g" />
    </node>
    <node role="configurationItems" type=".com.mbeddr.core.util.structure.ReportingConfiguration" id="1730914748330862722">
      <node role="strategy" type=".com.mbeddr.core.util.structure.PrintfReportingStrategy" id="1730914748330862723" />
    </node>
    <node role="binaries" type=".com.mbeddr.core.buildconfig.structure.Executable" id="1730914748330862724">
      <property name="name" value="MemoryLayoutTest" />
      <node role="referencedModules" type=".com.mbeddr.core.buildconfig.structure.ModuleRef" id="1730914748330862751">
        <link role="module" targetNodeId="1730914748330744337" resolveInfo="MemoryLayoutTest" />
      </node>
    </node>
  </root>
</model>
