...
public class CModulesInterpreter_extension extends Extension.Default<IInterpreter> {
  public CModulesInterpreter_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterCModulesInterpreter();
  }
}
