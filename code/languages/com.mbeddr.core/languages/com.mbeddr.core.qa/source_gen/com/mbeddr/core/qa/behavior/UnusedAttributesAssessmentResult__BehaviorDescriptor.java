...
public final class UnusedAttributesAssessmentResult__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xc8e0d19c3cf4b31L, 0xaf77531227edbce8L, 0x4a73996f914b7776L, "com.mbeddr.core.qa.structure.UnusedAttributesAssessmentResult");
  ...
  /*package*/ static String uniqueIdentifier_idK292flwHwe(@NotNull SNode __thisNode__) {
    return SNodeOperations.getConcept(SLinkOperations.getTarget(__thisNode__, LINKS.part$HZhp)).getName();
  }
  /*package*/ static void updateValues_id5L$H31Kf5$y(@NotNull SNode __thisNode__, SNode updatedResult) {
  }

  /*package*/ UnusedAttributesAssessmentResult__BehaviorDescriptor() {
  }
