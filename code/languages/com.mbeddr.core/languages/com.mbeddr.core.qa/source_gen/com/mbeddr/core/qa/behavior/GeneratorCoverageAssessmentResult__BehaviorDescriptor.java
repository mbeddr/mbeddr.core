...
public final class GeneratorCoverageAssessmentResult__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xc8e0d19c3cf4b31L, 0xaf77531227edbce8L, 0x6f54133473570625L, "com.mbeddr.core.qa.structure.GeneratorCoverageAssessmentResult");
  ...
  /*package*/ static String uniqueIdentifier_idK292flwHwe(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.generatorFragment$ih7B).getNodeId().toString();
  }
  /*package*/ static void updateValues_id5L$H31Kf5$y(@NotNull SNode __thisNode__, SNode updatedResult) {
  }

  /*package*/ GeneratorCoverageAssessmentResult__BehaviorDescriptor() {
  }
