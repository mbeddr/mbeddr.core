...
public final class OctalNumberLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x61c69711ed614850L, 0x81d97714ff227fb0L, 0xd04cd1bfc474145L, "com.mbeddr.core.expressions.structure.OctalNumberLiteral");
  ...
  /*package*/ static Object evaluateStatically_id6OxpEKG0KPv(@NotNull SNode __thisNode__) {
    if (isNotEmptyString(SPropertyOperations.getString(__thisNode__, PROPS.value$qZmE))) {
      return new BigInteger(SPropertyOperations.getString(__thisNode__, PROPS.value$qZmE), 8);
    } else {
      return BigInteger.ZERO;
    }
  }
  /*package*/ static String renderReadable_id1VQvajLb13M(@NotNull SNode __thisNode__) {
    return "0" + SPropertyOperations.getString(__thisNode__, PROPS.value$qZmE);
  }

  /*package*/ OctalNumberLiteral__BehaviorDescriptor() {
  }
