...
public final class HexNumberLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x61c69711ed614850L, 0x81d97714ff227fb0L, 0xea19691e38c3fccL, "com.mbeddr.core.expressions.structure.HexNumberLiteral");
  ...
  /*package*/ static String renderReadable_id1VQvajLb13M(@NotNull SNode __thisNode__) {
    return "0x" + SPropertyOperations.getString(__thisNode__, PROPS.value$qZmE);
  }

  /*package*/ HexNumberLiteral__BehaviorDescriptor() {
  }
