...
public class BracketsCell_SideTransformations_ParensExpression_a0 extends TransformationMenuBase {
  ...
  public List<TransformationMenuItem> createMenuItems(@NotNull TransformationMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default transformation menu for " + "Expression", new SNodePointer("r:53e59391-150a-45ff-930e-2b4fdafb0904(com.mbeddr.core.expressions.editor)", "2862331529394113450")));
    try {
