...
public final class surroundWithCast_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  private Collection<IntentionExecutable> myCachedExecutable;

  public surroundWithCast_Intention() {
    super(Kind.NORMAL, false, new SNodePointer("r:4c06b4f2-6394-4780-a8ca-e242a7dc5ec9(com.mbeddr.core.expressions.intentions)", "785275130115167400"));
  }

  @Override
  public String getPresentation() {
    return "surroundWithCast";
  }
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public String getDescription(final SNode node, final EditorContext editorContext) {
      return "EXPR: " + ("Cast (type)expr");
    }

    @Override
    public void execute(final SNode node, final EditorContext editorContext) {
      SNode inner = node;
      SNode result = SNodeOperations.replaceWithAnother(node, SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x61c69711ed614850L, 0x81d97714ff227fb0L, 0x5bbe8a6d239d0b54L, "com.mbeddr.core.expressions.structure.CastExpression")));
      if (SNodeOperations.isInstanceOf(node, CONCEPTS.BinaryExpression$cR)) {
        inner = createParensExpression_935qgx_a0a0c0a(node);
      }
      SLinkOperations.setTarget(result, LINKS.expr$3lz4, inner);
      SelectionUtil.selectCell(editorContext, result, SelectionManager.FIRST_EDITABLE_CELL);
    }
    ...
    public IntentionDescriptor getDescriptor() {
      return surroundWithCast_Intention.this;
    }

  }
  private static SNode createParensExpression_935qgx_a0a0c0a(SNode p0) {
