...
/*package*/ class UnaryMinusExpression_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public UnaryMinusExpression_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_p02nuh_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_p02nuh_a0a0");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new expressionSingleRoleHandler_p02nuh_a0b0(myNode, LINKS.expression$PfNq, getEditorContext());
    return provider.createCell();
  }
  private static class expressionSingleRoleHandler_p02nuh_a0b0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public expressionSingleRoleHandler_p02nuh_a0b0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
