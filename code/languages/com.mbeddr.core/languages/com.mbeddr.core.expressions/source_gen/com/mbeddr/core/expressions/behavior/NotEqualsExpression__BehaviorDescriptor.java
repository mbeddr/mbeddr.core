...
public final class NotEqualsExpression__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x61c69711ed614850L, 0x81d97714ff227fb0L, 0x69aff331ec334be6L, "com.mbeddr.core.expressions.structure.NotEqualsExpression");
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(evaluateStatically_id6OxpEKG0KPv, getPriolevel_id5HxjapwgqKu);


  /*package*/ static Object evaluateStatically_id6OxpEKG0KPv(@NotNull SNode __thisNode__) {
    Object leftEvaluationResult = Expression__BehaviorDescriptor.evaluateStatically_id6OxpEKG0KPv.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.left$SkXz));
    Object rightEvaluationResult = Expression__BehaviorDescriptor.evaluateStatically_id6OxpEKG0KPv.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.right$Slc$));
    if (EH.isNumber(leftEvaluationResult) && EH.isNumber(rightEvaluationResult)) {
      return NumberEvaluationHelper.notEqual(((Number) leftEvaluationResult), ((Number) rightEvaluationResult));
    } else if (leftEvaluationResult instanceof Boolean && rightEvaluationResult instanceof Boolean) {
      return BooleanEvaluationHelper.notEquals((Boolean) leftEvaluationResult, (Boolean) rightEvaluationResult);
    }
  ...
  /*package*/ NotEqualsExpression__BehaviorDescriptor() {
  }
