...
public final class CharLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x61c69711ed614850L, 0x81d97714ff227fb0L, 0x17196bfd1c5318acL, "com.mbeddr.core.expressions.structure.CharLiteral");
  ...
  /*package*/ static boolean isStaticallyEvaluatable_id3ilck8Kr3zN(@NotNull SNode __thisNode__) {
    ...
    return SPropertyOperations.getString(__thisNode__, PROPS.value$mkqz) != null;
  }
  /*package*/ static Object evaluateStatically_id6OxpEKG0KPv(@NotNull SNode __thisNode__) {
    if (isNotEmptyString(SPropertyOperations.getString(__thisNode__, PROPS.value$mkqz))) {
      int charAt = ((int) SPropertyOperations.getString(__thisNode__, PROPS.value$mkqz).charAt(0));
  ...
  /*package*/ static String renderReadable_id1VQvajLb13M(@NotNull SNode __thisNode__) {
    return "'" + SPropertyOperations.getString(__thisNode__, PROPS.value$mkqz) + "'";
  }
