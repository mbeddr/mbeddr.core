...
public final class Expression__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> cleanup_id7rX8gRKIEsj = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("cleanup").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8574045609340348179L).languageId(0x81d97714ff227fb0L, 0x61c69711ed614850L).build2();
