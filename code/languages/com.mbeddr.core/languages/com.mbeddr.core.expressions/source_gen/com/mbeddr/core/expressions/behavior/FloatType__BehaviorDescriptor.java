...
public final class FloatType__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x61c69711ed614850L, 0x81d97714ff227fb0L, 0x41c7cca6a7ab279fL, "com.mbeddr.core.expressions.structure.FloatType");
  ...
  public static final SMethod<Integer> getSize_id5HxjapwgqJC = new SMethodBuilder<>(Integer.TYPE).name("getSize").modifiers(9, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6584628407655574504L).languageId(0x81d97714ff227fb0L, 0x61c69711ed614850L).build2();
