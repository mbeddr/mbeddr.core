...
public final class EqualsExpression__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x61c69711ed614850L, 0x81d97714ff227fb0L, 0x7af69e2e83a1bf2aL, "com.mbeddr.core.expressions.structure.EqualsExpression");
  ...
  /*package*/ static Object evaluateStatically_id6OxpEKG0KPv(@NotNull SNode __thisNode__) {
    ...
    if (leftEvaluationResult instanceof Number && rightEvaluationResult instanceof Number) {
      return NumberEvaluationHelper.equal(((Number) leftEvaluationResult), ((Number) rightEvaluationResult));
    } else if (leftEvaluationResult instanceof Boolean && rightEvaluationResult instanceof Boolean) {
      return BooleanEvaluationHelper.equals((Boolean) leftEvaluationResult, (Boolean) rightEvaluationResult);
    }
