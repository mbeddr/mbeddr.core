...
public final class UIntPtrT__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x61c69711ed614850L, 0x81d97714ff227fb0L, 0x6c5cf294b07557a6L, "com.mbeddr.core.expressions.structure.UIntPtrT");
  ...
  /*package*/ static int getUsedBytes_id61lw97FtLtJ(@NotNull SNode __thisNode__) {
    ...
    return (int) Type__BehaviorDescriptor.getUsedBytes_id61lw97FtLtJ.invoke(SLinkOperations.getTarget(tsc, LINKS.uintPtrType$PVwl));
  }
  /*package*/ static String getPrintfFormatSpecifier_id4XMHJL4FDjg(@NotNull SNode __thisNode__) {
    return "%tu";
  }

  /*package*/ UIntPtrT__BehaviorDescriptor() {
  }
