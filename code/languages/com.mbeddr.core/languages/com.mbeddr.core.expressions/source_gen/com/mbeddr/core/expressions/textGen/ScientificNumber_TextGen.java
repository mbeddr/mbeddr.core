...
public class ScientificNumber_TextGen extends TextGenDescriptorBase {
  @Override
  public void generateText(final TextGenContext ctx) {
    final TextGenSupport tgs = new TextGenSupport(ctx);
    tgs.createPositionInfo();
    tgs.append(ScientificNumber__BehaviorDescriptor.toSciString_id1sHR4zGFJdw.invoke(ctx.getPrimaryInput()));
