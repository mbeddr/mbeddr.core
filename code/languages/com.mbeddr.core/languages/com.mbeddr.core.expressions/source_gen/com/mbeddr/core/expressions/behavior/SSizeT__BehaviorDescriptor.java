...
public final class SSizeT__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x61c69711ed614850L, 0x81d97714ff227fb0L, 0x35b3514992236519L, "com.mbeddr.core.expressions.structure.SSizeT");
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getUsedBytes_id61lw97FtLtJ, createdUnsignedCompanion_id5Xnv3$QELwg, createNextBiggerSignedCompanion_id4O$fzoYZDgS, getPrintfFormatSpecifier_id4XMHJL4FDjg);
  ...
  /*package*/ static int getUsedBytes_id61lw97FtLtJ(@NotNull SNode __thisNode__) {
    ...
    return (int) Type__BehaviorDescriptor.getUsedBytes_id61lw97FtLtJ.invoke(SLinkOperations.getTarget(tsc, LINKS.ssizeTType$hOmv));
  }
  /*package*/ static SNode createdUnsignedCompanion_id5Xnv3$QELwg(@NotNull SNode __thisNode__) {
    SNode tsc = TypeSizeConfiguration__BehaviorDescriptor.findTypeSizeConfig_id3LaV6lLNTR2.invoke(SNodeOperations.asSConcept(CONCEPTS.TypeSizeConfiguration$OP), __thisNode__);
    return (SNode) ISigned__BehaviorDescriptor.createdUnsignedCompanion_id5Xnv3$QELwg.invoke(SNodeOperations.cast(SLinkOperations.getTarget(tsc, LINKS.ssizeTType$hOmv), CONCEPTS.ISigned$EC));
  }
  /*package*/ static SNode createNextBiggerSignedCompanion_id4O$fzoYZDgS(@NotNull SNode __thisNode__) {
    SNode tsc = TypeSizeConfiguration__BehaviorDescriptor.findTypeSizeConfig_id3LaV6lLNTR2.invoke(SNodeOperations.asSConcept(CONCEPTS.TypeSizeConfiguration$OP), __thisNode__);
    return (SNode) ISigned__BehaviorDescriptor.createNextBiggerSignedCompanion_id4O$fzoYZDgS.invoke(SNodeOperations.cast(SLinkOperations.getTarget(tsc, LINKS.ssizeTType$hOmv), CONCEPTS.ISigned$EC));
  }
  /*package*/ static String getPrintfFormatSpecifier_id4XMHJL4FDjg(@NotNull SNode __thisNode__) {
    // !!! Important Note !!! Don't use %zi as format specifier but just %ld instead. The 'z' length sub-specifier appears
  ...
  /*package*/ SSizeT__BehaviorDescriptor() {
  }
