...
/*package*/ class volatileFlag_ComponentBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public volatileFlag_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_uasyvo_a0a();
  ...
  private boolean nodeCondition_uasyvo_a0a() {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_uasyvo_a0a");
    return editorCell;
  }
