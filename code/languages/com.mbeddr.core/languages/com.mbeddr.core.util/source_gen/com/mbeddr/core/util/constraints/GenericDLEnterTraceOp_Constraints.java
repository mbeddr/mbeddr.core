...
public class GenericDLEnterTraceOp_Constraints extends BaseConstraintsDescriptor {
  /*package*/ GenericDLEnterTraceOp_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.GenericDLEnterTraceOp$3Q, initContext);
    record(new RD1(this));
  }

  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.tracepoint$vPhN, container, true, false);
    }
    @Nullable
    @Override
