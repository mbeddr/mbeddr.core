...
public class GenericDLLeaveTraceOp_Constraints extends BaseConstraintsDescriptor {
  /*package*/ GenericDLLeaveTraceOp_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.GenericDLLeaveTraceOp$4e, initContext);
    record(new RD1(this));
  ...
  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.tracepoint$CleM, container, true, false);
    }
    @Nullable
    @Override
