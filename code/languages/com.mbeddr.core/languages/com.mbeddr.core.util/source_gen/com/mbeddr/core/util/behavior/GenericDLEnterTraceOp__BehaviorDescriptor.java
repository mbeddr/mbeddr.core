...
public final class GenericDLEnterTraceOp__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x2693fc719b0e4b05L, 0xab13f57227d675f2L, 0x7a23fdecbce1d04aL, "com.mbeddr.core.util.structure.GenericDLEnterTraceOp");
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getTarget_id66uzewbZgGM);


  /*package*/ static SNode getTarget_id66uzewbZgGM(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.tracepoint$vPhN);
  }

  /*package*/ GenericDLEnterTraceOp__BehaviorDescriptor() {
  }
