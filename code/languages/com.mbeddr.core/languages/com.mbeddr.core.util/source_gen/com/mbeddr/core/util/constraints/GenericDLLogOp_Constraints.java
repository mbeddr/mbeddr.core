...
public class GenericDLLogOp_Constraints extends BaseConstraintsDescriptor {
  public GenericDLLogOp_Constraints() {
    super(CONCEPTS.GenericDLLogOp$yM);
  }

  @Override
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(LINKS.item$3DF8, this, true, false) {
      @Nullable
      @Override
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public SNodeReference getSearchScopeValidatorNode() {
            return new SNodePointer("r:83f53e7f-110f-49f5-be48-95681cbb1402(com.mbeddr.core.util.constraints)", "6472565942509993392");
          }
          @Override
          public Scope createScope(final ReferenceConstraintsContext _context) {
            ...
            if (SNodeOperations.isInstanceOf(enclosingNode, CONCEPTS.GenericDotExpression$uQ) && SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SNodeOperations.cast(enclosingNode, CONCEPTS.GenericDotExpression$uQ), LINKS.expression$PfNq), CONCEPTS.DataLoggerRef$JQ)) {
              return new NamedElementsScope(SLinkOperations.getChildren(SLinkOperations.getTarget(SNodeOperations.cast(SLinkOperations.getTarget(SNodeOperations.cast(enclosingNode, CONCEPTS.GenericDotExpression$uQ), LINKS.expression$PfNq), CONCEPTS.DataLoggerRef$JQ), LINKS.datalogger$bfY7), LINKS.items$rLi7));
            }
