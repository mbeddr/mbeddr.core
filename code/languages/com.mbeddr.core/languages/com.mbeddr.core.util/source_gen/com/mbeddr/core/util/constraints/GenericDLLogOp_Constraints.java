...
public class GenericDLLogOp_Constraints extends BaseConstraintsDescriptor {
  /*package*/ GenericDLLogOp_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.GenericDLLogOp$yM, initContext);
    record(new RD1(this));
  }

  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.item$3DF8, container, true, false);
    }
    @Nullable
    @Override
