...
public final class BuildVariableDirPicker__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x2d7fadf533f64e80L, 0xa78f0f739add2bdeL, 0x1475db9ab213c262L, "com.mbeddr.core.buildconfig.structure.BuildVariableDirPicker");
  ...
  /*package*/ static SNode getCompanionFileOrFolderPicker_id3xqp6yeWGLu(@NotNull SNode __thisNode__) {
    SNode picker = SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x2d7fadf533f64e80L, 0xa78f0f739add2bdeL, 0x1475db9ab213c262L, "com.mbeddr.core.buildconfig.structure.BuildVariableDirPicker"));
    SPropertyOperations.assign(picker, PROPS.path$VaYg, SPropertyOperations.getString(__thisNode__, PROPS.path$VaYg));
    SPropertyOperations.assign(picker, PROPS.variable$psXh, SPropertyOperations.getString(__thisNode__, PROPS.variable$psXh));
    return picker;
  }
  /*package*/ static List<String> getVariableNames_id6xoAPBjOH1K(@NotNull SNode __thisNode__) {
    return Sequence.fromIterable(Sequence.<String>singleton(SPropertyOperations.getString(__thisNode__, PROPS.variable$psXh))).toList();
  }
  /*package*/ static String getDefaultValue_id6xoAPBjOH2T(@NotNull SNode __thisNode__, SModel model, String variableName) {
    return SPropertyOperations.getString(__thisNode__, PROPS.defaultPrefix$d3fh);
  }

  /*package*/ BuildVariableDirPicker__BehaviorDescriptor() {
  }
