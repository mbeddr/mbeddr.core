...
/*package*/ class ModuleRef_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ModuleRef_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_9ypmb6_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.module$6_LN;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.module$6_LN);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.module$6_LN);
    }
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createProperty_0() {
      ...
      try {
        ...
        style.set(StyleAttributes.FONT_STYLE, _StyleParameter_QueryFunction_9ypmb6_a1a0a0());
        editorCell.getStyle().putAll(style);
    ...
    private int _StyleParameter_QueryFunction_9ypmb6_a1a0a0() {
      if (SNodeOperations.isInstanceOf(getNode(), CONCEPTS.ImplementationModule$Gy)) {
  ...
  private EditorCell createReadOnlyModelAccessor_0() {
    EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new ModelAccessor.ReadOnly() {
      public String getText() {
        String vp = SPropertyOperations.getString(SLinkOperations.getTarget(myNode, LINKS.module$6_LN), PROPS.virtualPackage$EkXl);
        return (vp != null ? "(" + vp + ")" : "");
      }
    }, myNode);
    editorCell.setAction(CellActionType.DELETE, EmptyCellAction.getInstance());
    editorCell.setAction(CellActionType.BACKSPACE, EmptyCellAction.getInstance());
    editorCell.setCellId("ReadOnlyModelAccessor_9ypmb6_b0");
    Style style = new StyleImpl();
