...
/*package*/ class IStoreInRegisterComponent_ComponentBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public IStoreInRegisterComponent_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_ddt97i_a0();
  ...
  private boolean nodeCondition_ddt97i_a0() {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_ddt97i_a0");
    return editorCell;
  }
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public SNode doSubstitute(String pattern) {
            SNode node = SNodeOperations.cast(ctx.getNode(), CONCEPTS.ICanBeStoredInRegister$y2);
            IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.storeInRegister$k44L);
          ...
          public SAbstractConcept getOutputConcept() {
            return CONCEPTS.ICanBeStoredInRegister$y2;
          }
        };
