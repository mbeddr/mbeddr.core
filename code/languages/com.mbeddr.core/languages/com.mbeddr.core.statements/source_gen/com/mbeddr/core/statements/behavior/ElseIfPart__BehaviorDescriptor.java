...
public final class ElseIfPart__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xa9d696470840491eL, 0xbf392eb0805d2011L, 0x2b8026b23bc272a6L, "com.mbeddr.core.statements.structure.ElseIfPart");
  ...
  /*package*/ static List<SAbstractConcept> getCommentConcept_id5HxjapwgqLb(@NotNull SAbstractConcept __thisConcept__) {
    ...
    ListSequence.fromList(result).addElement(CONCEPTS.CommentedElseIfPart$lJ);
    return result;
  }

  /*package*/ ElseIfPart__BehaviorDescriptor() {
  }
