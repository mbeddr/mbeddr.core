...
public class findWriteAccessForArgument_Finder extends GeneratedFinder {
  public findWriteAccessForArgument_Finder() {
  }
  @Override
  ...
  protected void doFind0(@NotNull SNode node, SearchScope scope, IFinder.FindCallback callback, ProgressMonitor monitor) {
    ...
    try {
      ...
      for (SNode n : ListSequence.fromList(nodes)) {
        if (SNodeOperations.isInstanceOf(n, CONCEPTS.ArgumentRef$iE) && AssignmentHelper.isAssignedTo(n)) {
  ...
  public SNodeReference getDeclarationNode() {
    return buildNodePointer(FindUsagesDescriptor.DECLARING_MODEL, "1973141914968363196");
  }
