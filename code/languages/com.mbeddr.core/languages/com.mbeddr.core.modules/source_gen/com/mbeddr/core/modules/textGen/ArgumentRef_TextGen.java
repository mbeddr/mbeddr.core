...
public class ArgumentRef_TextGen extends TextGenDescriptorBase {
  @Override
  public void generateText(final TextGenContext ctx) {
    final TextGenSupport tgs = new TextGenSupport(ctx);
    tgs.createPositionInfo();
    tgs.append(IIdentifierNamedConcept__BehaviorDescriptor.processedName_id3x8oZgL6CjW.invoke(SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.arg$WIp5), SPropertyOperations.getString(SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.arg$WIp5), PROPS.name$MnvL)));
