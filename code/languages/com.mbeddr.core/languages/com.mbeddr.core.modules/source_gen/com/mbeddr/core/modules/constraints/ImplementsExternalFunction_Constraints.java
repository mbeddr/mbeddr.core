...
public class ImplementsExternalFunction_Constraints extends BaseConstraintsDescriptor {
  /*package*/ ImplementsExternalFunction_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.ImplementsExternalFunction$fm, initContext);
    record(new RD1(this));
  }

  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.implements$zcVY, container, true, false);
    }
    @Nullable
    @Override
