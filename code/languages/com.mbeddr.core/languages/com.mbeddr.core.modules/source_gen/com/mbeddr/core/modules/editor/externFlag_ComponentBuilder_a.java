...
/*package*/ class externFlag_ComponentBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_lgbhjq_a0a();
  ...
  private boolean nodeCondition_lgbhjq_a0a() {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "flag 'extern'") {
      ...
      public List<MenuPart<TransformationMenuItem, TransformationMenuContext>> createMenuParts() {
        return ListSequence.fromListAndArray(new ArrayList<MenuPart<TransformationMenuItem, TransformationMenuContext>>(), new GenericMenuPart_a0a0a_0());
      }
    };
    editorCell.setCellId("SideTransformationSectionCell_lgbhjq_a0a");
    return editorCell;
  }
  private class GenericMenuPart_a0a0a_0 implements MenuPart<TransformationMenuItem, TransformationMenuContext> {
