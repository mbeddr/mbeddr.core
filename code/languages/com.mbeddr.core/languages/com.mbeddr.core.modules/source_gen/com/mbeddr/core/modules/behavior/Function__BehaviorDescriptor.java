...
public final class Function__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isInlineFunctionForHeader_id4UbnhBFeL_b = new SMethodBuilder<>(Boolean.TYPE).name("isInlineFunctionForHeader").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5659719722623244619L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2();
  public static final SMethod<Boolean> hasExternalFunctionPrototype_id4UbnhBFeZtO = new SMethodBuilder<>(Boolean.TYPE).name("hasExternalFunctionPrototype").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5659719722623301492L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2();
