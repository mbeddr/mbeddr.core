...
import com.mbeddr.core.base.editor.mbeddrBaseStyles_StyleSheet.ParameterStyleClass;
...
/*package*/ class Argument_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_jagqzb_a0");
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_jagqzb_a0a0a();
  ...
  private boolean nodeCondition_jagqzb_a0a0a() {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_jagqzb_a0a0a");
    return editorCell;
  }
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public SNode doSubstitute(String pattern) {
            SNode node = SNodeOperations.cast(ctx.getNode(), CONCEPTS.Argument$9m);
            IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.storeInRegister$k44L);
  ...
  private EditorCell createTooltip_0(final EditorContext editorContext, final SNode node) {
    LazyTooltipCellEvaluator tooltip = new LazyTooltipCellEvaluator(editorContext, node, "com.mbeddr.core.modules.editor.GeneratedHints.tooltipHint_jagqzb_b0a", true);
    EditorCell visibleCell = createCustomFactory_5();

    TooltipWrapper editorCell = new TooltipWrapper(editorContext, node, visibleCell, tooltip, TooltipTimingProperties.DEFAULT);
    editorCell.setCellId("Tooltip_jagqzb_b0a");
    return editorCell;
  }
  ...
  private EditorCell createReadOnlyModelAccessor_0() {
    ...
    editorCell.setCellId("ReadOnlyModelAccessor_jagqzb_a0b0a");
    Style style = new StyleImpl();
    if (_StyleParameter_QueryFunction_jagqzb_a0a0b0a()) {
      new DEFINEDStyleClass(this).apply(style, editorCell);
    }
    if (_StyleParameter_QueryFunction_jagqzb_a1a0b0a()) {
  ...
  private boolean _StyleParameter_QueryFunction_jagqzb_a0a0b0a() {
    return SLinkOperations.getTarget(getNode(), LINKS.kind$ebZT) != null;
  }
  private boolean _StyleParameter_QueryFunction_jagqzb_a1a0b0a() {
    return SLinkOperations.getTarget(getNode(), LINKS.kind$ebZT) == null;
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new typeSingleRoleHandler_jagqzb_c0a(myNode, LINKS.type$sXU3, getEditorContext());
    return provider.createCell();
  }
  private static class typeSingleRoleHandler_jagqzb_c0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public typeSingleRoleHandler_jagqzb_c0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    private boolean nodeCondition_jagqzb_a2a0() {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      editorCell.getStyle().putAll(style);
      editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new PropertyCellContext(myNode, property), new SubstituteInfoPartExt[]{new Argument_component_cellMenu_jagqzb_a0a3a0(), new Argument_name_cellMenu_jagqzb_b0a3a0(), new SChildSubstituteInfoPartEx(editorCell)}));
      setCellContext(editorCell);
  ...
  public static class Argument_component_cellMenu_jagqzb_a0a3a0 implements SubstituteInfoPartExt {
    private controlledNameStuff myComponent;
    public Argument_component_cellMenu_jagqzb_a0a3a0() {
  ...
  public static class Argument_name_cellMenu_jagqzb_b0a3a0 extends AbstractCellMenuPart_PropertyValues {
    public Argument_name_cellMenu_jagqzb_b0a3a0() {
    }
    @Override
    public List<SubstituteAction> createActions(CellContext cellContext, EditorContext editorContext) {
      return ListSequence.fromList(super.createActions(cellContext, editorContext)).select((action) -> {
        return (SubstituteAction) new NodeSubstituteActionWrapper(action) {
          ...
          public EditorMenuTraceInfo getEditorMenuTraceInfo() {
            ...
            result.setDescriptor(new EditorMenuDescriptorBase("property postfix values", new SNodePointer("r:890ea833-37c9-445e-a04d-3b69ce24aa30(com.mbeddr.core.modules.editor)", "1850134002004915679")));
            return result;
          }
        };
      }).toList();
