...
/*package*/ class ImplementsExternalFunction_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ImplementsExternalFunction_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_iws3m4_a");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_iws3m4_a0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_iws3m4_a0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.implements$zcVY;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.implements$zcVY);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.implements$zcVY);
    }
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new ReferenceCellContext(getNode(), getNode(), referenceLink), new SubstituteInfoPartExt[]{new ImplementsExternalFunction_implements_cellMenu_iws3m4_a0b0a(), new SChildSubstituteInfoPartEx(editorCell)}));
  ...
  public static class ImplementsExternalFunction_implements_cellMenu_iws3m4_a0b0a extends PrimaryReferentMenuCellMenuPart {
    public ImplementsExternalFunction_implements_cellMenu_iws3m4_a0b0a() {
    }
  }
