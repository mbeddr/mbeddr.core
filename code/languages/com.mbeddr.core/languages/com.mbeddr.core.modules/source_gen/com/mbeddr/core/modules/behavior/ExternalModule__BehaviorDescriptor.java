...
public final class ExternalModule__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> conceptLabel_id4JF77iuWC$q = new SMethodBuilder<>(String.class).name("conceptLabel").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5470497459580078362L).languageId(0xaa41d1b2bffa7eb1L, 0xd4280a54f6df4383L).build2();
  public static final SMethod<Iterable<SNode>> headerDescriptors_id7RiewQ_lfWB = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("headerDescriptors").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(9066372830133026599L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2();
