...
public class CallLikeParameterHint implements ParametersInformation<SNode> {
  public CallLikeParameterHint() {
  }
  ...
  public void getStyledMethodPresentation(SNode node, EditorContext editorContext, SNode parameterObject, StyledTextPrinter styledText) {
    SNode ifl = ICallLike__BehaviorDescriptor.getFunction_id74lwjTQiYY5.invoke(parameterObject);
    IFunctionLike__BehaviorDescriptor.presentation_id2$xXL4HsOsB.invoke(SNodeOperations.asSConcept(SNodeOperations.getConcept(ifl)), ifl, this.getSelectedActualArgument(editorContext), styledText);
  }
