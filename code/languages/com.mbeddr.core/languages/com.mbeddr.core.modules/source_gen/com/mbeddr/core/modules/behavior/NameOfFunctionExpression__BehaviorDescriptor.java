...
public final class NameOfFunctionExpression__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static String renderReadable_id1VQvajLb13M(@NotNull SNode __thisNode__) {
    return "nameof<" + SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.function$3Vu_), PROPS.name$MnvL) + ">";
  }

  /*package*/ NameOfFunctionExpression__BehaviorDescriptor() {
  }
