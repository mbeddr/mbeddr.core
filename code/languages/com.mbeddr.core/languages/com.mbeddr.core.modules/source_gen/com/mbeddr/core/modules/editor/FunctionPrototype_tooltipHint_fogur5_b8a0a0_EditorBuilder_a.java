...
/*package*/ class FunctionPrototype_tooltipHint_fogur5_b8a0a0_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public FunctionPrototype_tooltipHint_fogur5_b8a0a0_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_igadem_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    try {
      getCellFactory().pushCellContext();
      getCellFactory().removeCellContextHints(new String[]{"com.mbeddr.core.modules.editor.GeneratedHints.tooltipHint_fogur5_b8a0a0"});
      if (nodeCondition_igadem_a0a()) {
  ...
  private boolean nodeCondition_igadem_a0a() {
  ...
  private EditorCell createReadOnlyModelAccessor_0() {
    ...
    editorCell.setCellId("ReadOnlyModelAccessor_igadem_a0");
