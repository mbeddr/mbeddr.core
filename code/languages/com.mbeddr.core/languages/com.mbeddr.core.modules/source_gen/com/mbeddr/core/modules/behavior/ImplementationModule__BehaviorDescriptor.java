...
public final class ImplementationModule__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> ensureImportFor_idipMc9Qxfn = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("ensureImportFor").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5179949767594967L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
  public static final SMethod<Void> ensureImportFor_id43R883waUzW = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("ensureImportFor").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4681246075563780348L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""), SMethodBuilder.createJavaParameter(Boolean.TYPE, ""));
  public static final SMethod<Void> ensureImportFor_id3YjQI$k4m49 = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("ensureImportFor").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4581245940564844809L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""), SMethodBuilder.createJavaParameter(Boolean.TYPE, ""), SMethodBuilder.createJavaParameter(Boolean.TYPE, ""));
  public static final SMethod<Void> addUniqueStdHeaderImport_id4GT16cGfDI2 = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("addUniqueStdHeaderImport").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5420368450507676546L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2(SMethodBuilder.createJavaParameter(String.class, ""), SMethodBuilder.createJavaParameter(Boolean.TYPE, ""), SMethodBuilder.createJavaParameter(String.class, ""), SMethodBuilder.createJavaParameter(String.class, ""));
