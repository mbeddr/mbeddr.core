...
public final class ImplementationModule__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Iterable<SNode>> implModuleImports_id7RiewQ_lfTD = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("implModuleImports").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(9066372830133026409L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2();
  public static final SMethod<SNode> createProxy_id35NyAcQ9ZV = new SMethodBuilder<>(SNode.class).name("createProxy").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(55677248263987195L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2();
  public static final SMethod<String> getUnitName_id4pl5GY7LKmR = new SMethodBuilder<>(String.class).name("getUnitName").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5067982036267369911L).languageId(0xbfd948636cfe8bc3L, 0x9ded098bad6a4657L).build2();
  public static final SMethod<Boolean> hasImportFor_id7PpjtdjCFN8 = new SMethodBuilder<>(Boolean.TYPE).name("hasImportFor").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(9032336097704852680L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2(SMethodBuilder.createJavaParameter(SNode.class, "requiredModule"));
  public static final SMethod<Void> ensureImportFor_idipMc9Qxfn = new SMethodBuilder<>(Void.TYPE).name("ensureImportFor").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5179949767594967L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2(SMethodBuilder.createJavaParameter(SNode.class, "requiredModule"));
  public static final SMethod<Void> ensureImportFor_id43R883waUzW = new SMethodBuilder<>(Void.TYPE).name("ensureImportFor").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4681246075563780348L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2(SMethodBuilder.createJavaParameter(SNode.class, "requiredModule"), SMethodBuilder.createJavaParameter(Boolean.TYPE, "reexport"));
  public static final SMethod<Void> ensureImportFor_id3YjQI$k4m49 = new SMethodBuilder<>(Void.TYPE).name("ensureImportFor").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4581245940564844809L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2(SMethodBuilder.createJavaParameter(SNode.class, "requiredModule"), SMethodBuilder.createJavaParameter(Boolean.TYPE, "beforeOtherImports"), SMethodBuilder.createJavaParameter(Boolean.TYPE, "reexport"));
  public static final SMethod<Void> addUniqueStdHeaderImport_id4GT16cGfDI2 = new SMethodBuilder<>(Void.TYPE).name("addUniqueStdHeaderImport").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5420368450507676546L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2(SMethodBuilder.createJavaParameter(String.class, "headerName"), SMethodBuilder.createJavaParameter(Boolean.TYPE, "addToHeader"), SMethodBuilder.createJavaParameter(String.class, "preprocessorCondition"), SMethodBuilder.createJavaParameter(String.class, "alternativeHeaderName"));
  public static final SMethod<Iterable<SNode>> importsForImplementation_id4GT16cGhZhY = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("importsForImplementation").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5420368450508289150L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2();
  public static final SMethod<Iterable<SNode>> importsForHeader_id4GT16cGhZmM = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("importsForHeader").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5420368450508289458L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2();
  public static final SMethod<Iterable<SNode>> unionOf_id5qxpWJ_usOE = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("unionOf").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6242384683938204970L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2(SMethodBuilder.createJavaParameter((Class<Iterable<SNode>>) ((Class) Object.class), "stdHeaders"), SMethodBuilder.createJavaParameter((Class<Iterable<SNode>>) ((Class) Object.class), "imports"));
  public static final SMethod<List<SNode>> getImportingHeaderGeneratingExternalModules_id2qdxtjsX3cT = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getImportingHeaderGeneratingExternalModules").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2778023694444016441L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2();
  public static final SMethod<Boolean> isImportedByHeaderGeneratingExternalModules_id2qdxtjsXgl1 = new SMethodBuilder<>(Boolean.TYPE).name("isImportedByHeaderGeneratingExternalModules").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2778023694444070209L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2();
  ...
  /*package*/ static final SMethod<Void> renderDependentModules_id6GZLGDRrk_R = new SMethodBuilder<>(Void.TYPE).name("renderDependentModules").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(7728114058480404855L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2(SMethodBuilder.createJavaParameter(SNode.class, "m"), SMethodBuilder.createJavaParameter(VisGraph.class, "g"), SMethodBuilder.createJavaParameter((Class<Set<SNode>>) ((Class) Object.class), "visited"), SMethodBuilder.createJavaParameter(String.class, "category"));
  ...
  public static final SMethod<Iterable<SNode>> allFunctions_id1H6zsul0og9 = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("allFunctions").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1965414175731713033L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2();
  public static final SMethod<Iterable<SNode>> allFunctionsWithoutInlineFunctionsForHeader_id1H6zsul5X7v = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("allFunctionsWithoutInlineFunctionsForHeader").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1965414175733174751L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2();
  public static final SMethod<Iterable<SNode>> inlineFunctionsForHeader_id1H6zsul0ctg = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("inlineFunctionsForHeader").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1965414175731664720L).languageId(0x8efc09336c1b0001L, 0x6d11763d483d4b2bL).build2();
