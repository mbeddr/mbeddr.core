...
/*package*/ class GlobalConstantDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public GlobalConstantDeclaration_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private boolean nodeCondition_kj6xkc_a1a0() {
  ...
  private boolean nodeCondition_kj6xkc_a3a0() {
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_kj6xkc_a0a0a0();
  ...
  private boolean nodeCondition_kj6xkc_a0a0a0() {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "flag '@prevent name mangling'") {
      ...
      public List<MenuPart<TransformationMenuItem, TransformationMenuContext>> createMenuParts() {
        return ListSequence.fromListAndArray(new ArrayList<MenuPart<TransformationMenuItem, TransformationMenuContext>>(), new GenericMenuPart_a0a0a0a0_3());
      }
    };
    editorCell.setCellId("SideTransformationSectionCell_kj6xkc_a0a0a0");
    return editorCell;
  }
  private class GenericMenuPart_a0a0a0a0_3 implements MenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public SNode doSubstitute(String pattern) {
            SNode node = SNodeOperations.cast(ctx.getNode(), CONCEPTS.GlobalConstantDeclaration$dg);
            IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.preventNameMangling$DOH5);
  ...
  private EditorCell createAlternation_1() {
    boolean alternationCondition = true;
    alternationCondition = nodeCondition_kj6xkc_a0a1a0();
    EditorCell editorCell = null;
    if (alternationCondition) {
  ...
  private boolean nodeCondition_kj6xkc_a0a1a0() {
  ...
  private EditorCell createSideTransformationSectionCell_1() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_kj6xkc_a0a1a0");
    return editorCell;
  }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new typeSingleRoleHandler_kj6xkc_d0a(myNode, LINKS.type$PEC1, getEditorContext());
    return provider.createCell();
  }
  private static class typeSingleRoleHandler_kj6xkc_d0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public typeSingleRoleHandler_kj6xkc_d0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      editorCell.getStyle().putAll(style);
      editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new PropertyCellContext(myNode, property), new SubstituteInfoPartExt[]{new GlobalConstantDeclaration_component_cellMenu_kj6xkc_a0e0a(), new SChildSubstituteInfoPartEx(editorCell)}));
      setCellContext(editorCell);
  ...
  public static class GlobalConstantDeclaration_component_cellMenu_kj6xkc_a0e0a implements SubstituteInfoPartExt {
    private controlledNameStuff myComponent;
    public GlobalConstantDeclaration_component_cellMenu_kj6xkc_a0e0a() {
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_kj6xkc_f0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new valueSingleRoleHandler_kj6xkc_g0a(myNode, LINKS.value$RmDl, getEditorContext());
    return provider.createCell();
  }
  private static class valueSingleRoleHandler_kj6xkc_g0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public valueSingleRoleHandler_kj6xkc_g0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_3() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ";");
    editorCell.setCellId("Constant_kj6xkc_h0a");
    Style style = new StyleImpl();
