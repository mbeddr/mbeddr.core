...
/*package*/ class GlobalConstantDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_kj6xkc_a0a0a();
  ...
  private boolean nodeCondition_kj6xkc_a0a0a() {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "flag '@prevent name mangling'") {
      ...
      public List<MenuPart<TransformationMenuItem, TransformationMenuContext>> createMenuParts() {
        return ListSequence.fromListAndArray(new ArrayList<MenuPart<TransformationMenuItem, TransformationMenuContext>>(), new GenericMenuPart_a0a0a0a_3());
      }
    };
    editorCell.setCellId("SideTransformationSectionCell_kj6xkc_a0a0a");
    return editorCell;
  }
  private class GenericMenuPart_a0a0a0a_3 implements MenuPart<TransformationMenuItem, TransformationMenuContext> {
  ...
  private EditorCell createAlternation_1() {
    boolean alternationCondition = true;
    alternationCondition = nodeCondition_kj6xkc_a0b0a();
    EditorCell editorCell = null;
    if (alternationCondition) {
  ...
  private boolean nodeCondition_kj6xkc_a0b0a() {
  ...
  private EditorCell createSideTransformationSectionCell_1() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_kj6xkc_a0b0a");
    return editorCell;
  }
