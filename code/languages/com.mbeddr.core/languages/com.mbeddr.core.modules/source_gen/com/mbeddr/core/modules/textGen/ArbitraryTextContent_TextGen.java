...
public class ArbitraryTextContent_TextGen extends TextGenDescriptorBase {
  @Override
  public void generateText(final TextGenContext ctx) {
    final TextGenSupport tgs = new TextGenSupport(ctx);
    tgs.createPositionInfo();
    for (SNode item : SLinkOperations.getChildren(ctx.getPrimaryInput(), LINKS.items$YGX6)) {
      tgs.appendNode(item);
    }
