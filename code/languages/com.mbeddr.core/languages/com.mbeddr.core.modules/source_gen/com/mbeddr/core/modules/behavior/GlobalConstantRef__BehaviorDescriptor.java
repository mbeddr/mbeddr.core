...
public final class GlobalConstantRef__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x6d11763d483d4b2bL, 0x8efc09336c1b0001L, 0x34953142306a769bL, "com.mbeddr.core.modules.structure.GlobalConstantRef");
  ...
  public static final SMethod<Void> rebindToProxy_id7jSUHHvkApb = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("rebindToProxy").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8428744930541856331L).languageId(0xaa41d1b2bffa7eb1L, 0xd4280a54f6df4383L).build2(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(isStaticallyEvaluatable_id3ilck8Kr3zN, evaluateStatically_id6OxpEKG0KPv, rebindToProxy_id7jSUHHvkApb, referencedModuleContent_id7jSUHHvkAph, renderReadable_id1VQvajLb13M, isLValue_id6iIoqg1yDKH);
  ...
  /*package*/ static boolean isStaticallyEvaluatable_id3ilck8Kr3zN(@NotNull SNode __thisNode__) {
    ...
    if (__thisNode__ != SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, LINKS.constant$aCs7), LINKS.value$RmDl)) {
      return (boolean) Expression__BehaviorDescriptor.isStaticallyEvaluatable_id3ilck8Kr3zN.invoke(SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, LINKS.constant$aCs7), LINKS.value$RmDl));
    } else {
      return false;
    }
  }
  /*package*/ static Object evaluateStatically_id6OxpEKG0KPv(@NotNull SNode __thisNode__) {
    return (Object) Expression__BehaviorDescriptor.evaluateStatically_id6OxpEKG0KPv.invoke(SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, LINKS.constant$aCs7), LINKS.value$RmDl));
  }
  /*package*/ static void rebindToProxy_id7jSUHHvkApb(@NotNull SNode __thisNode__, SNode proxyElement) {
    SLinkOperations.setTarget(__thisNode__, LINKS.constant$aCs7, SNodeOperations.cast(proxyElement, CONCEPTS.GlobalConstantDeclaration$dg));
  }
  /*package*/ static SNode referencedModuleContent_id7jSUHHvkAph(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.constant$aCs7);
  }
  /*package*/ static String renderReadable_id1VQvajLb13M(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.constant$aCs7), PROPS.name$MnvL);
  }
  /*package*/ static boolean isLValue_id6iIoqg1yDKH(@NotNull SNode __thisNode__) {
    return (boolean) AbstractDefineLike__BehaviorDescriptor.resultIsLValue_id4b64BCc0upM.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.constant$aCs7));
  }

  /*package*/ GlobalConstantRef__BehaviorDescriptor() {
  }
