...
/*package*/ class FunctionSignature_tooltipHint_njyx9c_b8a0_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public FunctionSignature_tooltipHint_njyx9c_b8a0_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_f0qzsg_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    try {
      getCellFactory().pushCellContext();
      getCellFactory().removeCellContextHints(new String[]{"com.mbeddr.core.modules.editor.GeneratedHints.tooltipHint_njyx9c_b8a0"});
      if (nodeCondition_f0qzsg_a0a()) {
  ...
  private boolean nodeCondition_f0qzsg_a0a() {
  ...
  private EditorCell createReadOnlyModelAccessor_0() {
    ...
    editorCell.setCellId("ReadOnlyModelAccessor_f0qzsg_a0");
