...
public class ConcatExpression_TextGen extends TextGenDescriptorBase {
  @Override
  public void generateText(final TextGenContext ctx) {
    final TextGenSupport tgs = new TextGenSupport(ctx);
    tgs.createPositionInfo();
    tgs.append("(\"");
    tgs.append(Expression__BehaviorDescriptor.evaluateStatically_id6OxpEKG0KPv.invoke(ctx.getPrimaryInput()).toString());
    tgs.append("\")");
