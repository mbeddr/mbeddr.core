...
public class findReadAccessForArgument_Finder extends GeneratedFinder {
  public findReadAccessForArgument_Finder() {
  }
  @Override
  ...
  protected void doFind0(@NotNull SNode node, SearchScope scope, IFinder.FindCallback callback, ProgressMonitor monitor) {
    ...
    try {
      ...
      for (SNode n : ListSequence.fromList(nodes)) {
        if (SNodeOperations.isInstanceOf(n, CONCEPTS.ArgumentRef$iE) && AssignmentHelper.isNotAssignedTo(n)) {
  ...
  public SNodeReference getDeclarationNode() {
    return buildNodePointer(FindUsagesDescriptor.DECLARING_MODEL, "1973141914968363221");
  }
