...
/*package*/ class functionSignature_ComponentBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public functionSignature_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_njyx9c_a0");
    ...
    if (nodeCondition_njyx9c_a8a0()) {
      editorCell.addEditorCell(createCollection_2());
    }
    editorCell.addEditorCell(createConstant_6());
    return editorCell;
  }
  private boolean nodeCondition_njyx9c_a1a0() {
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_njyx9c_a0a0a();
  ...
  private boolean nodeCondition_njyx9c_a0a0a() {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "flag 'extern'") {
      ...
      public List<MenuPart<TransformationMenuItem, TransformationMenuContext>> createMenuParts() {
        return ListSequence.fromListAndArray(new ArrayList<MenuPart<TransformationMenuItem, TransformationMenuContext>>(), new GenericMenuPart_a0a0a0a_5());
      }
    };
    editorCell.setCellId("SideTransformationSectionCell_njyx9c_a0a0a");
    return editorCell;
  }
  private class GenericMenuPart_a0a0a0a_5 implements MenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public SNode doSubstitute(String pattern) {
            SNode node = SNodeOperations.cast(ctx.getNode(), CONCEPTS.FunctionSignature$Tx);
            IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.extern$WI8W);
  ...
  private EditorCell createAlternation_1() {
    boolean alternationCondition = true;
    alternationCondition = nodeCondition_njyx9c_a0b0a();
    EditorCell editorCell = null;
    if (alternationCondition) {
  ...
  private boolean nodeCondition_njyx9c_a0b0a() {
  ...
  private EditorCell createSideTransformationSectionCell_1() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_njyx9c_a0b0a");
    return editorCell;
  }
  ...
  private EditorCell createAlternation_2() {
    boolean alternationCondition = true;
    alternationCondition = nodeCondition_njyx9c_a2a0();
    EditorCell editorCell = null;
    if (alternationCondition) {
  ...
  private boolean nodeCondition_njyx9c_a2a0() {
  ...
  private EditorCell createSideTransformationSectionCell_2() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_njyx9c_a2a0");
    return editorCell;
  }
  ...
  private EditorCell createCollection_1() {
    jetbrains.mps.nodeEditor.cells.EditorCell_Collection editorCell = new jetbrains.mps.nodeEditor.cells.EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_njyx9c_a3a0");
    editorCell.addEditorCell(createRefNodeList_0());
    return editorCell;
  }
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new prefixesListHandler_njyx9c_a0d0a(myNode, getEditorContext());
    jetbrains.mps.nodeEditor.cells.EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
    editorCell.setCellId("FS_refNodeList_prefixes");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class prefixesListHandler_njyx9c_a0d0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public prefixesListHandler_njyx9c_a0d0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(prefixesListHandler_njyx9c_a0d0a.this.getNode(), LINKS.prefixes$hyki));
      try {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new typeSingleRoleHandler_njyx9c_e0a(myNode, LINKS.type$sXU3, getEditorContext());
    return provider.createCell();
  }
  private static class typeSingleRoleHandler_njyx9c_e0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public typeSingleRoleHandler_njyx9c_e0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      editorCell.setCellId("FS_property_name");
      Style style = new StyleImpl();
  ...
  private EditorCell createConstant_3() {
    ...
    editorCell.setCellId("Constant_njyx9c_g0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new argumentsListHandler_njyx9c_h0a(myNode, getEditorContext());
    jetbrains.mps.nodeEditor.cells.EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
    editorCell.setCellId("FS_refNodeList_arguments");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class argumentsListHandler_njyx9c_h0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public argumentsListHandler_njyx9c_h0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(argumentsListHandler_njyx9c_h0a.this.getNode(), LINKS.arguments$6da0));
      try {
        EditorCell emptyCell = null;
  ...
  private EditorCell createCollection_2() {
    ...
    editorCell.setCellId("Collection_njyx9c_i0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_4() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ",");
    editorCell.setCellId("Constant_njyx9c_a8a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createTooltip_0(final EditorContext editorContext, final SNode node) {
    LazyTooltipCellEvaluator tooltip = new LazyTooltipCellEvaluator(editorContext, node, "com.mbeddr.core.modules.editor.GeneratedHints.tooltipHint_njyx9c_b8a0", true);
    ...
    editorCell.setCellId("Tooltip_njyx9c_b8a0");
    return editorCell;
  }
  ...
  private EditorCell createReadOnlyModelAccessor_1() {
    ...
    editorCell.setAction(CellActionType.DELETE, EmptyCellAction.getInstance());
    editorCell.setAction(CellActionType.BACKSPACE, EmptyCellAction.getInstance());
    editorCell.setCellId("ReadOnlyModelAccessor_njyx9c_a1i0a");
    Style style = new StyleImpl();
    if (_StyleParameter_QueryFunction_njyx9c_a0a1i0a()) {
      new DEFINEDStyleClass(this).apply(style, editorCell);
    }
    if (_StyleParameter_QueryFunction_njyx9c_a1a1i0a()) {
  ...
  private boolean _StyleParameter_QueryFunction_njyx9c_a0a1i0a() {
    return SLinkOperations.getTarget(getNode(), LINKS.ellipsisKind$Gwkk) != null;
  }
  private boolean _StyleParameter_QueryFunction_njyx9c_a1a1i0a() {
    return SLinkOperations.getTarget(getNode(), LINKS.ellipsisKind$Gwkk) == null;
  }
  private EditorCell createConstant_5() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "...");
    editorCell.setCellId("Constant_njyx9c_c8a0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_6() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_njyx9c_j0a");
    Style style = new StyleImpl();
    new ParensStyleClass(this).apply(style, editorCell);
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
