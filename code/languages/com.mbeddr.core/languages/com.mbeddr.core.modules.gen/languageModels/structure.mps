...
<model modelUID="r:9488318d-ce46-4320-b4e7-2566a511c366(com.mbeddr.core.modules.gen.structure)">
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="2197615781105627131" nodeInfo="ig">
    ...
    <node role="implements" roleId="tpce.1169129564478" type="tpce.InterfaceConceptReference" typeId="tpce.1169127622168" id="985798061525983746" nodeInfo="ig">
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="2391520863997668666" nodeInfo="ig">
    ...
    <property name="conceptAlias" nameId="tpce.5092175715804935370" value="prevent name mangling" />
    <property name="conceptShortDescription" nameId="tpce.4628067390765907488" value="prevent name mangling for unique names" />
    <link role="extends" roleId="tpce.1071489389519" targetNodeId="tpck.1133920641626" resolveInfo="BaseConcept" />
