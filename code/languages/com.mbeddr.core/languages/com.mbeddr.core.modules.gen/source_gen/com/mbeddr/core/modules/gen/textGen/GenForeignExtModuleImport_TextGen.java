...
public class GenForeignExtModuleImport_TextGen extends TextGenDescriptorBase {
  @Override
  public void generateText(final TextGenContext ctx) {
    final TextGenSupport tgs = new TextGenSupport(ctx);
    for (SNode header : Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.module$TXZL), LINKS.descriptors$HrHA), CONCEPTS.HeaderDescriptor$fi))) {
      tgs.append("#include ");
