...
public final class LowerHalfRegisterRefExpr__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x783af01f87a7412cL, 0xbe99293a162652b5L, 0x5f072ca6a4180531L, "com.mbeddr.core.embedded.structure.LowerHalfRegisterRefExpr");
  ...
  /*package*/ static String renderReadable_id1VQvajLb13M(@NotNull SNode __thisNode__) {
    return Expression__BehaviorDescriptor.renderReadable_id1VQvajLb13M.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expression$PfNq)) + ".L";
  }

  /*package*/ LowerHalfRegisterRefExpr__BehaviorDescriptor() {
  }
