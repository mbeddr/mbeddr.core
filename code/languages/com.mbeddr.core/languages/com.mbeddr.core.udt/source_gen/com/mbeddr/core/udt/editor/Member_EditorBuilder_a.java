...
/*package*/ class Member_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_jpw21l_a0a0();
  ...
  private boolean nodeCondition_jpw21l_a0a0() {
    IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.transparent$YPca);
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("flag_transparent");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "flag 'transparent'") {
      @Override
    ...
    editorCell.setCellId("SideTransformationSectionCell_jpw21l_a0a0");
    return editorCell;
  }
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public SNode doSubstitute(String pattern) {
            SNode node = SNodeOperations.cast(ctx.getNode(), CONCEPTS.Member$J1);
            IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.transparent$YPca);
            access.write(node, true);
            SelectionUtil.selectLabelCellAnSetCaret(ctx.getEditorContext(), node, "flag_transparent", -1);
            return null;
          }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new typeSingleRoleHandler_jpw21l_b0a(myNode, LINKS.type$sXU3, getEditorContext());
    return provider.createCell();
  }
  private static class typeSingleRoleHandler_jpw21l_b0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public typeSingleRoleHandler_jpw21l_b0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new PropertyCellContext(myNode, property), new SubstituteInfoPartExt[]{new Member_component_cellMenu_jpw21l_a0a2a0(), new Member_name_cellMenu_jpw21l_b0a2a0(), new SChildSubstituteInfoPartEx(editorCell)}));
      setCellContext(editorCell);
  ...
  public static class Member_component_cellMenu_jpw21l_a0a2a0 implements SubstituteInfoPartExt {
    private controlledNameStuff myComponent;
    public Member_component_cellMenu_jpw21l_a0a2a0() {
  ...
  public static class Member_name_cellMenu_jpw21l_b0a2a0 extends AbstractCellMenuPart_PropertyValues {
    public Member_name_cellMenu_jpw21l_b0a2a0() {
    }
    @Override
    public List<SubstituteAction> createActions(CellContext cellContext, EditorContext editorContext) {
      return ListSequence.fromList(super.createActions(cellContext, editorContext)).select((action) -> {
        return (SubstituteAction) new NodeSubstituteActionWrapper(action) {
          ...
          public EditorMenuTraceInfo getEditorMenuTraceInfo() {
            ...
            result.setDescriptor(new EditorMenuDescriptorBase("property postfix values", new SNodePointer("r:c0dcafae-993e-49da-8bd0-f4eeac6d4bd9(com.mbeddr.core.udt.editor)", "1430983428334431497")));
            return result;
          }
        };
      }).toList();
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_jpw21l_a3a0");
