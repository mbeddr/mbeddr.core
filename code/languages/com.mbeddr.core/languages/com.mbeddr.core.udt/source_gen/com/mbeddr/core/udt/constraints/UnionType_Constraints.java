...
public class UnionType_Constraints extends BaseConstraintsDescriptor {
  /*package*/ UnionType_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.UnionType$xI, initContext);
    record(new RD1(this));
  }

  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.union$RA0L, container, true, false);
    }
    @Nullable
    @Override
