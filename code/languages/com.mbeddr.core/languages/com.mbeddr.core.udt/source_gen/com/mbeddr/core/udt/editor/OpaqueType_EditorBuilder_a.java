...
/*package*/ class OpaqueType_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public OpaqueType_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_n4bxco_a0");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.decl$Gj8i;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.decl$Gj8i);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.decl$Gj8i);
    }
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_n4bxco_a0b0a();
  ...
  private boolean nodeCondition_n4bxco_a0b0a() {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_n4bxco_a0b0a");
    return editorCell;
  }
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public SNode doSubstitute(String pattern) {
            SNode node = SNodeOperations.cast(ctx.getNode(), CONCEPTS.OpaqueType$Vv);
            IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.const$VWr7);
  ...
  private EditorCell createAlternation_1() {
    boolean alternationCondition = true;
    alternationCondition = nodeCondition_n4bxco_a0c0a();
    EditorCell editorCell = null;
    if (alternationCondition) {
  ...
  private boolean nodeCondition_n4bxco_a0c0a() {
  ...
  private EditorCell createSideTransformationSectionCell_1() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "flag 'volatile'") {
      @Override
      public List<MenuPart<TransformationMenuItem, TransformationMenuContext>> createMenuParts() {
        return ListSequence.fromListAndArray(new ArrayList<MenuPart<TransformationMenuItem, TransformationMenuContext>>(), new GenericMenuPart_a0a0c0a_3());
      }
    };
    editorCell.setCellId("SideTransformationSectionCell_n4bxco_a0c0a");
    return editorCell;
  }
  private class GenericMenuPart_a0a0c0a_3 implements MenuPart<TransformationMenuItem, TransformationMenuContext> {
