...
/*package*/ class StructType_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_lr7ptq_a0");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.struct$WCsg;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.struct$WCsg);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.struct$WCsg);
    }
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new ReferenceCellContext(getNode(), getNode(), referenceLink), new SubstituteInfoPartExt[]{new ReplaceWith_Type_cellMenu_lr7ptq_a0a0a(), new SChildSubstituteInfoPartEx(editorCell)}));
  ...
  public static class ReplaceWith_Type_cellMenu_lr7ptq_a0a0a extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public ReplaceWith_Type_cellMenu_lr7ptq_a0a0a() {
    }
    ...
    protected EditorMenuDescriptor createEditorMenuDescriptor(CellContext cellContext, EditorContext editorContext) {
      return new EditorMenuDescriptorBase("replace node (custom node concept: " + "Type" + ")", new SNodePointer("r:c0dcafae-993e-49da-8bd0-f4eeac6d4bd9(com.mbeddr.core.udt.editor)", "4694304187129827563"));
    }
  }
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_lr7ptq_a0a1a0();
  ...
  private boolean nodeCondition_lr7ptq_a0a1a0() {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_lr7ptq_a0a1a0");
    return editorCell;
  }
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public SNode doSubstitute(String pattern) {
            SNode node = SNodeOperations.cast(ctx.getNode(), CONCEPTS.StructType$B3);
            IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.volatile$hJNe);
  ...
  private EditorCell createAlternation_1() {
    boolean alternationCondition = true;
    alternationCondition = nodeCondition_lr7ptq_a0a2a0();
    EditorCell editorCell = null;
    if (alternationCondition) {
  ...
  private boolean nodeCondition_lr7ptq_a0a2a0() {
  ...
  private EditorCell createSideTransformationSectionCell_1() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_lr7ptq_a0a2a0");
    return editorCell;
  }
