...
public class EnumDeclaration_Constraints extends BaseConstraintsDescriptor {
  /*package*/ EnumDeclaration_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.EnumDeclaration$PP, initContext);
