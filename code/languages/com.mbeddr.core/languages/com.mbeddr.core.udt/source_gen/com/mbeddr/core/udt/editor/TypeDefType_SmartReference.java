...
public class TypeDefType_SmartReference extends SubstituteMenuBase {
  public TypeDefType_SmartReference() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "TypeDefType_SmartReference", new SNodePointer("r:c0dcafae-993e-49da-8bd0-f4eeac6d4bd9(com.mbeddr.core.udt.editor)", "4432183239164585980")));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_ReferenceScope_kfrfr2_a(), CONCEPTS.TypeDefType$3U));
    return result;
  }

  public class SMP_ReferenceScope_kfrfr2_a extends ReferenceScopeSubstituteMenuPart {

    public SMP_ReferenceScope_kfrfr2_a() {
      super(CONCEPTS.TypeDefType$3U, LINKS.typeDef$LmRK, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:c0dcafae-993e-49da-8bd0-f4eeac6d4bd9(com.mbeddr.core.udt.editor)", "4432183239164585978")));
    }
