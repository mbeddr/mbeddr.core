...
/*package*/ class EnumType_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createSideTransformationSectionCell_1() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "flag 'const'") {
      @Override
      public List<MenuPart<TransformationMenuItem, TransformationMenuContext>> createMenuParts() {
        return ListSequence.fromListAndArray(new ArrayList<MenuPart<TransformationMenuItem, TransformationMenuContext>>(), new GenericMenuPart_a0a0c0a_2());
      }
    };
    editorCell.setCellId("SideTransformationSectionCell_tqnc4o_a0c0a");
    return editorCell;
  }
  private class GenericMenuPart_a0a0c0a_2 implements MenuPart<TransformationMenuItem, TransformationMenuContext> {
