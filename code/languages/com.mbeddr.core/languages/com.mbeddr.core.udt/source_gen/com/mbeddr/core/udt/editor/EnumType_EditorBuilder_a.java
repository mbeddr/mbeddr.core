...
/*package*/ class EnumType_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_tqnc4o_a0b0a();
  ...
  private boolean nodeCondition_tqnc4o_a0b0a() {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_tqnc4o_a0b0a");
    return editorCell;
  }
  ...
  private EditorCell createAlternation_1() {
    boolean alternationCondition = true;
    alternationCondition = nodeCondition_tqnc4o_a0c0a();
    EditorCell editorCell = null;
    if (alternationCondition) {
  ...
  private boolean nodeCondition_tqnc4o_a0c0a() {
  ...
  private EditorCell createSideTransformationSectionCell_1() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "flag 'const'") {
      @Override
      public List<MenuPart<TransformationMenuItem, TransformationMenuContext>> createMenuParts() {
        return ListSequence.fromListAndArray(new ArrayList<MenuPart<TransformationMenuItem, TransformationMenuContext>>(), new GenericMenuPart_a0a0c0a_1());
      }
    };
    editorCell.setCellId("SideTransformationSectionCell_tqnc4o_a0c0a");
    return editorCell;
  }
  private class GenericMenuPart_a0a0c0a_1 implements MenuPart<TransformationMenuItem, TransformationMenuContext> {
