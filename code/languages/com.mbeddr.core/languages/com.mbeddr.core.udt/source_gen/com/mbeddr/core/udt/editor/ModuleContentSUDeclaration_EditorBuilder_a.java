...
/*package*/ class ModuleContentSUDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_czjnxc_a0a0a0();
  ...
  private boolean nodeCondition_czjnxc_a0a0a0() {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_czjnxc_a0a0a0");
    return editorCell;
  }
  ...
  private EditorCell createAlternation_1() {
    boolean alternationCondition = true;
    alternationCondition = nodeCondition_czjnxc_a0a1a0();
    EditorCell editorCell = null;
    if (alternationCondition) {
  ...
  private boolean nodeCondition_czjnxc_a0a1a0() {
  ...
  private EditorCell createSideTransformationSectionCell_1() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "flag 'exported'") {
      @Override
      public List<MenuPart<TransformationMenuItem, TransformationMenuContext>> createMenuParts() {
        return ListSequence.fromListAndArray(new ArrayList<MenuPart<TransformationMenuItem, TransformationMenuContext>>(), new GenericMenuPart_a0a0a1a0_4());
      }
    };
    editorCell.setCellId("SideTransformationSectionCell_czjnxc_a0a1a0");
    return editorCell;
  }
  private class GenericMenuPart_a0a0a1a0_4 implements MenuPart<TransformationMenuItem, TransformationMenuContext> {
