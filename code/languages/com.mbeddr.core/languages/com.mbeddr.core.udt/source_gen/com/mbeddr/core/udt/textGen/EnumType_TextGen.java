...
public class EnumType_TextGen extends TextGenDescriptorBase {
  @Override
  public void generateText(final TextGenContext ctx) {
    final TextGenSupport tgs = new TextGenSupport(ctx);

    tgs.append("enum ");
    tgs.append(IModuleContent__BehaviorDescriptor.getMangledName_id19a6$uAAq0e.invoke(SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.enum$UImg)));
