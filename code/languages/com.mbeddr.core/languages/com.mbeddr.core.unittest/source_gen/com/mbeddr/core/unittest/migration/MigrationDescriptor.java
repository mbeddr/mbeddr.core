...
public class MigrationDescriptor implements MigrationAspectDescriptor {
  private Map<Integer, MigrationScript> myScripts = MapSequence.fromMapAndEntryArray(new HashMap<Integer, MigrationScript>(), Map.entry(0, new migrateExecuteTestExpression()), Map.entry(1, new addConfigItemToBuildConfig()), Map.entry(2, new migrateTestCollection()), Map.entry(3, new removeTestStrategy()));
