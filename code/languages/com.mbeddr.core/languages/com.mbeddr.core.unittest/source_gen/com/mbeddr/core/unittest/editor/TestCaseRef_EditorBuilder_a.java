...
/*package*/ class TestCaseRef_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.testcase$9iCj;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.testcase$9iCj);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.testcase$9iCj);
    }
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new ReferenceCellContext(getNode(), getNode(), referenceLink), new SubstituteInfoPartExt[]{new TestCaseRef_testcase_cellMenu_aryab1_a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
  ...
  public static class TestCaseRef_testcase_cellMenu_aryab1_a0a0 extends PrimaryReferentMenuCellMenuPart {
    public TestCaseRef_testcase_cellMenu_aryab1_a0a0() {
    }
    @NotNull
    @Override
    protected IReferentPresentationProvider getMatchingTextProvider() {
      return PresentationProviders.PRESENTATION_aryab1_a0a0a;
    }
    @NotNull
    @Override
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_aryab1_b0");
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "(unittest)");
    editorCell.setCellId("Constant_aryab1_c0");
    Style style = new StyleImpl();
