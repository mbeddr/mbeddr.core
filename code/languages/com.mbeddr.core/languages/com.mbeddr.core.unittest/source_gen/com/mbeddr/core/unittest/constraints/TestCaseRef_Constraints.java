...
public class TestCaseRef_Constraints extends BaseConstraintsDescriptor {
  /*package*/ TestCaseRef_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.TestCaseRef$6w, initContext);
    record(new RD1(this));
  }

  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.testcase$9iCj, container, true, false);
    }
    @Nullable
    @Override
