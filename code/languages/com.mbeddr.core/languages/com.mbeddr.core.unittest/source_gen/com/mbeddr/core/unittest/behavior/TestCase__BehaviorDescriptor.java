...
public final class TestCase__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> genFunctionName_id5so5TTr6V11 = new SMethodBuilder<>(String.class).name("genFunctionName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6275792049641599041L).languageId(0x83b8857e63787800L, 0x6d68b77b6994918L).build2();
