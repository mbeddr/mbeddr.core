...
<model modelUID="r:055bac8c-a50b-42ec-a317-e20a256152b4(com.mbeddr.core.debug.structure)" version="3">
  ...
  <roots>
    ...
    <node type="tpce.InterfaceConceptDeclaration" typeId="tpce.1169125989551" id="7174143234339741879">
      <property name="name" nameId="tpck.1169194664001" value="IDebugInformationProvider" />
      <property name="virtualPackage" nameId="tpck.1193676396447" value="state" />
    </node>
    <node type="tpce.InterfaceConceptDeclaration" typeId="tpce.1169125989551" id="6735543362812541977">
      <property name="name" nameId="tpck.1169194664001" value="IStepOverSteppableStrategyProvider" />
      <property name="virtualPackage" nameId="tpck.1193676396447" value="control" />
    </node>
    <node type="tpce.InterfaceConceptDeclaration" typeId="tpce.1169125989551" id="8843487766123652265">
      <property name="name" nameId="tpck.1169194664001" value="ISteppableContextStrategyProvider" />
      <property name="virtualPackage" nameId="tpck.1193676396447" value="control" />
    </node>
    <node type="tpce.InterfaceConceptDeclaration" typeId="tpce.1169125989551" id="9057217260024409663">
      <property name="name" nameId="tpck.1169194664001" value="IWatchableProvider" />
      <property name="virtualPackage" nameId="tpck.1193676396447" value="state" />
    </node>
    <node type="tpce.InterfaceConceptDeclaration" typeId="tpce.1169125989551" id="4474148880361719194">
      <property name="virtualPackage" nameId="tpck.1193676396447" value="state" />
      <property name="name" nameId="tpck.1169194664001" value="IWatchtablesProviderContext" />
    </node>
  ...
  <root id="7174143234339741879" />
  <root id="6735543362812541977" />
  <root id="8843487766123652265" />
