...
public class RuleRef_Constraints extends BaseConstraintsDescriptor {
  /*package*/ RuleRef_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.RuleRef$ep, initContext);
    record(new RD1(this));
  ...
  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.rule$O3Le, container, true, false);
    }
    @Nullable
    @Override
