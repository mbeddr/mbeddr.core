...
/*package*/ class Command_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new itemsListHandler_5th3tc_a0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
    editorCell.setCellId("refNodeList_items");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class itemsListHandler_5th3tc_a0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public itemsListHandler_5th3tc_a0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(itemsListHandler_5th3tc_a0.this.getNode(), LINKS.items$dnbt));
      try {
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "¶");
    editorCell.setCellId("Constant_5th3tc_b0");
