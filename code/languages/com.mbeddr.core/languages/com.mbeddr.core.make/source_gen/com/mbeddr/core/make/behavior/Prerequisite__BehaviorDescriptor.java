...
public final class Prerequisite__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf93d1dbebfd142ddL, 0x932af375fa6f5373L, 0x7abf078658cd4452L, "com.mbeddr.core.make.structure.Prerequisite");
  ...
  private static void ___init___(@NotNull SNode __thisNode__) {
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.prerequisiteItems$o14e)).addElement(createPlainTextFragment_e23t99_a0a0a0());
  }

  /*package*/ static String getPresentation_idhEwIMiw(@NotNull final SNode __thisNode__) {
    return IterableUtils.join(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.prerequisiteItems$o14e)).select((it) -> {
  ...
  /*package*/ Prerequisite__BehaviorDescriptor() {
  }
  ...
  private static SNode createPlainTextFragment_e23t99_a0a0a0() {
