...
/*package*/ class ArrayAccessExpr_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new expressionSingleRoleHandler_smnf8t_a0a0(myNode, LINKS.expression$PfNq, getEditorContext());
    return provider.createCell();
  }
  private static class expressionSingleRoleHandler_smnf8t_a0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public expressionSingleRoleHandler_smnf8t_a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
