...
public final class SizeOfExprForExpressions__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x3bf5377ae9044dedL, 0x97545a516023bfaaL, 0x5f889d8764c18525L, "com.mbeddr.core.pointers.structure.SizeOfExprForExpressions");
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(isSideeffectFree_id6SENleF$SRD, getPriolevel_id5HxjapwgqKu, renderReadable_id1VQvajLb13M);
  ...
  /*package*/ static String renderReadable_id1VQvajLb13M(@NotNull SNode __thisNode__) {
    return "sizeof(" + Expression__BehaviorDescriptor.renderReadable_id1VQvajLb13M.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expression$PfNq)) + ")";
  }

  /*package*/ SizeOfExprForExpressions__BehaviorDescriptor() {
  }
