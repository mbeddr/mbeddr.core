...
public final class StringLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Integer> getUnescapedValueLength_id4FYctDz1tF0 = new SMethodBuilder<>(Integer.TYPE).name("getUnescapedValueLength").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5403811416925133504L).languageId(0x97545a516023bfaaL, 0x3bf5377ae9044dedL).build2();
  public static final SMethod<Integer> getSize_idJ0Y$7B64qW = new SMethodBuilder<>(Integer.TYPE).name("getSize").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(846951890902599356L).languageId(0x97545a516023bfaaL, 0x3bf5377ae9044dedL).build2();
