...
public class SizeOfExpr_TextGen extends TextGenDescriptorBase {
  @Override
  public void generateText(final TextGenContext ctx) {
    final TextGenSupport tgs = new TextGenSupport(ctx);
    tgs.createPositionInfo();
    tgs.append("sizeof(");
    TokenTextGen.genTypeWithName(SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.type2Calculate$UhLe), "", ctx);
    tgs.append(")");
