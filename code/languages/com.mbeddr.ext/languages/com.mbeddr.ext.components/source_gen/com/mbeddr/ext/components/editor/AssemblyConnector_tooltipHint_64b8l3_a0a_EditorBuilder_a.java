...
/*package*/ class AssemblyConnector_tooltipHint_64b8l3_a0a_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createQueryList_0(final EditorContext editorContext, final SNode node) {
    ...
    return QueryListContext.computeWithContext(new QueryListContext(node), () -> {
      QueryListHandler handler = new QueryListHandler_jd4lxk_a0(editorContext, node);
      ...
      new ComponentStyleClass(AssemblyConnector_tooltipHint_64b8l3_a0a_EditorBuilder_a.this).apply(style, editorCell);
  ...
  private static class QueryListHandler_jd4lxk_a0 extends QueryListHandler {
    private SNode myNode;
    public QueryListHandler_jd4lxk_a0(EditorContext context, SNode ownerNode) {
