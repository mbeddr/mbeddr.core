...
public class InterfaceType_Constraints extends BaseConstraintsDescriptor {
  /*package*/ InterfaceType_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.InterfaceType$7N, initContext);
    record(new RD1(this));
  ...
  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.intf$e6VC, container, true, false);
    }
    @Nullable
    @Override
