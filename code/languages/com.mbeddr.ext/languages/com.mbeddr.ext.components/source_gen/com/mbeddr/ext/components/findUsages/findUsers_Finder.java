...
public class findUsers_Finder extends GeneratedFinder {
  public findUsers_Finder() {
  }
  @Override
  ...
  protected void doFind0(@NotNull SNode node, SearchScope scope, IFinder.FindCallback callback, ProgressMonitor monitor) {
    ...
    try {
      ...
      for (SNode n : ListSequence.fromList(nodes)) {
        if (SNodeOperations.isInstanceOf(n, CONCEPTS.RequiredPort$Si)) {
  ...
  public SNodeReference getDeclarationNode() {
    return buildNodePointer(FindUsagesDescriptor.DECLARING_MODEL, "374287044671918853");
  }
