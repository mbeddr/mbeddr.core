...
public final class InstanceConfiguration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Iterable<SNode>> adapters_id5fn4FV$c8kP = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("adapters").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6041318036222281013L).languageId(0x97fc7bd73b1f5f40L, 0x97d2424451db4e2eL).build2();
  public static final SMethod<String> graphName_id$9lckyphlf = new SMethodBuilder<>(String.class).name("graphName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(651144826794087759L).languageId(0x97fc7bd73b1f5f40L, 0x97d2424451db4e2eL).build2();
  public static final SMethod<String> generatedMethodName_id4mLQOETvhCf = new SMethodBuilder<>(String.class).name("generatedMethodName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5022036173480860175L).languageId(0x97fc7bd73b1f5f40L, 0x97d2424451db4e2eL).build2();
  ...
  public static final SMethod<SNode> findInstanceByName_id2LSSMkCIUME = new SMethodBuilder<>(SNode.class).name("findInstanceByName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3204560883610791082L).languageId(0x97fc7bd73b1f5f40L, 0x97d2424451db4e2eL).build2(SMethodBuilder.createJavaParameter(String.class, "name"));
