...
/*package*/ class RequiredPort_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RequiredPort_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_bp4nhi_a0");
    ...
    if (nodeCondition_bp4nhi_a6a0()) {
      editorCell.addEditorCell(createCustomFactory_5());
    }
    return editorCell;
  }
  private boolean nodeCondition_bp4nhi_a6a0() {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_bp4nhi_a0a");
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_bp4nhi_a0d0a();
  ...
  private boolean nodeCondition_bp4nhi_a0d0a() {
    IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.optional$mTHR);
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_bp4nhi_a0d0a");
    return editorCell;
  }
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public SNode doSubstitute(String pattern) {
            SNode node = SNodeOperations.cast(ctx.getNode(), CONCEPTS.RequiredPort$Si);
            IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.optional$mTHR);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new cardinalitySingleRoleHandler_bp4nhi_e0a(myNode, LINKS.cardinality$DLq9, getEditorContext());
    return provider.createCell();
  }
  private static class cardinalitySingleRoleHandler_bp4nhi_e0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public cardinalitySingleRoleHandler_bp4nhi_e0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.cardinality$DLq9, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.cardinality$DLq9, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.cardinality$DLq9);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.cardinality$DLq9));
      try {
    ...
    private EditorCell createCollection_1() {
      jetbrains.mps.nodeEditor.cells.EditorCell_Collection editorCell = new jetbrains.mps.nodeEditor.cells.EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
      editorCell.setCellId("Collection_bp4nhi_a4a0");
      Style style = new StyleImpl();
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new restrictionSingleRoleHandler_bp4nhi_f0a(myNode, LINKS.restriction$51lW, getEditorContext());
    return provider.createCell();
  }
  private static class restrictionSingleRoleHandler_bp4nhi_f0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public restrictionSingleRoleHandler_bp4nhi_f0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.restriction$51lW, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.restriction$51lW, child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.restriction$51lW);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.restriction$51lW));
      try {
    ...
    private EditorCell createCollection_2() {
      jetbrains.mps.nodeEditor.cells.EditorCell_Collection editorCell = new jetbrains.mps.nodeEditor.cells.EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
      editorCell.setCellId("Collection_bp4nhi_a5a0");
      Style style = new StyleImpl();
      style.set(StyleAttributes.SELECTABLE, false);
      editorCell.getStyle().putAll(style);
      return editorCell;
  ...
  private EditorCell createCollection_3() {
    jetbrains.mps.nodeEditor.cells.EditorCell_Collection editorCell = new jetbrains.mps.nodeEditor.cells.EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_bp4nhi_a6a0");
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_bp4nhi_a0g0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new characteristicsListHandler_bp4nhi_b0g0a(myNode, getEditorContext());
  ...
  private static class characteristicsListHandler_bp4nhi_b0g0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public characteristicsListHandler_bp4nhi_b0g0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(characteristicsListHandler_bp4nhi_b0g0a.this.getNode(), LINKS.characteristics$wUbi));
      try {
  ...
  private EditorCell createConstant_3() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "]");
    editorCell.setCellId("Constant_bp4nhi_c0g0a");
    Style style = new StyleImpl();
    new BracesStyleClass(this).apply(style, editorCell);
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
