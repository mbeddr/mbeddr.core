...
public final class PortAdapterRefExpr__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x97d2424451db4e2eL, 0x97fc7bd73b1f5f40L, 0x707ac195dd610219L, "com.mbeddr.ext.components.structure.PortAdapterRefExpr");
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(target_id70kXLV4LLzy, isDotCapable_id66WTx3vdu2E, renderReadable_id1VQvajLb13M);


  /*package*/ static SNode target_id70kXLV4LLzy(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.portAdater$$CH8);
  }
  ...
  /*package*/ static String renderReadable_id1VQvajLb13M(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.portAdater$$CH8), PROPS.name$MnvL);
  }

  /*package*/ PortAdapterRefExpr__BehaviorDescriptor() {
  }
