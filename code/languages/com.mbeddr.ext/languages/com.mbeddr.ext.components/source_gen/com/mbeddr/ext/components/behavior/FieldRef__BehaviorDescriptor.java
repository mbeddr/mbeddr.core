...
public final class FieldRef__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x97d2424451db4e2eL, 0x97fc7bd73b1f5f40L, 0x49ac54536383aff9L, "com.mbeddr.ext.components.structure.FieldRef");
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(renderReadable_id1VQvajLb13M, isLValue_id6iIoqg1yDKH, target_id70kXLV4LLzy);

  private static void ___init___(@NotNull SNode __thisNode__) {
  }

  /*package*/ static String renderReadable_id1VQvajLb13M(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.field$P8O8), PROPS.name$MnvL);
  }
  /*package*/ static boolean isLValue_id6iIoqg1yDKH(@NotNull SNode __thisNode__) {
    return !(SPropertyOperations.getBoolean(SLinkOperations.getTarget(__thisNode__, LINKS.field$P8O8), PROPS.initField$Wgp_));
  }
  /*package*/ static SNode target_id70kXLV4LLzy(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.field$P8O8);
  }

  /*package*/ FieldRef__BehaviorDescriptor() {
  }
