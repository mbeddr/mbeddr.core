...
public class ProvidedPort_Constraints extends BaseConstraintsDescriptor {
  /*package*/ ProvidedPort_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.ProvidedPort$RN, initContext);
    record(new RD1(this));
  }
    ...
    public ReferenceScopeProvider getScopeProvider() {
      return new BaseScopeProvider() {
        ...
        public SNodeReference getSearchScopeValidatorNode() {
          return new SNodePointer("r:4b72363d-e94a-4383-b5ad-ba453d6efac9(com.mbeddr.ext.components.constraints)", "4048193437558553057");
        }
        @Override
