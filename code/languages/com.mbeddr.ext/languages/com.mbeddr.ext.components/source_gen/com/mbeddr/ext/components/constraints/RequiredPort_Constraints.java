...
public class RequiredPort_Constraints extends BaseConstraintsDescriptor {
  /*package*/ RequiredPort_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.RequiredPort$Si, initContext);
    record(new RD1(this));
  }

  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.intf$QYND, container, true, false);
    }
    @Nullable
    @Override
