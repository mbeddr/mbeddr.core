...
/*package*/ class SenderReceiverInterface_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public SenderReceiverInterface_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_d0ee7f_a0");
    if (nodeCondition_d0ee7f_a0a0()) {
  ...
  private boolean nodeCondition_d0ee7f_a0a0() {
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_d0ee7f_a0a0a0();
  ...
  private boolean nodeCondition_d0ee7f_a0a0a0() {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_d0ee7f_a0a0a0");
    return editorCell;
  }
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public SNode doSubstitute(String pattern) {
            SNode node = SNodeOperations.cast(ctx.getNode(), CONCEPTS.SenderReceiverInterface$Vo);
            IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.exported$V4am);
          ...
          public SAbstractConcept getOutputConcept() {
            return CONCEPTS.SenderReceiverInterface$Vo;
          }
        };
  ...
  private EditorCell createAlternation_1() {
    boolean alternationCondition = true;
    alternationCondition = nodeCondition_d0ee7f_a0b0a();
    EditorCell editorCell = null;
    if (alternationCondition) {
  ...
  private boolean nodeCondition_d0ee7f_a0b0a() {
    IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.strict$AkgG);
    if (!(access.read(myNode))) {
      return false;
    }
  ...
  private EditorCell createSideTransformationSectionCell_1() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_d0ee7f_a0b0a");
    return editorCell;
  }
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "sr interface");
    editorCell.setCellId("Constant_d0ee7f_c0a");
    Style style = new StyleImpl();
    new KWStyleClass(this).apply(style, editorCell);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_3() {
    ...
    editorCell.setCellId("Constant_d0ee7f_e0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new elementsListHandler_d0ee7f_f0a(myNode, getEditorContext());
  ...
  private static class elementsListHandler_d0ee7f_f0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public elementsListHandler_d0ee7f_f0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(elementsListHandler_d0ee7f_f0a.this.getNode(), LINKS.elements$FJ25));
      try {
    ...
    private EditorCell createConstant_4() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
      editorCell.setCellId("Constant_d0ee7f_a5a0");
      Style style = new StyleImpl();
  ...
  private EditorCell createConstant_5() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "}");
    editorCell.setCellId("Constant_d0ee7f_g0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
