...
public final class Interface__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> genStructName_id4WLtQa9fEO8 = new SMethodBuilder<>(String.class).name("genStructName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5706473467948215560L).languageId(0x97fc7bd73b1f5f40L, 0x97d2424451db4e2eL).build2();
  ...
  public static final SMethod<Boolean> canBeUsedInMultipleRP_id2ZUGF54k3cG = new SMethodBuilder<>(Boolean.TYPE).name("canBeUsedInMultipleRP").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3457272138385339180L).languageId(0x97fc7bd73b1f5f40L, 0x97d2424451db4e2eL).build2();
  public static final SMethod<Boolean> hasProtocol_id5oFMniD9Ori = new SMethodBuilder<>(Boolean.TYPE).name("hasProtocol").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6209278014151673554L).languageId(0x97fc7bd73b1f5f40L, 0x97d2424451db4e2eL).build2();
