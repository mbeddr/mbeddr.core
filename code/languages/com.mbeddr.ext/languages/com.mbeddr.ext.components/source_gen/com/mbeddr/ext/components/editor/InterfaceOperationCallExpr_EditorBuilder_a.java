...
/*package*/ class InterfaceOperationCallExpr_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new expressionSingleRoleHandler_b94zx1_a0a0(myNode, LINKS.expression$PfNq, getEditorContext());
    return provider.createCell();
  }
  private static class expressionSingleRoleHandler_b94zx1_a0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public expressionSingleRoleHandler_b94zx1_a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private static class actualsListHandler_b94zx1_a4a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      ...
      try {
        ...
        emptyCell = createCustomFactory_15();
