...
public final class ComponentInstanceRefExpr__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x97d2424451db4e2eL, 0x97fc7bd73b1f5f40L, 0x7f76b5152d3c73ebL, "com.mbeddr.ext.components.structure.ComponentInstanceRefExpr");
  ...
  /*package*/ static SNode target_id70kXLV4LLzy(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.ci$IlQ8);
  }

  /*package*/ ComponentInstanceRefExpr__BehaviorDescriptor() {
  }
