...
public final class PPCParamRef__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x97d2424451db4e2eL, 0x97fc7bd73b1f5f40L, 0x5b797aeeb5956522L, "com.mbeddr.ext.components.structure.PPCParamRef");
  ...
  /*package*/ static SNode target_id70kXLV4LLzy(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.param$pPDC);
  }
  /*package*/ static String renderReadable_id1VQvajLb13M(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.param$pPDC), PROPS.name$MnvL);
  }

  /*package*/ PPCParamRef__BehaviorDescriptor() {
  }
