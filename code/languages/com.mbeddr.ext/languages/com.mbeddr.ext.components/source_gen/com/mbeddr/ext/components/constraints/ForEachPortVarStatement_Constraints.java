...
public class ForEachPortVarStatement_Constraints extends BaseConstraintsDescriptor {
  /*package*/ ForEachPortVarStatement_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.ForEachPortVarStatement$iY, initContext);
    record(new RD1(this));
  ...
  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.portVarRef$8A5X, container, true, false);
    }
    @Nullable
    @Override
