...
public class PortAdapterOpCallExpr_DataFlow extends DataFlowBuilder {
  public void build(final DataFlowBuilderContext _context) {
    ...
    for (SNode a : ListSequence.fromList(SLinkOperations.getChildren(_context.getNode(), LINKS.actuals$OVo1))) {
