...
/*package*/ class ImplementRunnableRef_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ImplementRunnableRef_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_97qbw_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_97qbw_a0");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.runnable$NKeC;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.runnable$NKeC);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.runnable$NKeC);
    }
    ...
    private EditorCell createReadOnlyModelAccessor_0() {
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new ModelAccessor.ReadOnly() {
        public String getText() {
          return SPropertyOperations.getString(NodeReadAccessCasterInEditor.runReadTransparentAction(() -> SNodeOperations.getNodeAncestor(myNode, CONCEPTS.AtomicComponent$ym, false, false)), PROPS.name$MnvL) + "::" + SPropertyOperations.getString(myNode, PROPS.name$MnvL);
        }
      }, myNode);
      editorCell.setAction(CellActionType.DELETE, EmptyCellAction.getInstance());
      editorCell.setAction(CellActionType.BACKSPACE, EmptyCellAction.getInstance());
      editorCell.setCellId("ReadOnlyModelAccessor_97qbw_a0b0");
      Style style = new StyleImpl();
