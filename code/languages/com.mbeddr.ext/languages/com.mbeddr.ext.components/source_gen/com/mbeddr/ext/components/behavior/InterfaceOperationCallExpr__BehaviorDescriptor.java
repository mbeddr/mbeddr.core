...
public final class InterfaceOperationCallExpr__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> signatureInfo_id9z$8oL3Yt1 = new SMethodBuilder<>(String.class).name("signatureInfo").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(172140116793354049L).languageId(0x97fc7bd73b1f5f40L, 0x97d2424451db4e2eL).build2();
