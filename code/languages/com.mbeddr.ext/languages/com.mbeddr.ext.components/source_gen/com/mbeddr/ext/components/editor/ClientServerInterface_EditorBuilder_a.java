...
/*package*/ class ClientServerInterface_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ClientServerInterface_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_5f29ts_a0");
    if (nodeCondition_5f29ts_a0a0()) {
  ...
  private boolean nodeCondition_5f29ts_a0a0() {
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_5f29ts_a0a0a0();
  ...
  private boolean nodeCondition_5f29ts_a0a0a0() {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "flag 'exported'") {
      ...
      public List<MenuPart<TransformationMenuItem, TransformationMenuContext>> createMenuParts() {
        return ListSequence.fromListAndArray(new ArrayList<MenuPart<TransformationMenuItem, TransformationMenuContext>>(), new GenericMenuPart_a0a0a0a0_1());
      }
    };
    editorCell.setCellId("SideTransformationSectionCell_5f29ts_a0a0a0");
    return editorCell;
  }
  private class GenericMenuPart_a0a0a0a0_1 implements MenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public SNode doSubstitute(String pattern) {
            SNode node = SNodeOperations.cast(ctx.getNode(), CONCEPTS.ClientServerInterface$D2);
            IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.exported$V4am);
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "cs interface");
    editorCell.setCellId("Constant_5f29ts_b0a");
    Style style = new StyleImpl();
    new KWStyleClass(this).apply(style, editorCell);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_5f29ts_d0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new contentsListHandler_5f29ts_e0a(myNode, getEditorContext());
  ...
  private static class contentsListHandler_5f29ts_e0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public contentsListHandler_5f29ts_e0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.contents$QSgb;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.ICSInterfaceContents$IL;
    }
    ...
    public SNode nodeFactory(SNode prevNode, SNode nextNode, int index) {
      return SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x97d2424451db4e2eL, 0x97fc7bd73b1f5f40L, 0x5f577c39369a7766L, "com.mbeddr.ext.components.structure.EmptyInterfaceContents"));
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(contentsListHandler_5f29ts_e0a.this.getNode(), LINKS.contents$QSgb));
      try {
    ...
    private EditorCell createReadOnlyModelAccessor_0() {
      ...
      editorCell.setCellId("ReadOnlyModelAccessor_5f29ts_a4a0");
      Style style = new StyleImpl();
  ...
  private EditorCell createConstant_3() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "}");
    editorCell.setCellId("Constant_5f29ts_f0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SInterfaceConcept ICSInterfaceContents$IL = MetaAdapterFactory.getInterfaceConcept(0x97d2424451db4e2eL, 0x97fc7bd73b1f5f40L, 0x5f577c39369694f9L, "com.mbeddr.ext.components.structure.ICSInterfaceContents");
  }
