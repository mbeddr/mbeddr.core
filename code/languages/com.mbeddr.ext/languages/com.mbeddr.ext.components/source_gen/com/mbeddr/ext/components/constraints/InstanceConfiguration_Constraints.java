...
public class InstanceConfiguration_Constraints extends BaseConstraintsDescriptor {
  /*package*/ InstanceConfiguration_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.InstanceConfiguration$MO, initContext);
