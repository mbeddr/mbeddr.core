...
public class ComponentType_Constraints extends BaseConstraintsDescriptor {
  /*package*/ ComponentType_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.ComponentType$8R, initContext);
    record(new RD1(this));
  }

  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.component$5BtC, container, true, false);
    }
    @Nullable
    @Override
