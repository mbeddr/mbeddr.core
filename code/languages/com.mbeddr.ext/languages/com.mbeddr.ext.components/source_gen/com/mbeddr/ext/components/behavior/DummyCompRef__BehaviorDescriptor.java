...
public final class DummyCompRef__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static String getReferenceCategory_id2IZ2bWrPahB(@NotNull SAbstractConcept __thisConcept__) {
    return "Components";
  }

  /*package*/ DummyCompRef__BehaviorDescriptor() {
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SAbstractConcept concept, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) ((String) getReferenceCategory_id2IZ2bWrPahB(concept));
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
