...
/*package*/ class OperationParameter_tooltipHint_9ndag5_a0_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public OperationParameter_tooltipHint_9ndag5_a0_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_t9hwzs_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    try {
      getCellFactory().pushCellContext();
      getCellFactory().removeCellContextHints(new String[]{"com.mbeddr.ext.components.editor.GeneratedHints.tooltipHint_9ndag5_a0"});
      if (nodeCondition_t9hwzs_a0a()) {
  ...
  private boolean nodeCondition_t9hwzs_a0a() {
  ...
  private EditorCell createReadOnlyModelAccessor_0() {
    ...
    editorCell.setCellId("ReadOnlyModelAccessor_t9hwzs_a0a");
