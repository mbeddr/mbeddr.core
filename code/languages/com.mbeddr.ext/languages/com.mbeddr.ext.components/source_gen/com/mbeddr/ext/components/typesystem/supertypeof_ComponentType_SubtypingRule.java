...
public class supertypeof_ComponentType_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  public supertypeof_ComponentType_SubtypingRule() {
  }
  public SNode getSubOrSuperType(SNode componentType, TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    return createPointerType_9dhd24_a0a1();
  }
  ...
  private static SNode createPointerType_9dhd24_a0a1() {
