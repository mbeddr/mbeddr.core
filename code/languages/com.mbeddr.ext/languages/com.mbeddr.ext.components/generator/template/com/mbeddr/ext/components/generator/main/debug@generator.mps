...
<model modelUID="r:910aa226-f466-4532-b802-c2ccde0fbc4b(com.mbeddr.ext.components.generator.main.debug@generator)">
  ...
  <roots>
    <node type="tpf8.MappingConfiguration" typeId="tpf8.1095416546421" id="2412970179599424370">
      <property name="topPriorityGroup" nameId="tpf8.1184950341882" value="true" />
      <property name="name" nameId="tpck.1169194664001" value="debug" />
    </node>
    <node type="v7ag.ComponentMappingDebugHelper" typeId="v7ag.7798021607625279741" id="2412970179599424376">
      <property name="name" nameId="tpck.1169194664001" value="map_InstanceConfiguration" />
    </node>
  </roots>
  <root id="2412970179599424370">
    <node role="rootMappingRule" roleId="tpf8.1167514678247" type="tpf8.Root_MappingRule" typeId="tpf8.1167514355419" id="2412970179599424371">
      ...
      <link role="template" roleId="tpf8.1167514355421" targetNodeId="2412970179599424376" resolveInfo="map_InstanceConfiguration" />
      <node role="conditionFunction" roleId="tpf8.1167169362365" type="tpf8.BaseMappingRule_Condition" typeId="tpf8.1167168920554" id="2412970179599424372">
        <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="2412970179599424373">
  ...
  <root id="2412970179599424376">
    <node role="smodelAttribute" roleId="tpck.5169995583184591170" type="tpf8.RootTemplateAnnotation" typeId="tpf8.1168619357332" id="2412970179599424377">
    ...
    <node role="mappings" roleId="v7ag.7798021607625279750" type="v7ag.InterfaceToImplementationMapping" typeId="v7ag.2924520848052679299" id="2412970179599424378">
      <property name="interfaceName" nameId="v7ag.2924520848052679301" value="intfName" />
      <property name="componentNodeID" nameId="v7ag.2924520848052679302" value="compID" />
      <property name="componentModelName" nameId="v7ag.3298295153090008254" value="modelID" />
      <node role="smodelAttribute" roleId="tpck.5169995583184591170" type="tpf8.LoopMacro" typeId="tpf8.1118786554307" id="2412970179599424380">
        <node role="sourceNodesQuery" roleId="tpf8.1167952069335" type="tpf8.SourceSubstituteMacro_SourceNodesQuery" typeId="tpf8.1167951910403" id="2412970179599424381">
          <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="2412970179599424382">
            <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="2412970179599424383">
              <node role="expression" roleId="tpee.1068580123156" type="tpee.DotExpression" typeId="tpee.1197027756228" id="2412970179599424405">
                <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="2412970179599424384" />
                <node role="operation" roleId="tpee.1197027833540" type="tp25.Node_ConceptMethodCall" typeId="tp25.1179409122411" id="2412970179599424410">
      ...
      <node role="smodelAttribute" roleId="tpck.5169995583184591170" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="2412970179599424422">
        <property name="propertyName" nameId="tpck.1757699476691236117" value="interfaceName" />
        <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="2412970179599424425">
          <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="2412970179599424426">
      ...
      <node role="smodelAttribute" roleId="tpck.5169995583184591170" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="2412970179599424433">
        <property name="propertyName" nameId="tpck.1757699476691236117" value="componentNodeID" />
        <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="2412970179599424436">
          <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="2412970179599424437">
      ...
      <node role="smodelAttribute" roleId="tpck.5169995583184591170" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="2412970179599424444">
        <property name="propertyName" nameId="tpck.1757699476691236117" value="componentModelName" />
        <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="2412970179599424447">
          <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="2412970179599424448">
    ...
    <node role="smodelAttribute" roleId="tpck.5169995583184591170" type="tpf8.PropertyMacro" typeId="tpf8.1087833241328" id="2412970179599424411">
      <property name="propertyName" nameId="tpck.1757699476691236117" value="name" />
      <node role="propertyValueFunction" roleId="tpf8.1167756362303" type="tpf8.PropertyMacro_GetPropertyValue" typeId="tpf8.1167756080639" id="2412970179599424414">
        <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="2412970179599424415">
          <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="2412970179599424416">
            <node role="expression" roleId="tpee.1068580123156" type="tpee.DotExpression" typeId="tpee.1197027756228" id="2412970179599424417">
              <node role="operation" roleId="tpee.1197027833540" type="tp25.SPropertyAccess" typeId="tp25.1138056022639" id="2412970179599424421">
                <link role="property" roleId="tp25.1138056395725" targetNodeId="tpck.1169194664001" resolveInfo="name" />
              </node>
              <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="2412970179599424419" />
            </node>
          </node>
        </node>
      </node>
