...
/*package*/ class Transition_graphical_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createDiagramConnector_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, () -> {
      ...
      SNodeEdgeAccessor accessor = new SNodeEdgeAccessor(node, null) {
...

        {
          ...
          if (reverse) {
            ...
            {
              Tuples._2<IConnectionEndpointReference, IConnectionEndpointReference> _tmp_efk5jx_b0b0i0a0a1a2a3a8 = MultiTuple.<IConnectionEndpointReference,IConnectionEndpointReference>from(endpointTo, endpointFrom);
              endpointFrom = _tmp_efk5jx_b0b0i0a0a1a2a3a8._0();
              endpointTo = _tmp_efk5jx_b0b0i0a0a1a2a3a8._1();
            }
            {
              Tuples._2<EditorCell, EditorCell> _tmp_efk5jx_c0b0i0a0a1a2a3a8 = MultiTuple.<EditorCell,EditorCell>from(endRoleCell, startRoleCell);
              startRoleCell = _tmp_efk5jx_c0b0i0a0a1a2a3a8._0();
              endRoleCell = _tmp_efk5jx_c0b0i0a0a1a2a3a8._1();
            }
            {
              Tuples._2<IShape, IShape> _tmp_efk5jx_d0b0i0a0a1a2a3a8 = MultiTuple.<IShape,IShape>from(endShape, startShape);
              startShape = _tmp_efk5jx_d0b0i0a0a1a2a3a8._0();
              endShape = _tmp_efk5jx_d0b0i0a0a1a2a3a8._1();
            }
          }
        }
      ...
      EditorCell label = DiagramUtil.getCellIfNotEmpty(new Inline_Builder_9t39wh_a0(editorContext, node).createCell());

      EditorCell editorCell = label;
      MyGraph rootGraph = DiagramCreationContext.getRootGraph();
      if (editorCell != null && rootGraph != null) {
        Style style = new StyleImpl();
        style.set(StyleAttributes.getInstance().<LineStyle>getAttribute("de.itemis.mps.editor.diagram.styles", "__line-style"), _StyleParameter_QueryFunction_9t39wh_a0a());
        style.set(StyleAttributes.getInstance().<Float>getAttribute("de.itemis.mps.editor.diagram.styles", "__line-width"), _StyleParameter_QueryFunction_9t39wh_a1a());
        style.set(StyleAttributes.getInstance().<Color>getAttribute("de.itemis.mps.editor.diagram.styles", "__line-color"), getStyleRegistry().getSimpleColor(_StyleParameter_QueryFunction_9t39wh_a2a()));
      ...
      editorCell.setCellId("DiagramConnector_9t39wh_a");
  ...
  private LineStyle _StyleParameter_QueryFunction_9t39wh_a0a() {
    return LineStyle.SOLID;
  }
  private Float _StyleParameter_QueryFunction_9t39wh_a1a() {
    return 2.0f;
  }
  private Color _StyleParameter_QueryFunction_9t39wh_a2a() {
  ...
  /*package*/ static class Inline_Builder_9t39wh_a0 extends AbstractEditorBuilder {
    ...
    private EditorCell createCollection_0() {
      ...
      Style style = new StyleImpl();
      style.set(StyleAttributes.MAX_WIDTH, 225);
      editorCell.getStyle().putAll(style);
    ...
    private EditorCell createRefNode_0() {
      SingleRoleCellProvider provider = new triggerSingleRoleHandler_9t39wh_a0a0(myNode, LINKS.trigger$GAf9, getEditorContext());
      return provider.createCell();
    }
    private static class triggerSingleRoleHandler_9t39wh_a0a0 extends SingleRoleCellProvider {
      @NotNull
      private SNode myNode;

      public triggerSingleRoleHandler_9t39wh_a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      ...
      private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
        ...
        style.set(StyleAttributes.TEXT_COLOR, getStyleRegistry().getSimpleColor(_StyleParameter_QueryFunction_9t39wh_a0a0a0()));
        editorCell.getStyle().putAll(style);
      }
      @Override
      ...
      private Color _StyleParameter_QueryFunction_9t39wh_a0a0a0() {
        return DiagramColors.STATE_COMMENT;
      }
    }
    private EditorCell createConstant_0() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "[");
      editorCell.setCellId("Constant_9t39wh_b0a0");
      Style style = new StyleImpl();
    ...
    private EditorCell createRefNode_1() {
      SingleRoleCellProvider provider = new guardSingleRoleHandler_9t39wh_c0a0(myNode, LINKS.guard$OBO2, getEditorContext());
      return provider.createCell();
    }
    private static class guardSingleRoleHandler_9t39wh_c0a0 extends SingleRoleCellProvider {
      @NotNull
      private SNode myNode;

      public guardSingleRoleHandler_9t39wh_c0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
        super(containmentLink, context);
        myNode = ownerNode;
      }
      ...
      private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
        ...
        Style style = new StyleImpl();
        new StateStyleClass(this).apply(style, editorCell);
        style.set(StyleAttributes.TEXT_COLOR, getStyleRegistry().getSimpleColor(_StyleParameter_QueryFunction_9t39wh_a0c0a0()));
        editorCell.getStyle().putAll(style);
      }
      @Override
      protected EditorCell createEmptyCell() {
      ...
      private Color _StyleParameter_QueryFunction_9t39wh_a0c0a0() {
        return DiagramColors.STATE_COMMENT;
      }
    }
    private EditorCell createConstant_1() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "]");
      editorCell.setCellId("Constant_9t39wh_d0a0");
      Style style = new StyleImpl();
