...
public final class ComponentRefExpr__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x54f2a59b97bb4c09L, 0xaf92928ebf9c5966L, 0x4370c1b32a2f2b3dL, "com.mbeddr.ext.compositecomponents.structure.ComponentRefExpr");
  ...
  /*package*/ static String renderReadable_id1VQvajLb13M(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.instance$Oefo), PROPS.name$MnvL) + "." + SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.providedPort$C8zD), PROPS.name$MnvL);
  }

  /*package*/ ComponentRefExpr__BehaviorDescriptor() {
  }
