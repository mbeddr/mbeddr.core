...
public final class CompositeComponent__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> resolveEffectiveRunnableForOperation_idpTHqv6LhL9 = new SMethodBuilder<>(SNode.class).name("resolveEffectiveRunnableForOperation").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(466603768608529481L).languageId(0x97fc7bd73b1f5f40L, 0x97d2424451db4e2eL).build2(SMethodBuilder.createJavaParameter(SNode.class, "port"), SMethodBuilder.createJavaParameter(SNode.class, "op"));
  public static final SMethod<Boolean> isAbstract_id3PT6Z48L3oi = new SMethodBuilder<>(Boolean.TYPE).name("isAbstract").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4429602430543738386L).languageId(0x97fc7bd73b1f5f40L, 0x97d2424451db4e2eL).build2();
  public static final SMethod<SNode> innerInstanceConfig_id6JVEnxIjbYq = new SMethodBuilder<>(SNode.class).name("innerInstanceConfig").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7780999115924357018L).languageId(0xaf92928ebf9c5966L, 0x54f2a59b97bb4c09L).build2();
  public static final SMethod<Iterable<SNode>> delegatingConnectors_id4FYctDz5Kra = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("delegatingConnectors").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5403811416926258890L).languageId(0xaf92928ebf9c5966L, 0x54f2a59b97bb4c09L).build2();
  public static final SMethod<Iterable<SNode>> allDelegatedProvidedPorts_id4FYctDz4gVr = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("allDelegatedProvidedPorts").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5403811416925867739L).languageId(0xaf92928ebf9c5966L, 0x54f2a59b97bb4c09L).build2();
  public static final SMethod<Iterable<SNode>> allDelegatedRequiredPorts_id4FYctDz4pxF = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("allDelegatedRequiredPorts").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5403811416925902955L).languageId(0xaf92928ebf9c5966L, 0x54f2a59b97bb4c09L).build2();
  public static final SMethod<Iterable<SNode>> allNonDelegatedProvidedPorts_id4FYctDz4zDx = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("allNonDelegatedProvidedPorts").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5403811416925944417L).languageId(0xaf92928ebf9c5966L, 0x54f2a59b97bb4c09L).build2();
  public static final SMethod<Iterable<SNode>> allNonDelegatedRequiredPorts_id4FYctDz4QOB = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("allNonDelegatedRequiredPorts").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5403811416926022951L).languageId(0xaf92928ebf9c5966L, 0x54f2a59b97bb4c09L).build2();
  public static final SMethod<String> generatedInstanceConfigFunctionName_id6JVEnxIjv5t = new SMethodBuilder<>(String.class).name("generatedInstanceConfigFunctionName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7780999115924435293L).languageId(0xaf92928ebf9c5966L, 0x54f2a59b97bb4c09L).build2();
  public static final SMethod<Boolean> isDelegated_id3_MZZHrtYKG = new SMethodBuilder<>(Boolean.TYPE).name("isDelegated").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4139652462543367212L).languageId(0xaf92928ebf9c5966L, 0x54f2a59b97bb4c09L).build2(SMethodBuilder.createJavaParameter(SNode.class, "p"));
  public static final SMethod<SNode> getDelegatingConnector_id3_MZZHrtYP0 = new SMethodBuilder<>(SNode.class).name("getDelegatingConnector").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4139652462543367488L).languageId(0xaf92928ebf9c5966L, 0x54f2a59b97bb4c09L).build2(SMethodBuilder.createJavaParameter(SNode.class, "p"));
  public static final SMethod<Boolean> translatesIntoAtomicComponent_id3_MZZHrtZ3j = new SMethodBuilder<>(Boolean.TYPE).name("translatesIntoAtomicComponent").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4139652462543368403L).languageId(0xaf92928ebf9c5966L, 0x54f2a59b97bb4c09L).build2();
  public static final SMethod<String> shadowComponentName_id5vJvKD7x8Ka = new SMethodBuilder<>(String.class).name("shadowComponentName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6336422882859846666L).languageId(0xaf92928ebf9c5966L, 0x54f2a59b97bb4c09L).build2();
  public static final SMethod<SNode> createShadowComponent_id5vJvKD7x8K0 = new SMethodBuilder<>(SNode.class).name("createShadowComponent").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6336422882859846656L).languageId(0xaf92928ebf9c5966L, 0x54f2a59b97bb4c09L).build2();
  public static final SMethod<SNode> findShadowComponent_id5vJvKD7x8Kk = new SMethodBuilder<>(SNode.class).name("findShadowComponent").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6336422882859846676L).languageId(0xaf92928ebf9c5966L, 0x54f2a59b97bb4c09L).build2();
  public static final SMethod<SNode> createShadowInstance_id5vJvKD7xN05 = new SMethodBuilder<>(SNode.class).name("createShadowInstance").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6336422882860019717L).languageId(0xaf92928ebf9c5966L, 0x54f2a59b97bb4c09L).build2();
  public static final SMethod<SNode> findShadowInstance_id5vJvKD7xN3Q = new SMethodBuilder<>(SNode.class).name("findShadowInstance").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6336422882860019958L).languageId(0xaf92928ebf9c5966L, 0x54f2a59b97bb4c09L).build2();
  public static final SMethod<String> shadowInstanceName_id5vJvKD7xPJg = new SMethodBuilder<>(String.class).name("shadowInstanceName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6336422882860030928L).languageId(0xaf92928ebf9c5966L, 0x54f2a59b97bb4c09L).build2();
  public static final SMethod<Boolean> isDelegated_id5vJvKD7x94j = new SMethodBuilder<>(Boolean.TYPE).name("isDelegated").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6336422882859847955L).languageId(0xaf92928ebf9c5966L, 0x54f2a59b97bb4c09L).build2(SMethodBuilder.createJavaParameter(SNode.class, "port"));
  public static final SMethod<Iterable<Tuples._2<SNode, SNode>>> delegationTarget_id5vJvKD7x92J = new SMethodBuilder<>((Class<Iterable<Tuples._2<SNode, SNode>>>) ((Class) Object.class)).name("delegationTarget").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6336422882859847855L).languageId(0xaf92928ebf9c5966L, 0x54f2a59b97bb4c09L).build2(SMethodBuilder.createJavaParameter(SNode.class, "port"));
