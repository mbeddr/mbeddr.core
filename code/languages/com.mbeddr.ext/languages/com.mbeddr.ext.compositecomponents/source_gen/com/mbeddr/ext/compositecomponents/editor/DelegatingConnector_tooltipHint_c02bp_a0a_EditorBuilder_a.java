...
/*package*/ class DelegatingConnector_tooltipHint_c02bp_a0a_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DelegatingConnector_tooltipHint_c02bp_a0a_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_sa0iyv_a");
  ...
  private EditorCell createQueryList_0(final EditorContext editorContext, final SNode node) {
    ...
    return QueryListContext.computeWithContext(new QueryListContext(node), () -> {
      QueryListHandler handler = new QueryListHandler_sa0iyv_a0(editorContext, node);
      ...
      style.set(StyleAttributes.FONT_SIZE, _StyleParameter_QueryFunction_sa0iyv_a1a0());
  ...
  private static class QueryListHandler_sa0iyv_a0 extends QueryListHandler {
    private SNode myNode;
    public QueryListHandler_sa0iyv_a0(EditorContext context, SNode ownerNode) {
    ...
    private Object executeQuery(final SNode node, final EditorContext editorContext) {
      return SLinkOperations.getTarget(SLinkOperations.getTarget(myNode, LINKS.outsidePort$z5z3), LINKS.intf$QYND);
    }
    @Override
  ...
  private int _StyleParameter_QueryFunction_sa0iyv_a1a0() {
