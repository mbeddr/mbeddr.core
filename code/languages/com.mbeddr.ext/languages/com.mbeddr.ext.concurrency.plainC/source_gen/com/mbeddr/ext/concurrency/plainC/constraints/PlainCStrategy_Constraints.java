...
public class PlainCStrategy_Constraints extends BaseConstraintsDescriptor {
  public PlainCStrategy_Constraints() {
    super(CONCEPTS.PlainCStrategy$Ag);
  }

  @Override
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(LINKS.timeSource$ql2o, this, true, false) {
      @Nullable
      @Override
