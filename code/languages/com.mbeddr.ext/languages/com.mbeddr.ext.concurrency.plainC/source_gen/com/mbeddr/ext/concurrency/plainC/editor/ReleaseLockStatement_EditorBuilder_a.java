...
/*package*/ class ReleaseLockStatement_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ReleaseLockStatement_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_o0npqv_a");
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "release");
    editorCell.setCellId("Constant_o0npqv_a0");
  ...
  private EditorCell createBooleanText_0(EditorContext editorContext, SNode node) {
    SProperty property = PROPS.readLock$PxfW;
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_o0npqv_c0");
    Style style = new StyleImpl();
    new KWStyleClass(this).apply(style, editorCell);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.lock$vg56;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.lock$vg56);
    ...
    provider.setNoTargetText("<no lock>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.lock$vg56);
    }
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_o0npqv_e0");
    Style style = new StyleImpl();
