...
/*package*/ class AcquireLockStatement_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public AcquireLockStatement_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_yu5l1b_a");
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "acquire");
    editorCell.setCellId("Constant_yu5l1b_a0");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_yu5l1b_c0");
    Style style = new StyleImpl();
    new KWStyleClass(this).apply(style, editorCell);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.lock$LfqE;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.lock$LfqE);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.lock$LfqE);
    }
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_yu5l1b_e0");
    Style style = new StyleImpl();
