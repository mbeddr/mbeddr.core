...
<model ref="r:cd386a44-1e2c-4ee8-bcf0-82b78af127fd(com.mbeddr.ext.concurrency.plainC.actions)">
  ...
  <imports>
    ...
    <import index="hx13" ref="r:80c23f30-b611-47e7-a72e-676515328dc5(com.mbeddr.ext.concurrency.plainC.editor)" />
  ...
  <node concept="3FK_9_" id="2SCoDaNmdta">
    ...
    <node concept="1X3_iC" id="2mvFNoTus5z" role="lGtFl">
      ...
      <node concept="3FOIzC" id="2SCoDaNmdwl" role="8Wnug">
        ...
        <node concept="zlxcR" id="2SCoDaNmi9J" role="tZc4B">
                ...
                <node concept="1Wc70l" id="2SCoDaNnyhw" role="3clFbG">
                  ...
                  <node concept="2OqwBi" id="2SCoDaNmjtZ" role="3uHU7B">
                    ...
                    <node concept="2Zo12i" id="2SCoDaNmjHa" role="2OqNvi">
                      <node concept="chp4Y" id="2SCoDaNmjNc" role="2Zo12j">
                        <ref role="cht4Q" to="izv8:2SCoDaNmbIv" resolve="IGeneratorOnlyConcept" />
                      </node>
                    </node>
                  </node>
                </node>
          ...
          <node concept="xAzKH" id="2mvFNoTus5y" role="lGtFl">
            <ref role="xAzKI" to="hx13:2mvFNoTus5v" resolve="RemoveGeneratorOnlyConcepts_Contribution" />
          </node>
        </node>
        <node concept="xBawi" id="2mvFNoTus5x" role="lGtFl">
          <ref role="xBaxx" to="hx13:2mvFNoTus5v" resolve="RemoveGeneratorOnlyConcepts_Contribution" />
        </node>
      </node>
    </node>
  </node>
