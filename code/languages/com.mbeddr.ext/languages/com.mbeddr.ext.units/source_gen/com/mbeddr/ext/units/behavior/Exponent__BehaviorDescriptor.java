...
public final class Exponent__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> negate_id3j3yk3gDZSH = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("negate").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3802033421902413357L).languageId(0xb9b011884b2ff1c8L, 0xd04a6cc773e4069L).build2();
