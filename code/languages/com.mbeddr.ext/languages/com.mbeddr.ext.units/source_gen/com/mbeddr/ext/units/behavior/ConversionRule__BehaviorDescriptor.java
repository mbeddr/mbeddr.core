...
public final class ConversionRule__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> genName_id1wGuEUvX$YR = new SMethodBuilder<>(String.class).name("genName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1741902046312157111L).languageId(0xb9b011884b2ff1c8L, 0xd04a6cc773e4069L).build2();
