...
public class GenericUnitDeclarationAttribute_Delete {
  ...
  /*package*/ static AbstractCellAction createAction_BACKSPACE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        for (SNode unit : ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.units$UfaK))) {
          SearchResults results = FindUtils.getSearchResults(new EmptyProgressMonitor(), unit, null, "jetbrains.mps.lang.structure.findUsages.NodeUsages_Finder");
          for (Object usage : results.getResultObjects()) {
            SNode reference = ((SNode) usage);
            if (SNodeOperations.isInstanceOf(reference, CONCEPTS.UnitReference$hr)) {
              SNodeOperations.deleteNode(reference);
            }
          }
        }
