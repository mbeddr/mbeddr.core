...
public class Expression_PrimitiveType_SpecifyUnit_Contribution extends TransformationMenuBase {
  ...
  public List<TransformationMenuItem> createMenuItems(@NotNull TransformationMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default transformation menu for " + "Expression", new SNodePointer("r:5b3a7fb6-3625-421c-a433-fc84488109d4(com.mbeddr.ext.units.editor)", "3691316882320236799")));
    try {
    ...
    private class TMP_Param_kyrnr_a0a extends ParameterizedMenuPart<SNode, TransformationMenuItem, TransformationMenuContext> {
      ...
      private class TMP_Action_kyrnr_a0a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
        ...
        protected TransformationMenuItem createItem(TransformationMenuContext context) {
          ...
          context.getEditorMenuTrace().pushTraceInfo();
          try {
            context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase(description, new SNodePointer("r:5b3a7fb6-3625-421c-a433-fc84488109d4(com.mbeddr.ext.units.editor)", "3691316882320236870")));
