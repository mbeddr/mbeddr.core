...
public final class WriteHandler__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xbb0ad88b63cd45fdL, 0xae278662d274cf3cL, 0x1c55392e757b8a50L, "com.mbeddr.ext.serialization.structure.WriteHandler");


  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList();

  private static void ___init___(@NotNull SNode __thisNode__) {
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.arguments$6da0)).addElement(createArgument_jjm6dv_a0a0a0());
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.arguments$6da0)).addElement(createArgument_jjm6dv_a0a1a0());
    SLinkOperations.setTarget(__thisNode__, LINKS.type$sXU3, createSizeT_jjm6dv_a0c0a());
  }


  /*package*/ WriteHandler__BehaviorDescriptor() {
  }
  ...
  private static SNode createArgument_jjm6dv_a0a0a0() {
    ...
    n0.setProperty(PROPS.name$MnvL, "data");
    {
      ...
      {
        SNodeBuilder n2 = n1.forChild(LINKS.baseType$zMGV).init(CONCEPTS.VoidType$GT);
        n2.setProperty(PROPS.const$VWr7, "" + (true));
      }
    }
    return n0.getResult();
  }
  private static SNode createArgument_jjm6dv_a0a1a0() {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.Argument$9m);
    n0.setProperty(PROPS.name$MnvL, "size");
    n0.forChild(LINKS.type$sXU3).init(CONCEPTS.SizeT$IZ);
    return n0.getResult();
  }
  private static SNode createSizeT_jjm6dv_a0c0a() {
