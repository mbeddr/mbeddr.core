...
public final class ReadInt32__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xbb0ad88b63cd45fdL, 0xae278662d274cf3cL, 0x297dbd78f162455eL, "com.mbeddr.ext.serialization.structure.ReadInt32");
  ...
  /*package*/ static SNode expectedExprType_id7op4RkOvNOW(@NotNull SNode __thisNode__) {
    return createPointerType_hr5nos_a0a0();
  }

  /*package*/ ReadInt32__BehaviorDescriptor() {
  }
  ...
  private static SNode createPointerType_hr5nos_a0a0() {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.PointerType$HX);
    n0.forChild(LINKS.baseType$zMGV).init(CONCEPTS.Int32tType$Sy);
    return n0.getResult();
  }
