...
public final class ReadBool__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xbb0ad88b63cd45fdL, 0xae278662d274cf3cL, 0x297dbd78f162455aL, "com.mbeddr.ext.serialization.structure.ReadBool");
  ...
  /*package*/ static SNode expectedExprType_id7op4RkOvNOW(@NotNull SNode __thisNode__) {
    return createPointerType_xflcso_a0a0();
  }

  /*package*/ ReadBool__BehaviorDescriptor() {
  }
  ...
  private static SNode createPointerType_xflcso_a0a0() {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.PointerType$HX);
    n0.forChild(LINKS.baseType$zMGV).init(CONCEPTS.BooleanType$fL);
    return n0.getResult();
  }
