...
public final class ReadInt64__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static SNode expectedExprType_id7op4RkOvNOW(@NotNull SNode __thisNode__) {
    return createPointerType_5fxd2l_a0a0();
  }

  /*package*/ ReadInt64__BehaviorDescriptor() {
  }
  ...
  private static SNode createPointerType_5fxd2l_a0a0() {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.PointerType$HX);
    n0.forChild(LINKS.baseType$zMGV).init(CONCEPTS.Int64tType$UX);
    return n0.getResult();
  }
