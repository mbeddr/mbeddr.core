...
public final class ReadInt8__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xbb0ad88b63cd45fdL, 0xae278662d274cf3cL, 0x297dbd78f1624560L, "com.mbeddr.ext.serialization.structure.ReadInt8");
  ...
  /*package*/ static SNode expectedExprType_id7op4RkOvNOW(@NotNull SNode __thisNode__) {
    return createPointerType_pl3mc9_a0a0();
  }

  /*package*/ ReadInt8__BehaviorDescriptor() {
  }
  ...
  private static SNode createPointerType_pl3mc9_a0a0() {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.PointerType$HX);
    n0.forChild(LINKS.baseType$zMGV).init(CONCEPTS.Int8tType$tq);
    return n0.getResult();
  }
