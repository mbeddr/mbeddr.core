...
public final class ReadFloat__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xbb0ad88b63cd45fdL, 0xae278662d274cf3cL, 0x297dbd78f162455cL, "com.mbeddr.ext.serialization.structure.ReadFloat");
  ...
  /*package*/ static SNode expectedExprType_id7op4RkOvNOW(@NotNull SNode __thisNode__) {
    return createPointerType_kdqb6t_a0a0();
  }

  /*package*/ ReadFloat__BehaviorDescriptor() {
  }
  ...
  private static SNode createPointerType_kdqb6t_a0a0() {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.PointerType$HX);
    n0.forChild(LINKS.baseType$zMGV).init(CONCEPTS.FloatType$6s);
    return n0.getResult();
  }
