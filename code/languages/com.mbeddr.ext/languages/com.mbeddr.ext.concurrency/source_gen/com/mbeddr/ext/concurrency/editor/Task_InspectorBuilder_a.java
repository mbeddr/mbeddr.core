...
/*package*/ class Task_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createQueryList_0(final EditorContext editorContext, final SNode node) {
    ...
    return QueryListContext.computeWithContext(new QueryListContext(node), () -> {
      QueryListHandler handler = new QueryListHandler_jn8cz7_c1a(editorContext, node);
  ...
  private static class QueryListHandler_jn8cz7_c1a extends QueryListHandler {
    private SNode myNode;
    public QueryListHandler_jn8cz7_c1a(EditorContext context, SNode ownerNode) {
  ...
  private EditorCell createQueryList_2(final EditorContext editorContext, final SNode node) {
    ...
    return QueryListContext.computeWithContext(new QueryListContext(node), () -> {
      QueryListHandler handler = new QueryListHandler_jn8cz7_c2a(editorContext, node);
      EditorCell_QueryList editorCell = handler.createCells(new CellLayout_Vertical());
      editorCell.setTargeConcept(CONCEPTS.GlobalVariableDeclaration$TW);
      editorCell.setOwner(SNodeOperations.getConcept(node));
  ...
  private static class QueryListHandler_jn8cz7_c2a extends QueryListHandler {
    private SNode myNode;
    public QueryListHandler_jn8cz7_c2a(EditorContext context, SNode ownerNode) {
      super(context, ownerNode, true);
      myNode = ownerNode;
    }
    @NotNull
  ...
  private EditorCell createQueryList_4(final EditorContext editorContext, final SNode node) {
    ...
    return QueryListContext.computeWithContext(new QueryListContext(node), () -> {
      QueryListHandler handler = new QueryListHandler_jn8cz7_c3a(editorContext, node);
      EditorCell_QueryList editorCell = handler.createCells(new CellLayout_Vertical());
  ...
  private static class QueryListHandler_jn8cz7_c3a extends QueryListHandler {
    private SNode myNode;
    public QueryListHandler_jn8cz7_c3a(EditorContext context, SNode ownerNode) {
      super(context, ownerNode, true);
      myNode = ownerNode;
    }
    @NotNull
  ...
  private EditorCell createQueryList_6(final EditorContext editorContext, final SNode node) {
    ...
    return QueryListContext.computeWithContext(new QueryListContext(node), () -> {
      QueryListHandler handler = new QueryListHandler_jn8cz7_c4a(editorContext, node);
      EditorCell_QueryList editorCell = handler.createCells(new CellLayout_Vertical());
      editorCell.setTargeConcept(CONCEPTS.EventDeclaration$kr);
      editorCell.setOwner(SNodeOperations.getConcept(node));
  ...
  private static class QueryListHandler_jn8cz7_c4a extends QueryListHandler {
    private SNode myNode;
    public QueryListHandler_jn8cz7_c4a(EditorContext context, SNode ownerNode) {
      super(context, ownerNode, true);
      myNode = ownerNode;
    }
    @NotNull
