...
public final class ConcurrencyGenerationStrategy__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> validateSchedules_id6bs538muOve = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("validateSchedules").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7123590915951380430L).languageId(0x8df7e6fa93b9b711L, 0xb879012d402b40e0L).build2(SMethodBuilder.createJavaParameter((Class<Iterable<SNode>>) ((Class) Object.class), ""));
