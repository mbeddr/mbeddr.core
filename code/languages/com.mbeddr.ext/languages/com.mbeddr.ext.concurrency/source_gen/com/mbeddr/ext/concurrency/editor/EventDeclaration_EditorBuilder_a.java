...
/*package*/ class EventDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public EventDeclaration_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private boolean nodeCondition_a2klxi_a0a() {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_a2klxi_b0");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_a2klxi_d0");
    Style style = new StyleImpl();
