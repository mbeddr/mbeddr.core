...
<model ref="r:32cdfaee-ff0b-4e39-997a-e5ec22a48b4c(test.ex.ext.concurrency.c.singleTask)">
  ...
  <node concept="N3F5e" id="73JrkgytXsk">
    ...
    <node concept="6qQRg" id="12_KeTzYMQ0" role="N3F5h">
      ...
      <node concept="scIFY" id="2ZMK30Sn_ip" role="6qQK8">
        <node concept="3O_q_g" id="2ZMK30Sn_MO" role="scD4D">
