...
<language namespace="test.com.mbeddr.mpsutil.iconchar" uuid="6439a9c3-d5bd-4cb1-b4a1-24ee935afcf9" version="0">
  <models>
  ...
  <generators>
    <generator name="" generatorUID="test.com.mbeddr.mpsutil.iconchar#8866176685649024459" uuid="dc782681-8ee9-440b-9a63-347af0b76d56">
      <models>
        <modelRoot contentPath="${module}" type="default">
