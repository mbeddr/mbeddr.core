...
<language namespace="test.ts.mpsutil.multilingual.editor.sandbox" uuid="0eba8d68-ca0c-4113-a9e6-19b359352ecf" version="0">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator generatorUID="test.ts.mpsutil.multilingual.editor.sandbox#4912572611775887657" uuid="0fbcb2bc-923f-4328-beef-a6eb2b652fec">
      <models>
        <modelRoot contentPath="${module}" type="default">
