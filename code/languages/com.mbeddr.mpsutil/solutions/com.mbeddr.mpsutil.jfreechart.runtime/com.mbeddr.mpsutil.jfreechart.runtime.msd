...
<solution name="com.mbeddr.mpsutil.jfreechart.runtime" uuid="7fe13e34-8620-4d5d-92c7-df091b0ed628" moduleVersion="0" pluginKind="PLUGIN_OTHER" compileInMPS="true">
  <models>
  ...
  <stubModelEntries>
    <stubModelEntry path="${module}/lib/jfreechart-1.0.19.jar" />
    <stubModelEntry path="${module}/lib/jcommon-1.0.23.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
