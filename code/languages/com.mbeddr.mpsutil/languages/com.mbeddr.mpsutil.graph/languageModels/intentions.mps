...
<model modelUID="r:00f8c71c-08af-4a7e-bf81-6c0b4b9a6c80(com.mbeddr.mpsutil.graph.intentions)">
  ...
  <roots>
    ...
    <node type="tp3j.IntentionDeclaration" typeId="tp3j.1192794744107" id="2231107713271241032">
      <property name="virtualPackage" nameId="tpck.1193676396447" value="node" />
      <property name="name" nameId="tpck.1169194664001" value="addStyle" />
      <link role="forConcept" roleId="tp3j.2522969319638198290" targetNodeId="fu4.5104882350373546414" resolveInfo="Node" />
    </node>
  </roots>
  ...
  <root id="2231107713271241032">
    <node role="descriptionFunction" roleId="tp3j.2522969319638093993" type="tp3j.DescriptionBlock" typeId="tp3j.1192794782375" id="2231107713271241033">
      <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="2231107713271241034">
        <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="2231107713271241037">
          <node role="expression" roleId="tpee.1068580123156" type="tpee.StringLiteral" typeId="tpee.1070475926800" id="2231107713271241038">
            <property name="value" nameId="tpee.1070475926801" value="Add Style" />
          </node>
        </node>
      </node>
    </node>
    <node role="executeFunction" roleId="tp3j.2522969319638198291" type="tp3j.ExecuteBlock" typeId="tp3j.1192795911897" id="2231107713271241035">
      <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="2231107713271241036">
        <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="2231107713271241040">
          <node role="expression" roleId="tpee.1068580123156" type="tpee.DotExpression" typeId="tpee.1197027756228" id="2231107713271241908">
            <node role="operand" roleId="tpee.1197027771414" type="tpee.DotExpression" typeId="tpee.1197027756228" id="2231107713271241042">
              <node role="operand" roleId="tpee.1197027771414" type="tp3j.ConceptFunctionParameter_node" typeId="tp3j.1192796902958" id="2231107713271241041" />
              <node role="operation" roleId="tpee.1197027833540" type="tp25.SLinkListAccess" typeId="tp25.1138056282393" id="2231107713271241907">
                <link role="link" roleId="tp25.1138056546658" targetNodeId="fu4.2231107713271241039" />
              </node>
            </node>
            <node role="operation" roleId="tpee.1197027833540" type="tp25.LinkList_AddNewChildOperation" typeId="tp25.1139184414036" id="2231107713271241912" />
          </node>
        </node>
      </node>
    </node>
