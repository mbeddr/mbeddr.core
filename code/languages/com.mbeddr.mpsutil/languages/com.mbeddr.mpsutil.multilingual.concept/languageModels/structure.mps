...
<model modelUID="r:d26f1060-b333-4b75-ae0e-82ef2c6fdec3(com.mbeddr.mpsutil.multilingual.concept.structure)" version="1">
  ...
  <import index="phyx" modelUID="r:d26f1060-b333-4b75-ae0e-82ef2c6fdec3(com.mbeddr.mpsutil.multilingual.concept.structure)" version="1" implicit="yes" />
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="2510545900187060757" nodeInfo="ig">
    ...
    <node role="linkDeclaration" roleId="tpce.1071489727083" type="tpce.LinkDeclaration" typeId="tpce.1071489288298" id="2510545900187060758" nodeInfo="ig">
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="2510545900187060760" nodeInfo="ig">
    ...
    <node role="linkDeclaration" roleId="tpce.1071489727083" type="tpce.LinkDeclaration" typeId="tpce.1071489288298" id="2510545900187060764" nodeInfo="ig">
      <property name="metaClass" nameId="tpce.1071599937831" value="reference" />
      <property name="role" nameId="tpce.1071599776563" value="language" />
      <link role="target" roleId="tpce.1071599976176" targetNodeId="sxyo.568377005202317228" resolveInfo="Language" />
    </node>
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="2510545900187060782" nodeInfo="ig">
    ...
    <link role="extends" roleId="tpce.1071489389519" targetNodeId="tpck.1133920641626" resolveInfo="BaseConcept" />
    <node role="propertyDeclaration" roleId="tpce.1071489727084" type="tpce.PropertyDeclaration" typeId="tpce.1071489288299" id="2510545900187060783" nodeInfo="ig">
      <property name="name" nameId="tpck.1169194664001" value="editName" />
      <link role="dataType" roleId="tpce.1082985295845" targetNodeId="tpck.1082983657063" resolveInfo="boolean" />
    </node>
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="2510545900187060787" nodeInfo="ig">
    ...
    <link role="extends" roleId="tpce.1071489389519" targetNodeId="tpck.1133920641626" resolveInfo="BaseConcept" />
    <node role="propertyDeclaration" roleId="tpce.1071489727084" type="tpce.PropertyDeclaration" typeId="tpce.1071489288299" id="2510545900187060788" nodeInfo="ig">
      <property name="name" nameId="tpck.1169194664001" value="editName" />
      <link role="dataType" roleId="tpce.1082985295845" targetNodeId="tpck.1082983657063" resolveInfo="boolean" />
    </node>
