...
<model ref="r:7c206b56-c799-4eec-b921-4b48a2ae02b0(com.mbeddr.mpsutil.preferenceform.typesystem)">
  ...
  <node concept="1YbPZF" id="86yKXFVlf1">
    <property role="TrG5h" value="typeof_GetPreferenceFormInProjectOperation" />
    <property role="3GE5qa" value="getter" />
    <node concept="3clFbS" id="86yKXFVlkx" role="18ibNy">
      <node concept="3clFbH" id="86yKXFWZ2t" role="3cqZAp" />
      <node concept="1Z5TYs" id="86yKXFVuDZ" role="3cqZAp">
        <node concept="mw_s8" id="86yKXFWZtq" role="1ZfhKB">
          <node concept="2OqwBi" id="86yKXFXJ_4" role="mwGJk">
            <node concept="2OqwBi" id="86yKXFXJaV" role="2Oq$k0">
              <node concept="1YBJjd" id="86yKXFXJ8H" role="2Oq$k0">
                <ref role="1YBMHb" node="86yKXFVlkz" resolve="getPreferenceFormInProjectOperation" />
              </node>
              <node concept="3TrEf2" id="86yKXFXJmD" role="2OqNvi">
                <ref role="3Tt5mk" to="3iid:86yKXFVl2p" />
              </node>
            </node>
            <node concept="2qgKlT" id="86yKXFXJNq" role="2OqNvi">
              <ref role="37wK5l" to="tp4h:hEwJimy" resolve="createType" />
            </node>
          </node>
        </node>
        <node concept="mw_s8" id="86yKXFVuE2" role="1ZfhK$">
          <node concept="1Z2H0r" id="86yKXFVu_3" role="mwGJk">
            <node concept="1YBJjd" id="86yKXFVu_E" role="1Z2MuG">
              <ref role="1YBMHb" node="86yKXFVlkz" resolve="getPreferenceFormInProjectOperation" />
            </node>
          </node>
        </node>
    ...
    <node concept="1YaCAy" id="86yKXFVlkz" role="1YuTPh">
      <property role="TrG5h" value="getPreferenceFormInProjectOperation" />
      <ref role="1YaFvo" to="3iid:86yKXFVk5m" resolve="GetPreferenceFormInProjectOperation" />
    </node>
  </node>
