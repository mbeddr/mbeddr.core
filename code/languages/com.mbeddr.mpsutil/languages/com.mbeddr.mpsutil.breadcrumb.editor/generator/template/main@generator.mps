    ...
    <node concept="312cEu" id="3JErwPFIF3t" role="13RCb5">
      ...
      <node concept="3clFb_" id="3JErwPFIF3y" role="jymVt">
        ...
        <node concept="3clFbS" id="3JErwPFIF3_" role="3clF47">
          ...
          <node concept="3clFbH" id="3BkstRjCnXv" role="3cqZAp" />
          <node concept="3clFbJ" id="3BkstRjCyBV" role="3cqZAp">
            <node concept="3clFbS" id="3BkstRjCyC5" role="3clFbx">
              <node concept="3cpWs6" id="3BkstRjC$b0" role="3cqZAp">
                <node concept="37vLTw" id="3BkstRjC$fX" role="3cqZAk">
                  <ref role="3cqZAo" node="3JErwPFIF3B" resolve="wrapped" />
                </node>
              </node>
            </node>
            <node concept="3fqX7Q" id="3BkstRjCxDU" role="3clFbw">
              <node concept="2OqwBi" id="3BkstRjCxDW" role="3fr31v">
                <node concept="37vLTw" id="3BkstRjCxDX" role="2Oq$k0">
                  <ref role="3cqZAo" node="3JErwPFIF46" resolve="editorComponent" />
                </node>
                <node concept="1PvZjq" id="3BkstRjCxDY" role="2OqNvi">
