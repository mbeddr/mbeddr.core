...
/*package*/ class ConditionalAlternative_tooltipHint_dfexte_a1a_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createQueryList_0(final EditorContext editorContext, final SNode node) {
    ...
    return QueryListContext.computeWithContext(new QueryListContext(node), () -> {
      QueryListHandler handler = new QueryListHandler_kincxf_b0a0(editorContext, node);
  ...
  private static class QueryListHandler_kincxf_b0a0 extends QueryListHandler {
    private SNode myNode;
    public QueryListHandler_kincxf_b0a0(EditorContext context, SNode ownerNode) {
  ...
  private EditorCell createQueryList_2(final EditorContext editorContext, final SNode node) {
    ...
    return QueryListContext.computeWithContext(new QueryListContext(node), () -> {
      QueryListHandler handler = new QueryListHandler_kincxf_b1a0(editorContext, node);
      EditorCell_QueryList editorCell = handler.createCells(new CellLayout_Horizontal());
  ...
  private static class QueryListHandler_kincxf_b1a0 extends QueryListHandler {
    private SNode myNode;
    public QueryListHandler_kincxf_b1a0(EditorContext context, SNode ownerNode) {
      super(context, ownerNode, true);
      myNode = ownerNode;
    }
    @NotNull
