...
/*package*/ class PresenceCondition_tooltipHint_6yzsc6_a0b0_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public PresenceCondition_tooltipHint_6yzsc6_a0b0_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_sfg0bt_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    try {
      getCellFactory().pushCellContext();
      getCellFactory().removeCellContextHints(new String[]{"com.mbeddr.cc.var.annotations.editor.GeneratedHints.tooltipHint_6yzsc6_a0b0"});
      if (nodeCondition_sfg0bt_a0a()) {
  ...
  private boolean nodeCondition_sfg0bt_a0a() {
    return VarEditorModeHelper.modeIsConcise();
  }
  private EditorCell createCollection_1() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_sfg0bt_a0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_sfg0bt_a0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createQueryList_0() {

    QueryListHandler handler = new QueryListHandler_sfg0bt_b0a(getEditorContext(), getNode(), true);
    ...
    editorCell.setCellId("QueryList_sfg0bt_b0a");
  ...
  private static class QueryListHandler_sfg0bt_b0a extends QueryListHandler {
    /**
     * allows node access in the query with ConceptFunctionParameter_node
     */
    private SNode myNode;
    public QueryListHandler_sfg0bt_b0a(EditorContext context, SNode ownerNode, boolean readOnly) {
    ...
    private Object executeQuery(final SNode node, final EditorContext editorContext) {
      return SLinkOperations.getTarget(SLinkOperations.getTarget(myNode, LINKS.condition$Jt8t), LINKS.expr$Myds);
    }
    @Override
    ...
    protected EditorCell createNodeCellNotNull(final EditorContext context, @NotNull final SNode node) {
      ...
      try {
        ...
        cell = createCellDuplicatesSafe(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateReferencedNodeCell(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateChildNodeCell(node), node, new DummyReferenceLink("querylist6658623717389116975")));
      } finally {
        getCellFactory().popCellContext();
      }
      return cell;
