...
<model modelUID="r:2217bb25-9695-4af2-948e-8d9b31dd5a1a(com.mbeddr.cc.var.rt.structure)">
  ...
  <roots>
    ...
    <node type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="8882953773355830195">
      <property name="name" nameId="tpck.1169194664001" value="CreateRtConfigStatement" />
  ...
  <root id="8882953773355574483">
    ...
    <node role="implements" roleId="tpce.1169129564478" type="tpce.InterfaceConceptReference" typeId="tpce.1169127622168" id="8882953773355809763">
    ...
    <node role="conceptLink" roleId="tpce.1105736949336" type="tpce.ReferenceConceptLink" typeId="tpce.1105736778597" id="8882953773355809765">
      <link role="conceptLinkDeclaration" roleId="tpce.1105736734721" targetNodeId="vs0r.1656687801206572013" resolveInfo="configItem" />
      <link role="target" roleId="tpce.1105736807942" targetNodeId="8882953773355809617" resolveInfo="VarRTConfigItem" />
    </node>
  </root>
  ...
  <root id="8882953773355830195">
    ...
    <node role="linkDeclaration" roleId="tpce.1071489727083" type="tpce.LinkDeclaration" typeId="tpce.1071489288298" id="8882953773355830456">
      <property name="metaClass" nameId="tpce.1071599937831" value="reference" />
      <property name="role" nameId="tpce.1071599776563" value="rtFeatureModel" />
      <property name="sourceCardinality" nameId="tpce.1071599893252" value="1" />
      <link role="target" roleId="tpce.1071599976176" targetNodeId="8882953773355574483" resolveInfo="RtFeatureModel" />
    </node>
    <node role="linkDeclaration" roleId="tpce.1071489727083" type="tpce.LinkDeclaration" typeId="tpce.1071489288298" id="8882953773355830282">
      <property name="metaClass" nameId="tpce.1071599937831" value="reference" />
    ...
    <node role="conceptProperty" roleId="tpce.1105725339613" type="tpce.StringConceptProperty" typeId="tpce.1105725638761" id="8882953773355830283">
      <property name="value" nameId="tpce.1105725733873" value="createconfig" />
      <link role="conceptPropertyDeclaration" roleId="tpce.1105725439818" targetNodeId="tpck.1137473891462" resolveInfo="alias" />
    </node>
  </root>
</model>
