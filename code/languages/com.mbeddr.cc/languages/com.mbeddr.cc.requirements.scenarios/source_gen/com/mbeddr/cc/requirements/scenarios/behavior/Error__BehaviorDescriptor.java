...
public final class Error__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xd6714220402d48cbL, 0xa4a288223c6257f6L, 0x70aec3f2d3fdee52L, "com.mbeddr.cc.requirements.scenarios.structure.Error");
  ...
  /*package*/ static void visualize_id6xkj9mMr7e(@NotNull SNode __thisNode__, VisGraph g, String category) {
    if ("scenario".equals(category)) {
      g.add("hnote over " + SPropertyOperations.getString(ICallContext__BehaviorDescriptor.getContextParticipant_id4YQM_89uRDd.invoke(SNodeOperations.getNodeAncestor(__thisNode__, CONCEPTS.ICallContext$Wj, false, false)), PROPS.name$MnvL) + " #FFAAAA: " + SPropertyOperations.getString(__thisNode__, PROPS.message$fSBQ));
    }
  }

  /*package*/ Error__BehaviorDescriptor() {
  }
