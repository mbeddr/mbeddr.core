...
public final class Collaboration__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xd6714220402d48cbL, 0xa4a288223c6257f6L, 0x4fb6ca520978eab7L, "com.mbeddr.cc.requirements.scenarios.structure.Collaboration");
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(target_id70kXLV4LLzy);


  /*package*/ static SNode target_id70kXLV4LLzy(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.participant$tAkS);
  }

  /*package*/ Collaboration__BehaviorDescriptor() {
  }
