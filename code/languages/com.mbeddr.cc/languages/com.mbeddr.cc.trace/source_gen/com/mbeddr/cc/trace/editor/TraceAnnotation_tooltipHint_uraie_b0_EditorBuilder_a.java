...
/*package*/ class TraceAnnotation_tooltipHint_uraie_b0_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createQueryList_0(final EditorContext editorContext, final SNode node) {
    ...
    return QueryListContext.computeWithContext(new QueryListContext(node), () -> {
      QueryListHandler handler = new QueryListHandler_f4cb33_b1c0a(editorContext, node);
  ...
  private static class QueryListHandler_f4cb33_b1c0a extends QueryListHandler {
    private SNode myNode;
    public QueryListHandler_f4cb33_b1c0a(EditorContext context, SNode ownerNode) {
