...
<model modelUID="r:df3ed807-1af3-4a33-8adc-b4636cd05fb8(com.mbeddr.cc.trace.pluginSolution.plugin)">
  ...
  <root type="tp4k.ActionDeclaration" typeId="tp4k.1203071646776" id="3969129843280202135" nodeInfo="ng">
    ...
    <property name="caption" nameId="tp4k.1205250923097" value="Show Traces" />
    ...
    <node role="executeFunction" roleId="tp4k.1203083461638" type="tp4k.ExecuteBlock" typeId="tp4k.1203083511112" id="3969129843280202138" nodeInfo="nn">
      <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="3969129843280202139" nodeInfo="sn">
        <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="9051044440122581013" nodeInfo="nn">
          <node role="expression" roleId="tpee.1068580123156" type="tpee.StaticMethodCall" typeId="tpee.1081236700937" id="9051044440122581273" nodeInfo="nn">
            ...
            <node role="actualArgument" roleId="tpee.1068499141038" type="tpee.BooleanConstant" typeId="tpee.1068580123137" id="9051044440122581387" nodeInfo="nn">
    ...
    <node role="updateBlock" roleId="tp4k.1203083196627" type="tp4k.IsApplicableBlock" typeId="tp4k.1205681243813" id="3969129843280202144" nodeInfo="nn">
      <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="3969129843280202145" nodeInfo="sn">
        <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="1039011227345292669" nodeInfo="nn">
          <node role="expression" roleId="tpee.1068580123156" type="tpee.NotExpression" typeId="tpee.1081516740877" id="1039011227345292670" nodeInfo="nn">
            <node role="expression" roleId="tpee.1081516765348" type="tpee.StaticMethodCall" typeId="tpee.1081236700937" id="9051044440122573380" nodeInfo="nn">
              <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="y6af.4317007310193663856" resolveInfo="showTraces" />
              <link role="classConcept" roleId="tpee.1144433194310" targetNodeId="y6af.1039011227345284374" resolveInfo="TraceEditorModeHelper" />
            </node>
          </node>
        </node>
  ...
  <root type="tp4k.ActionDeclaration" typeId="tp4k.1203071646776" id="9051044440122583886" nodeInfo="ng">
    <property name="name" nameId="tpck.1169194664001" value="hideTraces" />
    <property name="caption" nameId="tp4k.1205250923097" value="Show Traces" />
    ...
    <node role="executeFunction" roleId="tp4k.1203083461638" type="tp4k.ExecuteBlock" typeId="tp4k.1203083511112" id="9051044440122583895" nodeInfo="nn">
      <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="9051044440122583896" nodeInfo="sn">
        <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="9051044440122583897" nodeInfo="nn">
          <node role="expression" roleId="tpee.1068580123156" type="tpee.StaticMethodCall" typeId="tpee.1081236700937" id="9051044440122583898" nodeInfo="nn">
            <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="y6af.4317007310193663863" resolveInfo="setShowTrace" />
            <link role="classConcept" roleId="tpee.1144433194310" targetNodeId="y6af.1039011227345284374" resolveInfo="TraceEditorModeHelper" />
            <node role="actualArgument" roleId="tpee.1068499141038" type="tpee.BooleanConstant" typeId="tpee.1068580123137" id="9051044440122583899" nodeInfo="nn" />
          </node>
        </node>
    ...
    <node role="updateBlock" roleId="tp4k.1203083196627" type="tp4k.IsApplicableBlock" typeId="tp4k.1205681243813" id="9051044440122583908" nodeInfo="nn">
      <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="9051044440122583909" nodeInfo="sn">
        <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="9051044440122583910" nodeInfo="nn">
          <node role="expression" roleId="tpee.1068580123156" type="tpee.StaticMethodCall" typeId="tpee.1081236700937" id="9051044440122583912" nodeInfo="nn">
            <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="y6af.4317007310193663856" resolveInfo="showTraces" />
            <link role="classConcept" roleId="tpee.1144433194310" targetNodeId="y6af.1039011227345284374" resolveInfo="TraceEditorModeHelper" />
          </node>
        </node>
  ...
  <root type="tp4k.ActionGroupDeclaration" typeId="tp4k.1203087890642" id="3969129843280035678" nodeInfo="ng">
    ...
    <node role="contents" roleId="tp4k.1207145245948" type="tp4k.ElementListContents" typeId="tp4k.1207145163717" id="3969129843280035679" nodeInfo="ng">
      <node role="reference" roleId="tp4k.1207145201301" type="tp4k.ActionInstance" typeId="tp4k.1203088046679" id="9051044440122586100" nodeInfo="ng">
        <link role="action" roleId="tp4k.1203088061055" targetNodeId="9051044440122583886" resolveInfo="hideTraces" />
      </node>
      <node role="reference" roleId="tp4k.1207145201301" type="tp4k.ActionInstance" typeId="tp4k.1203088046679" id="9051044440122586105" nodeInfo="ng">
        <link role="action" roleId="tp4k.1203088061055" targetNodeId="3969129843280202135" resolveInfo="showTraces" />
      </node>
    </node>
