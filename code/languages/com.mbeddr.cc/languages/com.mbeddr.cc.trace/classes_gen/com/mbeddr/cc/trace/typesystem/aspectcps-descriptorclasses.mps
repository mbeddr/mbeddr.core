        ...
        <node concept="3cpWs8" id="X" role="3cqZAp">
          ...
          <node concept="3cpWsn" id="11" role="3cpWs9">
            ...
            <node concept="2OqwBi" id="13" role="33vP2m">
              ...
              <node concept="3zqWPK" id="15" role="2OqNvi">
                <ref role="37wK5l" to="y6af:6pDXxhBbHL_" resolve="cannotBeUsedHereErrorMessage" />
                <uo k="s:originTrace" v="n:5094230315231765967" />
                <node concept="2OqwBi" id="16" role="37wK5m">
                  <uo k="s:originTrace" v="n:5094230315231765969" />
                  <node concept="2OqwBi" id="17" role="2Oq$k0">
                    <uo k="s:originTrace" v="n:5094230315231765970" />
                    <node concept="37vLTw" id="19" role="2Oq$k0">
                      <ref role="3cqZAo" node="P" resolve="tk" />
                      <uo k="s:originTrace" v="n:5094230315231765971" />
                    </node>
                    <node concept="1mfA1w" id="1a" role="2OqNvi">
                      <uo k="s:originTrace" v="n:5094230315231765972" />
                    </node>
                  </node>
                  <node concept="1mfA1w" id="18" role="2OqNvi">
                    <uo k="s:originTrace" v="n:5094230315231765973" />
                  </node>
                </node>
              </node>
            </node>
