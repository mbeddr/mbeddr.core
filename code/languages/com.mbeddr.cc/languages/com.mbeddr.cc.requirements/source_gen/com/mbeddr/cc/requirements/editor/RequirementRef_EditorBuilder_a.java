...
/*package*/ class RequirementRef_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RequirementRef_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createTooltip_0() {
    LazyTooltipCellEvaluator tooltip = new LazyTooltipCellEvaluator(getEditorContext(), myNode, "com.mbeddr.cc.requirements.editor.GeneratedHints.tooltipHint_b96nxa_a", true);
    ...
    editorCell.setCellId("Tooltip_b96nxa_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.target$hiva;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.req$z1Pv);
    ...
    provider.setEmptyCellId("empty_" + "req");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.target$hiva);
    }
    editorCell.setSubstituteInfo(new SReferenceSubstituteInfoSmartReferenceDecorator(new SReferenceSubstituteInfo(editorCell, referenceLink, CONCEPTS.Requirement$sS)));
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink req$z1Pv = MetaAdapterFactory.getReferenceLink(0xe865cad27cc8437aL, 0x951a665bcbcb8b1aL, 0x619a854eb41655dL, 0x619a854eb41655eL, "req");
  }
