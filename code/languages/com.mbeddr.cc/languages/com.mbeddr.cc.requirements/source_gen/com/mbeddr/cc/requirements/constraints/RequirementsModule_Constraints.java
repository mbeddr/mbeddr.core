...
public class RequirementsModule_Constraints extends BaseConstraintsDescriptor {
  /*package*/ RequirementsModule_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.RequirementsModule$Vm, initContext);
