...
public final class RequirementsClass__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> fixRequirementStructure_id3greo4ND9Kk = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("fixRequirementStructure").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3754657941423430676L).languageId(0x951a665bcbcb8b1aL, 0xe865cad27cc8437aL).build2(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
