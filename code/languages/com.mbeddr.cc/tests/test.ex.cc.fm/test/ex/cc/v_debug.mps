...
<model modelUID="r:6296b515-9bf6-44ff-b708-1b2e8fc471aa(test.ex.cc.v_debug)" version="0">
  ...
  <root id="2613872510229365740">
    ...
    <node role="configurationItems" roleId="vs0r.4459718605982007338" type=".com.mbeddr.cc.var.buildconfig.structure.VariabilityConfigItem" id="4055870397237244739">
      <node role="config" type=".com.mbeddr.cc.var.annotations.structure.VariabilityTransformationConfig" id="4055870397237244740">
        <node role="mappings" type=".com.mbeddr.cc.var.annotations.structure.ConfigurationMapping" id="4055870397237244742">
          <link role="featureModel" targetNodeId="n76k.6617704999132170930" resolveInfo="DeploymentConfiguration" />
          <link role="configurationModel" targetNodeId="n76k.6617704999132170935" resolveInfo="Debug" />
        </node>
      </node>
    </node>
  </root>
