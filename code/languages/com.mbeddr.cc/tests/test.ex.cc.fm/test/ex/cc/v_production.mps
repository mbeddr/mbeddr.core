...
<model modelUID="r:020d46e4-ad30-482a-a806-d503750dc47f(test.ex.cc.v_production)">
  ...
  <root id="6617704999132175007">
    ...
    <node role="configurationItems" roleId="vs0r.4459718605982007338" type=".com.mbeddr.cc.var.buildconfig.structure.VariabilityConfigItem" id="4055870397237244744">
      <node role="config" type=".com.mbeddr.cc.var.annotations.structure.VariabilityTransformationConfig" id="4055870397237244745">
        <node role="mappings" type=".com.mbeddr.cc.var.annotations.structure.ConfigurationMapping" id="4055870397237244746">
          <link role="featureModel" targetNodeId="n76k.6617704999132170930" resolveInfo="DeploymentConfiguration" />
          <link role="configurationModel" targetNodeId="n76k.6617704999132170939" resolveInfo="Production" />
        </node>
      </node>
    </node>
  </root>
