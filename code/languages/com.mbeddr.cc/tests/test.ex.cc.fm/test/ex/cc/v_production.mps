...
<model modelUID="r:020d46e4-ad30-482a-a806-d503750dc47f(test.ex.cc.v_production)">
  ...
  <root id="6617704999132175007">
    ...
    <node role="configurationItems" roleId="vs0r.4459718605982007338" type="rbly.VariabilityConfigItem" typeId="rbly.4055870397237196333" id="4055870397237244744">
      <node role="config" roleId="rbly.4055870397237196334" type="qdv7.VariabilityTransformationConfig" typeId="qdv7.6617704999132114004" id="4055870397237244745">
        <node role="mappings" roleId="qdv7.6617704999132114005" type="qdv7.ConfigurationMapping" typeId="qdv7.6617704999132114000" id="4055870397237244746">
