...
All notable changes to the mbeddr platform will be documented in this file.
...
- `com.mbeddr.mpsutil.editingGuide`: fixed tutorial image rendering and execution-mode editor issues (rendering shows immediately; re-opening a step no longer errors).
...
## com.mbeddr.core.base, com.mbeddr.mpsutil.hyperlink, com.mbeddr.mpsutil.editingGuide.execution, com.mbeddr.mpsutil.nodeaccess, com.mbeddr.mpsutil.traceExplorer
...
* Updated the platform languages to MPS version 2022.2.
