...
/*package*/ class DocumentedConceptAnnotation_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DocumentedConceptAnnotation_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_akrwo7_a");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_akrwo7_a0");
    DocumentedConceptAnnotation_ActionMap.setCellActions(editorCell, myNode, getEditorContext());
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_akrwo7_a0a");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_akrwo7_c0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.FONT_STYLE, MPSFonts.ITALIC);
    style.set(StyleAttributes.TEXT_COLOR, getStyleRegistry().getSimpleColor(MPSColors.DARK_GREEN));
    editorCell.getStyle().putAll(style);
