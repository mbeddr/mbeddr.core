...
import com.mbeddr.spreadsheat.behavior.Workbook__BehaviorDescriptor;
import org.apache.poi.xssf.usermodel.XSSFCellStyle;
import com.mbeddr.spreadsheat.behavior.Style__BehaviorDescriptor;
...
import com.mbeddr.spreadsheat.behavior.TextCell__BehaviorDescriptor;
...
public class QueriesGenerated extends QueryProviderBase {
        ...
        for (SNode row : ListSequence.fromList(SLinkOperations.getChildren(sheet, LINKS.rows$zoQ3))) {
          ...
          for (SNode cell : ListSequence.fromList(SLinkOperations.getChildren(row, LINKS.cells$zCRu))) {
            ...
            if (SNodeOperations.isInstanceOf(cell, CONCEPTS.TextCell$C0)) {
              ...
              if (TextCell__BehaviorDescriptor.getCellType_id1LnB5xdvClY.invoke(textcell) == SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0x1d891f7bdc9342f9L, 0xa4bcb016656b14e2L, 0x1c579c584d7e852eL, "com.mbeddr.spreadsheat.structure.TextCellType"), 0x1c579c584d7e8531L, "STRING")) {
                excelCell.setCellValue(SPropertyOperations.getString(textcell, PROPS.value$zLwC));
              }
              if (TextCell__BehaviorDescriptor.getCellType_id1LnB5xdvClY.invoke(textcell) == SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0x1d891f7bdc9342f9L, 0xa4bcb016656b14e2L, 0x1c579c584d7e852eL, "com.mbeddr.spreadsheat.structure.TextCellType"), 0x1c579c584d7e8530L, "NUMBER")) {
                excelCell.setCellValue(Double.parseDouble(SPropertyOperations.getString(textcell, PROPS.value$zLwC)));
              }
              if (TextCell__BehaviorDescriptor.getCellType_id1LnB5xdvClY.invoke(textcell) == SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0x1d891f7bdc9342f9L, 0xa4bcb016656b14e2L, 0x1c579c584d7e852eL, "com.mbeddr.spreadsheat.structure.TextCellType"), 0x1c579c584d7e852fL, "BOOLEAN")) {
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept TextCell$C0 = MetaAdapterFactory.getConcept(0x1d891f7bdc9342f9L, 0xa4bcb016656b14e2L, 0x1c579c584d7b9a60L, "com.mbeddr.spreadsheat.structure.TextCell");
    /*package*/ static final SConcept ColumnGroup$Tj = MetaAdapterFactory.getConcept(0x1d891f7bdc9342f9L, 0xa4bcb016656b14e2L, 0x1c579c584d7e8636L, "com.mbeddr.spreadsheat.structure.ColumnGroup");
    /*package*/ static final SConcept Workbook$uR = MetaAdapterFactory.getConcept(0x1d891f7bdc9342f9L, 0xa4bcb016656b14e2L, 0x1c579c584d7b9a32L, "com.mbeddr.spreadsheat.structure.Workbook");
  }
}
