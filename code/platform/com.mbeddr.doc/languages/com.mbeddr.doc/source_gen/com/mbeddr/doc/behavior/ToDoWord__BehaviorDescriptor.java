...
public final class ToDoWord__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static String getSnippet_id627_yy3Sp0O(@NotNull SNode __thisNode__) {
    return (String) Text__BehaviorDescriptor.asTextString_id3Q5enzfMT4l.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.text$qwxg));
  }

  /*package*/ ToDoWord__BehaviorDescriptor() {
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) ((String) getSnippet_id627_yy3Sp0O(node));
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
