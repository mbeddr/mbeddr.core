...
public class pasteToEmptyContent {
  ...
  /*package*/ static AbstractCellAction createAction_PASTE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        ...
        SNodeOperations.replaceWithAnother(node, paragraph);
        editorContext.flushEvents();

        EditorCell_Multiline textCell = (EditorCell_Multiline) as_4gi58d_a0a0a8a1a0a0a1(editorContext.getEditorComponent().findNodeCell(SLinkOperations.getTarget(paragraph, LINKS.text$tl4m)), EditorCell_Collection.class).firstCell();
        EditorCell_Word firstWordCell = as_4gi58d_a0a9a1a0a0a1(CellTraversalUtil.getFirstLeaf(textCell), EditorCell_Word.class);
  ...
  private static <T> T as_4gi58d_a0a0a8a1a0a0a1(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_4gi58d_a0a9a1a0a0a1(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
