...
public class DocRefWord_Constraints extends BaseConstraintsDescriptor {
  /*package*/ DocRefWord_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.DocRefWord$1F, initContext);
    record(new RD1(this));
  ...
  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.target$aemi, container, true, false);
    }
    @Nullable
    @Override
