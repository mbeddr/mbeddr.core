...
public final class TextBlockTableCell__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x2374bc907e3741f1L, 0xa9c4c2e35194c36aL, 0x504952297857eccaL, "com.mbeddr.doc.structure.TextBlockTableCell");
  ...
  /*package*/ static boolean containsText_idjpyKDg1onB(@NotNull SNode __thisNode__, String text) {
    return (boolean) TextBlock__BehaviorDescriptor.containsText_idjpyKDg1A7A.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.text$nnbM), text);
  }
  /*package*/ static String resultName_idjpyKDg1pW5(@NotNull SNode __thisNode__) {
    return (String) TextBlock__BehaviorDescriptor.asTextString_id6byLOcR3jNg.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.text$nnbM));
  }

  /*package*/ TextBlockTableCell__BehaviorDescriptor() {
  }
