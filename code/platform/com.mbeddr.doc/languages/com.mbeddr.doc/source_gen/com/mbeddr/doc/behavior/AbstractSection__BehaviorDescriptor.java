...
public final class AbstractSection__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> unfoldCloseChildren_id3RseghId_8J = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("unfoldCloseChildren").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4457500422381654575L).languageId(0xa9c4c2e35194c36aL, 0x2374bc907e3741f1L).build2(SMethodBuilder.createJavaParameter(EditorContext.class, ""), SMethodBuilder.createJavaParameter(Boolean.TYPE, ""));
