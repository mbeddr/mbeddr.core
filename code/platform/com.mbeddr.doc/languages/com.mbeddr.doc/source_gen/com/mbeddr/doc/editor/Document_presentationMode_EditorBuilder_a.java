...
/*package*/ class Document_presentationMode_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Document_presentationMode_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_jou1sl_a");
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new contentsListHandler_jou1sl_a0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_contents");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class contentsListHandler_jou1sl_a0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public contentsListHandler_jou1sl_a0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(contentsListHandler_jou1sl_a0.this.getNode(), LINKS.contents$e7kB));
      try {
    ...
    private EditorCell createConstant_0() {
      ...
      editorCell.setCellId("Constant_jou1sl_a0a");
