...
public final class FormattedText__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> asTextString_id6byLOcR3jNg = new SMethodBuilder<>(String.class).name("asTextString").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7125476651953896656L).languageId(0xa9c4c2e35194c36aL, 0x2374bc907e3741f1L).build2();
  public static final SMethod<Void> setText_id2en8HnCGqDy = new SMethodBuilder<>(Void.TYPE).name("setText").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2564556814938122850L).languageId(0xa9c4c2e35194c36aL, 0x2374bc907e3741f1L).build2(SMethodBuilder.createJavaParameter(String.class, "s"));
