...
/*package*/ class Document_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_7wjwco_b0a");
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "first chapter number");
    editorCell.setCellId("Constant_7wjwco_d0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, true);
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.chapterStartIndex$rjjE;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, true), myNode);
      editorCell.setDefaultText("no index");
      editorCell.setCellId("property_chapterStartIndex");
      editorCell.setSubstituteInfo(new SPropertySubstituteInfo(editorCell, property));
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(new IAttributeDescriptor.AllAttributes().list(myNode), CONCEPTS.PropertyAttribute$Gb);
      Iterable<SNode> currentPropertyAttributes = Sequence.fromIterable(propertyAttributes).where((it) -> Objects.equals(PropertyAttribute__BehaviorDescriptor.getProperty_id1avfQ4BBzOo.invoke(it), property));
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_7wjwco_f0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, true);
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new dependsOnListHandler_7wjwco_g0a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_dependsOn");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class dependsOnListHandler_7wjwco_g0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public dependsOnListHandler_7wjwco_g0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.dependsOn$QZv7;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.DocumentRef$zv;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(dependsOnListHandler_7wjwco_g0a.this.getNode(), LINKS.dependsOn$QZv7));
      try {
    ...
    private EditorCell createConstant_3() {
      ...
      editorCell.setCellId("Constant_7wjwco_a6a0");
      Style style = new StyleImpl();
  ...
  private EditorCell createConstant_4() {
    ...
    editorCell.setCellId("Constant_7wjwco_h0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, true);
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new authorsListHandler_7wjwco_i0a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_authors");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class authorsListHandler_7wjwco_i0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public authorsListHandler_7wjwco_i0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.authors$GNIE;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Author$CJ;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(authorsListHandler_7wjwco_i0a.this.getNode(), LINKS.authors$GNIE));
      try {
        EditorCell emptyCell = null;
    ...
    private EditorCell createConstant_5() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
      editorCell.setCellId("Constant_7wjwco_a8a0");
      Style style = new StyleImpl();
      style.set(StyleAttributes.EDITABLE, true);
      editorCell.getStyle().putAll(style);
      editorCell.setDefaultText("");
  ...
  private EditorCell createCustom_0() {
    ...
    editorCell.setCellId("Custom_7wjwco_b0");
    return editorCell;
  }
  ...
  private EditorCell createRefNodeList_2() {
    AbstractCellListHandler handler = new contentsListHandler_7wjwco_d0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_contents");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class contentsListHandler_7wjwco_d0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public contentsListHandler_7wjwco_d0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(contentsListHandler_7wjwco_d0.this.getNode(), LINKS.contents$e7kB));
      try {
        EditorCell emptyCell = null;
    ...
    private EditorCell createConstant_7() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
      editorCell.setCellId("Constant_7wjwco_a3a");
      Style style = new StyleImpl();
      style.set(StyleAttributes.EDITABLE, true);
      editorCell.getStyle().putAll(style);
      editorCell.setDefaultText("");
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept Author$CJ = MetaAdapterFactory.getConcept(0x2374bc907e3741f1L, 0xa9c4c2e35194c36aL, 0x1c2f4be3daaed62L, "com.mbeddr.doc.structure.Author");
