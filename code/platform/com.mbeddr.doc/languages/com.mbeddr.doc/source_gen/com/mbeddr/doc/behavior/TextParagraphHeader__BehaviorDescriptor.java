...
public final class TextParagraphHeader__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x2374bc907e3741f1L, 0xa9c4c2e35194c36aL, 0x47f6e109266c039eL, "com.mbeddr.doc.structure.TextParagraphHeader");
  ...
  /*package*/ static boolean containsText_idjpyKDg1onB(@NotNull SNode __thisNode__, String text) {
    return SPropertyOperations.getString(__thisNode__, PROPS.text$Lxji) != null && SPropertyOperations.getString(__thisNode__, PROPS.text$Lxji).contains(text);
  }
  /*package*/ static String resultName_idjpyKDg1pW5(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(__thisNode__, PROPS.text$Lxji);
  }

  /*package*/ TextParagraphHeader__BehaviorDescriptor() {
  }
