...
<language namespace="test.ts.mpsutil.multilingual.editor.sandbox" uuid="0eba8d68-ca0c-4113-a9e6-19b359352ecf" languageVersion="0" moduleVersion="0">
  <models>
  ...
  <facets>
    <facet type="java" compile="mps" classes="mps" ext="yes">
      ...
      <library location="${module}/resources/test.ts.mpsutil.multilingual.editor.sandbox.resources.jar" />
    </facet>
  </facets>
  <accessoryModels />
  <languageVersions>
  ...
  <dependencyVersions>
    ...
    <module reference="0eba8d68-ca0c-4113-a9e6-19b359352ecf(test.ts.mpsutil.multilingual.editor.sandbox)" version="0" />
  </dependencyVersions>
  <extendedLanguages />
</language>
