...
public final class PassWordFieldPreferenceFormProperty__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static void ___init___(@NotNull SNode __thisNode__) {
    SLinkOperations.setTarget(__thisNode__, LINKS.type$a1UY, _quotation_createNode_ktqjhb_a0a0a());
    SLinkOperations.setTarget(__thisNode__, LINKS.initializer$2twD, _quotation_createNode_ktqjhb_a0b0a());
  }

  /*package*/ static SNode getComponentType_id5C8n8D5Vy2T(@NotNull SNode __thisNode__) {
    return SNodeOperations.getNode("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:javax.swing(JDK/)", "~JPasswordField");
  }

  /*package*/ PassWordFieldPreferenceFormProperty__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_ktqjhb_a0a0a() {
  ...
  private static SNode _quotation_createNode_ktqjhb_a0b0a() {
    SNode quotedNode_1 = null;
