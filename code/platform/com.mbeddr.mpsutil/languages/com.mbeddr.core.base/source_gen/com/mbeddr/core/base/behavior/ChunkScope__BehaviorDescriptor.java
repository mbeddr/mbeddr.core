...
public final class ChunkScope__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static final SMethod<Iterable<SNode>> findElements_id69$E9O8syOu = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("findElements").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(7089977105793035550L).languageId(0xaa41d1b2bffa7eb1L, 0xd4280a54f6df4383L).build2();
  public static final SMethod<Boolean> requiresGrouping_id3DYDRw0SXyk = new SMethodBuilder<>(Boolean.TYPE).name("requiresGrouping").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4214990435118209172L).languageId(0xaa41d1b2bffa7eb1L, 0xd4280a54f6df4383L).build2();

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(findElements_id20N7CGtOl8_, findElements_id7nkDZJXluPi, findElements_id69$E9O8syOu, requiresGrouping_id3DYDRw0SXyk);
