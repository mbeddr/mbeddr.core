...
public final class CheckHashAssessmentResult__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xd4280a54f6df4383L, 0xaa41d1b2bffa7eb1L, 0xb30c524f880871eL, "com.mbeddr.core.base.structure.CheckHashAssessmentResult");
  ...
  /*package*/ static String uniqueIdentifier_idK292flwHwe(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.exref$B2WJ).getNodeId() + "";
  }
  /*package*/ static void updateValues_id5L$H31Kf5$y(@NotNull SNode __thisNode__, SNode updatedResult) {
  }

  /*package*/ CheckHashAssessmentResult__BehaviorDescriptor() {
  }
