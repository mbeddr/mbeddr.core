  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        SNode commentedCode = SLinkOperations.getTarget(node, LINKS.commentedCode$sS6E);
        SNodeOperations.replaceWithAnother(node, commentedCode);
        SelectionUtil.selectCell(editorContext, commentedCode, SelectionManager.FIRST_EDITABLE_CELL);
      }
