...
public final class Assessment__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> update_id3jNX2XuLy_p = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("update").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3815661793603627353L).languageId(0xaa41d1b2bffa7eb1L, 0xd4280a54f6df4383L).build2();
  public static final SMethod<Void> update_id4WjNWxKKBRM = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("update").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5698126413346012658L).languageId(0xaa41d1b2bffa7eb1L, 0xd4280a54f6df4383L).build2(SMethodBuilder.createJavaParameter(Project.class, ""));
  public static final SMethod<Void> clear_id3greo4NDQJp = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("clear").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3754657941423614937L).languageId(0xaa41d1b2bffa7eb1L, 0xd4280a54f6df4383L).build2();
