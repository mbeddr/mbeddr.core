...
public final class Assessment__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(update_id3jNX2XuLy_p, clear_id3greo4NDQJp, activeResultEntries_id3jNX2XuL9gI, allowEverythingExceptWhitespace_id8q0nkX_5K4);

  private static void ___init___(@NotNull SNode __thisNode__) {
  }

  /*package*/ static void update_id3jNX2XuLy_p(@NotNull SNode __thisNode__) {
    AssessmentQuery__BehaviorDescriptor.executeQuery_idK292flwJAp.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.query$gGFe), __thisNode__);
