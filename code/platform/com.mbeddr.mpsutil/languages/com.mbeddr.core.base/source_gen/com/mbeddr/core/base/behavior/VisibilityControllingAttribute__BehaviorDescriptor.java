...
public final class VisibilityControllingAttribute__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(isCurrentlyVisible_id5aNdPeN2Pp4);

  private static void ___init___(@NotNull SNode __thisNode__) {
  }


  /*package*/ VisibilityControllingAttribute__BehaviorDescriptor() {
  }
