...
public final class AssessmentScope__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(requiresGrouping_id3DYDRw0SXyk, findElements_id7nkDZJXluPi, findElements_id20N7CGtOl8_);
  ...
  /*package*/ static Iterable<SNode> findElements_id7nkDZJXluPi(@NotNull SNode __thisNode__, SModel currentModel) {
    throw new UnsupportedOperationException("Use findElements(Project, model)");
  }
