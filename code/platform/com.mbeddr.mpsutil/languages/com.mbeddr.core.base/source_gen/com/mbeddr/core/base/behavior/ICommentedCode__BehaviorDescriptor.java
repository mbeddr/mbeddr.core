...
public final class ICommentedCode__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> replaceWithGenericComment_id57qKfjsi03z = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("replaceWithGenericComment").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5898238819895345379L).languageId(0xaa41d1b2bffa7eb1L, 0xd4280a54f6df4383L).build2();
