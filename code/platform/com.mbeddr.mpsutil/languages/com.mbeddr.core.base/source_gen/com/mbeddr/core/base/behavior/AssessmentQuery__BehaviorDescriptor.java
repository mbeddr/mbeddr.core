...
public final class AssessmentQuery__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static void executeQuery_id4WjNWxKFbeJ(@NotNull SNode __thisNode__, @NotNull Project mpsProject, SNode assessment) {
    ...
    for (SNode newResult : ListSequence.fromList(AssessmentQuery__BehaviorDescriptor.runQuery_id4WjNWxKJWaq.invoke(__thisNode__, mpsProject))) {
  ...
  /*package*/ static List<SNode> runQuery_id7hIyKqbFNeu(@NotNull SNode __thisNode__) {
    throw new UnsupportedOperationException("runQuery(Project) should be overridden");
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 3:
        ...
        return null;
      case 4:
        executeQuery_id4WjNWxKFbeJ(node, (Project) parameters[0], (SNode) parameters[1]);
        return null;
      case 5:
