...
/*package*/ class DefaultGenericChunkDependency_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DefaultGenericChunkDependency_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_wnvs45_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, true);
    editorCell.getStyle().putAll(style);
    if (nodeCondition_wnvs45_a0a()) {
      editorCell.addEditorCell(createCollection_1());
    }
    editorCell.addEditorCell(createRefCell_0());
    if (nodeCondition_wnvs45_a2a()) {
      editorCell.addEditorCell(createConstant_0());
    }
    return editorCell;
  }
  private boolean nodeCondition_wnvs45_a0a() {
    return SLinkOperations.getTarget(myNode, LINKS.chunk$2d8c) != null;
  }
  private boolean nodeCondition_wnvs45_a2a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.reexport$dsPD);
  }
  private EditorCell createCollection_1() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_wnvs45_a0");
    Style style = new StyleImpl();
  ...
  private EditorCell createCustom_0() {
    AbstractCellProvider provider = ((_FunctionTypes._return_P0_E0<IconCell>) () -> new IconCell(SLinkOperations.getTarget(myNode, LINKS.chunk$2d8c), 3)).invoke();
    EditorCell editorCell = provider.createEditorCell(getEditorContext());
    editorCell.setCellId("Custom_wnvs45_a0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
    return editorCell;
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.chunk$2d8c;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.chunk$2d8c);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.chunk$2d8c);
    }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_wnvs45_c0");
    Style style = new StyleImpl();
    new KWStyleClass(this).apply(style, editorCell);
    editorCell.getStyle().putAll(style);
    deleteReexport.setCellActions(editorCell, myNode, getEditorContext());
