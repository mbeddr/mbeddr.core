...
public final class ChangeDescriptionModification__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf92af8d71fae4067L, 0x810917acf80f8e58L, 0x2d6d1f84511f8133L, "com.mbeddr.mpsutil.ccmenu.reftarget.structure.ChangeDescriptionModification");
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    return ListSequence.fromListAndArray(new ArrayList<SConcept>(), CONCEPTS.Parameter_TargetLink$xY, CONCEPTS.Parameter_conceptToCreate$p_);
  }
  /*package*/ static SNode getExpectedReturnType_idhEwIGRD(@NotNull SNode __thisNode__) {
    return _quotation_createNode_qn33wk_a0a2();
  }

  /*package*/ ChangeDescriptionModification__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_qn33wk_a0a2() {
