  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        ...
        EditorCell widthCell = editorContext.getEditorComponent().findNodeCell(SLinkOperations.getTarget(inlineFormat, LINKS.width$hZIq));
        EditorCell prevLeaf = CellTraversalUtil.getPrevLeaf(widthCell);
        ...
        SNodeOperations.deleteNode(SLinkOperations.getTarget(inlineFormat, LINKS.width$hZIq));
      }
