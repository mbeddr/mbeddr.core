  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        ...
        if (SNodeOperations.isInstanceOf(node, CONCEPTS.IFormatConversionFlag$53) && ListSequence.fromList(SLinkOperations.getChildren(inlineFormat, LINKS.flags$hZvp)).count() > 1) {
          SNodeOperations.deleteNode(node);
          return;
        }

        EditorCell flagCell = editorContext.getEditorComponent().findNodeCell(ListSequence.fromList(SLinkOperations.getChildren(inlineFormat, LINKS.flags$hZvp)).first());
        EditorCell prevLeaf = CellTraversalUtil.getPrevLeaf(flagCell);
        ...
        ListSequence.fromList(SLinkOperations.getChildren(inlineFormat, LINKS.flags$hZvp)).clear();
      }
