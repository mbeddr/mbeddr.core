...
public final class ConversionFlagAlwaysIncludeSign__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static boolean isApplicable_id6Go9U2yx_gX(@NotNull SNode __thisNode__, SNode conversion, SNode category, SNode expressionType) {
    if (SetSequence.fromSet(ConversionFlagBehaviorHelper.listIntegralCategories()).contains(category)) {
      if (TypeChecker.getInstance().getSubtypingManager().isSubtype(expressionType, _quotation_createNode_rokuwu_b0a0a0a0(), true)) {
  ...
  /*package*/ ConversionFlagAlwaysIncludeSign__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_rokuwu_b0a0a0a0() {
