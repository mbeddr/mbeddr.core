...
public final class ConversionFlagLeadingSpace__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static boolean isApplicable_id6Go9U2yx_gX(@NotNull SNode __thisNode__, SNode conversion, SNode category, SNode expressionType) {
    if (SetSequence.fromSet(ConversionFlagBehaviorHelper.listIntegralCategories()).contains(category)) {
      if (TypeChecker.getInstance().getSubtypingManager().isSubtype(expressionType, _quotation_createNode_buygnb_b0a0a0a1(), true)) {
  ...
  private static SNode _quotation_createNode_buygnb_b0a0a0a1() {
