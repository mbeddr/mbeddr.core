...
public final class FormatCategoryFloatingPointDouble__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x442d3b7dfe4a4293L, 0xa7c16744d440ecaaL, 0x6b1827a0a20aadc6L, "com.mbeddr.mpsutil.richstring.structure.FormatCategoryFloatingPointDouble");
  ...
  /*package*/ static Iterable<SNode> getApplicableTypes_id6Go9U2y2JzF(@NotNull SAbstractConcept __thisConcept__) {
    return ListSequence.fromListAndArray(new ArrayList<SNode>(), _quotation_createNode_dph3ud_a0a0a0(), _quotation_createNode_dph3ud_b0a0a0(), _quotation_createNode_dph3ud_c0a0a0(), _quotation_createNode_dph3ud_d0a0a0(), _quotation_createNode_dph3ud_e0a0a0());
  }
  /*package*/ static Iterable<SNode> getTypicalTypes_id6Go9U2y64Le(@NotNull SAbstractConcept __thisConcept__) {
    return ListSequence.fromListAndArray(new ArrayList<SNode>(), _quotation_createNode_dph3ud_a0a0a1(), _quotation_createNode_dph3ud_b0a0a1(), _quotation_createNode_dph3ud_c0a0a1(), _quotation_createNode_dph3ud_d0a0a1());
  }
  /*package*/ static Object getExampleObject_id6Go9U2y2SeO(@NotNull SAbstractConcept __thisConcept__) {
    return 31337.14159265359d;
  }
  ...
  /*package*/ FormatCategoryFloatingPointDouble__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_dph3ud_a0a0a0() {
  ...
  private static SNode _quotation_createNode_dph3ud_b0a0a0() {
    SNode quotedNode_1 = null;
  ...
  private static SNode _quotation_createNode_dph3ud_c0a0a0() {
    SNode quotedNode_1 = null;
  ...
  private static SNode _quotation_createNode_dph3ud_d0a0a0() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0x101de48bf9eL, "ClassifierType"));
    quotedNode_1 = nb.getResult();
  ...
  private static SNode _quotation_createNode_dph3ud_e0a0a0() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0x101de48bf9eL, "ClassifierType"));
    quotedNode_1 = nb.getResult();
  ...
  private static SNode _quotation_createNode_dph3ud_a0a0a1() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0xf940d327fdL, "FloatType"));
    quotedNode_1 = nb.getResult();
    return quotedNode_1;
  }
  private static SNode _quotation_createNode_dph3ud_b0a0a1() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0x101de48bf9eL, "ClassifierType"));
    quotedNode_1 = nb.getResult();
    nb.setReference(MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL, "classifier"), "6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.lang(JDK/)/~Float");
  ...
  private static SNode _quotation_createNode_dph3ud_c0a0a1() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0xf940d451a6L, "DoubleType"));
    quotedNode_1 = nb.getResult();
    return quotedNode_1;
  }
  private static SNode _quotation_createNode_dph3ud_d0a0a1() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0x101de48bf9eL, "ClassifierType"));
    quotedNode_1 = nb.getResult();
    nb.setReference(MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL, "classifier"), "6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.lang(JDK/)/~Double");
