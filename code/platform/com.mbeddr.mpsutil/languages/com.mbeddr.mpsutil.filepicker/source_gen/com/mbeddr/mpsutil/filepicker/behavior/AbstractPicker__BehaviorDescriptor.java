...
public final class AbstractPicker__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> mayBeEmpty_id2RM$2qudEJJ = new SMethodBuilder<>(Boolean.TYPE).name("mayBeEmpty").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3310867171608275951L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2();
  ...
  public static final SMethod<String> getPrefix_id5lKnBeAIfOh = new SMethodBuilder<>(String.class).name("getPrefix").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6156524541426859281L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2();
  ...
  public static final SMethod<String> findInstalledSolutionPrefix_id6WnTJkDU6W6 = new SMethodBuilder<>(String.class).name("findInstalledSolutionPrefix").modifiers(0, AccessPrivileges.PROTECTED).concept(CONCEPT).baseMethodId(8005120803318820614L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2(SMethodBuilder.createJavaParameter(SModel.class, "originalModel"));
  ...
  public static final SMethod<String> getOutputLocationRelativePath_id5Fmx6J52q6D = new SMethodBuilder<>(String.class).name("getOutputLocationRelativePath").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6545564706831704489L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2(SMethodBuilder.createJavaParameter(SModel.class, "originalModel"), SMethodBuilder.createJavaParameter(SNode.class, "outputLocationProvider"));
  public static final SMethod<String> getCanonicalPath_id5lKnBeAuKov = new SMethodBuilder<>(String.class).name("getCanonicalPath").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6156524541422798367L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2();
  public static final SMethod<String> getCanonicalPath_id35YirduUIVl = new SMethodBuilder<>(String.class).name("getCanonicalPath").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3566368989664440021L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2(SMethodBuilder.createJavaParameter(SModel.class, "originalModel"));
  public static final SMethod<String> getCanonicalPath_id5lKnBeAuiS4 = new SMethodBuilder<>(String.class).name("getCanonicalPath").modifiers(8, AccessPrivileges.PROTECTED).concept(CONCEPT).baseMethodId(6156524541422677508L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2(SMethodBuilder.createJavaParameter(String.class, "path"));
  public static final SMethod<String> getCanonicalPath_id35YirduUNg0 = new SMethodBuilder<>(String.class).name("getCanonicalPath").modifiers(8, AccessPrivileges.PROTECTED).concept(CONCEPT).baseMethodId(3566368989664457728L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2(SMethodBuilder.createJavaParameter(String.class, "path"), SMethodBuilder.createJavaParameter(SModel.class, "originalModel"));
  public static final SMethod<String> getNonCanonicalPath_id2_BfG8PE78n = new SMethodBuilder<>(String.class).name("getNonCanonicalPath").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2983422282001052183L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2();
  public static final SMethod<String> getNonCanonicalPath_id2_BfG8PE9Jr = new SMethodBuilder<>(String.class).name("getNonCanonicalPath").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2983422282001062875L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2(SMethodBuilder.createJavaParameter(SModel.class, "originalModel"));
  public static final SMethod<String> getNonCanonicalPath_id7c_RIoAVXmk = new SMethodBuilder<>(String.class).name("getNonCanonicalPath").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8297282968577103252L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2(SMethodBuilder.createJavaParameter(String.class, "path"));
  public static final SMethod<String> getNonCanonicalPath_id35YirduUTni = new SMethodBuilder<>(String.class).name("getNonCanonicalPath").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3566368989664482770L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2(SMethodBuilder.createJavaParameter(String.class, "path"), SMethodBuilder.createJavaParameter(SModel.class, "originalModel"));
  public static final SMethod<String> resolvePath_id4_vItr5cCkz = new SMethodBuilder<>(String.class).name("resolvePath").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5287148819638813987L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2(SMethodBuilder.createJavaParameter(String.class, "path"));
  public static final SMethod<String> resolvePath_id35YirduUVCr = new SMethodBuilder<>(String.class).name("resolvePath").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3566368989664492059L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2(SMethodBuilder.createJavaParameter(String.class, "path"), SMethodBuilder.createJavaParameter(SModel.class, "originalModel"));
  public static final SMethod<Boolean> exists_id5lKnBeAtTZu = new SMethodBuilder<>(Boolean.TYPE).name("exists").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6156524541422575582L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2();
  public static final SMethod<Boolean> isValidFile_id5lKnBeAufga = new SMethodBuilder<>(Boolean.TYPE).name("isValidFile").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6156524541422662666L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2();
  public static final SMethod<Boolean> isValidDirectory_id5lKnBeAuiv7 = new SMethodBuilder<>(Boolean.TYPE).name("isValidDirectory").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6156524541422675911L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2();
  public static final SMethod<List<String>> proposals_id5lKnBeAuxBd = new SMethodBuilder<>((Class<List<String>>) ((Class) Object.class)).name("proposals").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6156524541422737869L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2();
  public static final SMethod<Boolean> editWithSystemEditor_id2HwAvL$nzbX = new SMethodBuilder<>(Boolean.TYPE).name("editWithSystemEditor").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3125667450689827581L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2();
  public static final SMethod<Boolean> openWithSystemEditor_id2HwAvL$nEXJ = new SMethodBuilder<>(Boolean.TYPE).name("openWithSystemEditor").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3125667450689859439L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2();
  public static final SMethod<Boolean> openWithSystemFileExplorer_id6uhyUqXhg1F = new SMethodBuilder<>(Boolean.TYPE).name("openWithSystemFileExplorer").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7462899605785870443L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2();
  public static final SMethod<SNode> getCompanionFileOrFolderPicker_id3xqp6yeWGLu = new SMethodBuilder<>(SNode.class).name("getCompanionFileOrFolderPicker").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4060668414265576542L).languageId(0x900e10444ddfed52L, 0xd3a0fd26445a466cL).build2();
