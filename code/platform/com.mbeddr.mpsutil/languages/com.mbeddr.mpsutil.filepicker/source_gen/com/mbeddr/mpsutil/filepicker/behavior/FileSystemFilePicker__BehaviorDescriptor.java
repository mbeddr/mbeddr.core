...
public final class FileSystemFilePicker__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xd3a0fd26445a466cL, 0x900e10444ddfed52L, 0x14e00b5befb780d2L, "com.mbeddr.mpsutil.filepicker.structure.FileSystemFilePicker");
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(mustExist_id2RM$2quh1HO, pickDirOnly_id5lKnBeB0qXj, pickFileOnly_id48DzgHgr2tO, getErrorMessage_id5lKnBeAutg0, getCompanionFileOrFolderPicker_id3xqp6yeWGLu);
  ...
  /*package*/ static String getErrorMessage_id5lKnBeAutg0(@NotNull SNode __thisNode__) {
    return "not a valid absolute file path";
  }
  /*package*/ static SNode getCompanionFileOrFolderPicker_id3xqp6yeWGLu(@NotNull SNode __thisNode__) {
    SNode picker = SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0xd3a0fd26445a466cL, 0x900e10444ddfed52L, 0x43bdbc6ab482e997L, "com.mbeddr.mpsutil.filepicker.structure.FileSystemDirPicker"));
    SPropertyOperations.assign(picker, PROPS.path$VaYg, SPropertyOperations.getString(__thisNode__, PROPS.path$VaYg));
    return picker;
  }

  /*package*/ FileSystemFilePicker__BehaviorDescriptor() {
  }
