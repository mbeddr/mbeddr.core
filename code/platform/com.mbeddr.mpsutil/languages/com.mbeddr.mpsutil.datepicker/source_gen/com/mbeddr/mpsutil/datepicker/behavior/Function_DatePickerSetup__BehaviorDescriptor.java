...
public final class Function_DatePickerSetup__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xfb1561dd216d4cd5L, 0x9cd85d1dc9d20bcfL, 0x25ee2bf1d281d4a5L, "com.mbeddr.mpsutil.datepicker.structure.Function_DatePickerSetup");
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    return ListSequence.fromListAndArray(new ArrayList<SConcept>(), CONCEPTS.Parameter_DatePickerConfig$hX, CONCEPTS.ConceptFunctionParameter_node$zM, CONCEPTS.ConceptFunctionParameter_editorContext$vJ);
  }

  /*package*/ Function_DatePickerSetup__BehaviorDescriptor() {
  }
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept Parameter_DatePickerConfig$hX = MetaAdapterFactory.getConcept(0xfb1561dd216d4cd5L, 0x9cd85d1dc9d20bcfL, 0x25ee2bf1d281d4a9L, "com.mbeddr.mpsutil.datepicker.structure.Parameter_DatePickerConfig");
