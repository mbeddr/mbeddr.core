...
public final class IconChar__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> init_id3TQBmq3qB5f = new SMethodBuilder<>(Void.TYPE).name("init").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4500957941220405583L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2();
  public static final SMethod<Void> setDefaultValues_id3TQBmq3qBde = new SMethodBuilder<>(Void.TYPE).name("setDefaultValues").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4500957941220406094L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2();
  public static final SMethod<Void> setIconPath_id3TQBmq3p9ZJ = new SMethodBuilder<>(Void.TYPE).name("setIconPath").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4500957941220024303L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2();
  public static final SMethod<SNode> getConceptDeclaration_id3TQBmq3qpDT = new SMethodBuilder<>(SNode.class).name("getConceptDeclaration").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4500957941220350585L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2();
  public static final SMethod<String> concatIconFileName_id3TQBmq3qtXH = new SMethodBuilder<>(String.class).name("concatIconFileName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4500957941220368237L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2();
  public static final SMethod<File> getIconFile_id3TQBmq3qdeX = new SMethodBuilder<>(File.class).name("getIconFile").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4500957941220299709L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2();
  public static final SMethod<File> getIconFile_id3TQBmq3rnNb = new SMethodBuilder<>(File.class).name("getIconFile").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4500957941220605131L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2(SMethodBuilder.createJavaParameter(AbstractModule.class, "abstractModule"));
  public static final SMethod<BufferedImage> createIconImage_id5L7BF$C77MJ = new SMethodBuilder<>(BufferedImage.class).name("createIconImage").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6649457892914920623L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2();
  public static final SMethod<Void> writeIconImage_id5L7BF$C8g1T = new SMethodBuilder<>(Void.TYPE).name("writeIconImage").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6649457892915216505L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2(SMethodBuilder.createJavaParameter(BufferedImage.class, "bi"), SMethodBuilder.createJavaParameter(AbstractModule.class, "abstractModule"));
  public static final SMethod<Void> setGraphicsHints_id608oBgqv2dI = new SMethodBuilder<>(Void.TYPE).name("setGraphicsHints").modifiers(0, AccessPrivileges.PROTECTED).concept(CONCEPT).baseMethodId(6919889078254838638L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2(SMethodBuilder.createJavaParameter(Graphics2D.class, "g"));
  public static final SMethod<BufferedImage> createCharImage_id5L7BF$C6Jgf = new SMethodBuilder<>(BufferedImage.class).name("createCharImage").modifiers(0, AccessPrivileges.PROTECTED).concept(CONCEPT).baseMethodId(6649457892914820111L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2(SMethodBuilder.createJavaParameter(Integer.TYPE, "widthCharImage"), SMethodBuilder.createJavaParameter(Integer.TYPE, "heightCharImage"), SMethodBuilder.createJavaParameter(Double.TYPE, "desiredCharWidth"), SMethodBuilder.createJavaParameter(Double.TYPE, "desiredCharHeight"));
  public static final SMethod<Integer> findCharMinX_id5L7BF$C6PQd = new SMethodBuilder<>(Integer.TYPE).name("findCharMinX").modifiers(0, AccessPrivileges.PROTECTED).concept(CONCEPT).baseMethodId(6649457892914847117L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2(SMethodBuilder.createJavaParameter(Integer.TYPE, "widthCharImage"), SMethodBuilder.createJavaParameter(Integer.TYPE, "heightCharImage"), SMethodBuilder.createJavaParameter(BufferedImage.class, "charImage"));
  public static final SMethod<Integer> findCharMaxX_id5L7BF$C6W0S = new SMethodBuilder<>(Integer.TYPE).name("findCharMaxX").modifiers(0, AccessPrivileges.PROTECTED).concept(CONCEPT).baseMethodId(6649457892914872376L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2(SMethodBuilder.createJavaParameter(Integer.TYPE, "widthCharImage"), SMethodBuilder.createJavaParameter(Integer.TYPE, "heightCharImage"), SMethodBuilder.createJavaParameter(BufferedImage.class, "charImage"));
  public static final SMethod<Integer> findCharMinY_id5L7BF$C6TaA = new SMethodBuilder<>(Integer.TYPE).name("findCharMinY").modifiers(0, AccessPrivileges.PROTECTED).concept(CONCEPT).baseMethodId(6649457892914860710L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2(SMethodBuilder.createJavaParameter(Integer.TYPE, "widthCharImage"), SMethodBuilder.createJavaParameter(Integer.TYPE, "heightCharImage"), SMethodBuilder.createJavaParameter(BufferedImage.class, "charImage"));
  public static final SMethod<Integer> findCharMaxY_id5L7BF$C6X6A = new SMethodBuilder<>(Integer.TYPE).name("findCharMaxY").modifiers(0, AccessPrivileges.PROTECTED).concept(CONCEPT).baseMethodId(6649457892914876838L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2(SMethodBuilder.createJavaParameter(Integer.TYPE, "widthCharImage"), SMethodBuilder.createJavaParameter(Integer.TYPE, "heightCharImage"), SMethodBuilder.createJavaParameter(BufferedImage.class, "charImage"));
  public static final SMethod<Boolean> isPixelUsed_id608oBgqljgu = new SMethodBuilder<>(Boolean.TYPE).name("isPixelUsed").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6919889078252287006L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2(SMethodBuilder.createJavaParameter(BufferedImage.class, "img"), SMethodBuilder.createJavaParameter(Integer.TYPE, "x"), SMethodBuilder.createJavaParameter(Integer.TYPE, "y"));
  public static final SMethod<Color> getTransparentColor_id5L7BF$C6GwK = new SMethodBuilder<>(Color.class).name("getTransparentColor").modifiers(1, AccessPrivileges.PROTECTED).concept(CONCEPT).baseMethodId(6649457892914808880L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2();
