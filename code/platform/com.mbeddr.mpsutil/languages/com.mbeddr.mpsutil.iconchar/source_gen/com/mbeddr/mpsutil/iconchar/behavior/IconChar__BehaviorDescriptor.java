...
public final class IconChar__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> init_id3TQBmq3qB5f = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("init").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4500957941220405583L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2();
  public static final SMethod<Void> setDefaultValues_id3TQBmq3qBde = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("setDefaultValues").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4500957941220406094L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2();
  public static final SMethod<Void> setIconPath_id3TQBmq3p9ZJ = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("setIconPath").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4500957941220024303L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2();
  ...
  public static final SMethod<Void> writeIconImage_id5L7BF$C8g1T = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("writeIconImage").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6649457892915216505L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2(SMethodBuilder.createJavaParameter(BufferedImage.class, ""), SMethodBuilder.createJavaParameter(AbstractModule.class, ""));
  public static final SMethod<Void> setGraphicsHints_id608oBgqv2dI = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("setGraphicsHints").modifiers(0, AccessPrivileges.PROTECTED).concept(CONCEPT).baseMethodId(6919889078254838638L).languageId(0xb3b4eca3f222d4daL, 0xe840b8ae64d94b5bL).build2(SMethodBuilder.createJavaParameter(Graphics2D.class, ""));
