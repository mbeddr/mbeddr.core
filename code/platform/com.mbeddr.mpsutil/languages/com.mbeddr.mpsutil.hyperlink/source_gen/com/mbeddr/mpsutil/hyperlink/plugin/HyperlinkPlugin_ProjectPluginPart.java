...
public class HyperlinkPlugin_ProjectPluginPart extends ProjectPluginPart {
  ...
  public void init(MPSProject project) {
    ...
    check_vp7zbg_a1a0(check_vp7zbg_a0b0a(ProjectHelper.toIdeaProject(project)), extension);
  ...
  public void dispose(MPSProject project) {
    EditorExtension extension = HyperlinkPlugin_ProjectPluginPart.this.extension;
    check_vp7zbg_a1a0_0(check_vp7zbg_a0b0a_0(ProjectHelper.toIdeaProject(project)), extension);
  ...
  private static EditorExtensionRegistry check_vp7zbg_a0b0a(Project checkedDotOperand) {
    if (null != checkedDotOperand) {
  ...
  private static EditorExtensionRegistry check_vp7zbg_a0b0a_0(Project checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getComponent(EditorExtensionRegistry.class);
    }
    return null;
