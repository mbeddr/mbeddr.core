...
public final class Exercise__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> nextTask_id4TMjSvbGeWs = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("nextTask").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5652667926959943452L).languageId(0xa8e6bc7837e9e11fL, 0x67506b1e43ad47feL).build2();
