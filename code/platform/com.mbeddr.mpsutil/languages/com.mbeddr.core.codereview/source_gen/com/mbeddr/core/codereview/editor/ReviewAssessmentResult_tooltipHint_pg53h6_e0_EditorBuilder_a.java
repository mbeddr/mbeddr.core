...
/*package*/ class ReviewAssessmentResult_tooltipHint_pg53h6_e0_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ReviewAssessmentResult_tooltipHint_pg53h6_e0_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_rvqlzl_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    try {
      getCellFactory().pushCellContext();
      getCellFactory().removeCellContextHints(new String[]{"com.mbeddr.core.codereview.editor.GeneratedHints.tooltipHint_pg53h6_e0"});
  ...
  private EditorCell createQueryList_0() {
    ...
    QueryListHandler handler = new QueryListHandler_rvqlzl_a0(getEditorContext(), getNode(), true);
    ...
    editorCell.setCellId("QueryList_rvqlzl_a0");
  ...
  private static class QueryListHandler_rvqlzl_a0 extends QueryListHandler {
    /**
     * allows node access in the query with ConceptFunctionParameter_node
     */
    private SNode myNode;
    public QueryListHandler_rvqlzl_a0(EditorContext context, SNode ownerNode, boolean readOnly) {
    ...
    private Object executeQuery(final SNode node, final EditorContext editorContext) {
      return SLinkOperations.getTarget(myNode, LINKS.code$K9BJ);
    }
    @Override
    ...
    protected EditorCell createNodeCellNotNull(final EditorContext context, @NotNull final SNode node) {
      ...
      try {
        ...
        cell = createCellDuplicatesSafe(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateReferencedNodeCell(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateChildNodeCell(node), node, new DummyReferenceLink("querylist4214990435117851992")));
      } finally {
        getCellFactory().popCellContext();
      }
      return cell;
