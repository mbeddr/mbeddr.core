...
public final class RemoveAction__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xc38abce14c0944cbL, 0x9ebf2a764e824bb5L, 0x5aef4be6d5b99999L, "com.mbeddr.mpsutil.actionsfilter.structure.RemoveAction");
  ...
  /*package*/ static boolean refersToActionId_id5ReuVUpdzR3(@NotNull SNode __thisNode__, String id) {
    return id != null && id.equals(SPropertyOperations.getString(__thisNode__, PROPS.actionId$GUAt));
  }

  /*package*/ RemoveAction__BehaviorDescriptor() {
  }
