...
/*package*/ class ConceptIdRefExpression_UniqueNames_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ConceptIdRefExpression_UniqueNames_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_3pmg2u_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    if (nodeCondition_3pmg2u_a0a()) {
  ...
  private boolean nodeCondition_3pmg2u_a0a() {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_3pmg2u_a0");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_3pmg2u_b0");
    Style style = new StyleImpl();
    new EditorKeyWordStyleClass(this).apply(style, editorCell);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_3pmg2u_c0");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefCell_1() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder1(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.conceptDeclaration$l13w);
        CellUtil.setupIDeprecatableStyles(targetNode, cell);
        setSemanticNodeToCells(cell, getNode());
        installDeleteActions_notnull(cell);
        return cell;
  ...
  private EditorCell createConstant_3() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "/");
    editorCell.setCellId("Constant_3pmg2u_f0");
    Style style = new StyleImpl();
