...
/*package*/ class ConceptNodeType_UniqueNames_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ConceptNodeType_UniqueNames_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_kquzvs_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_kquzvs_a0");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_kquzvs_b0");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefCell_1() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder1(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.conceptDeclaraton$Pc1V);
        CellUtil.setupIDeprecatableStyles(targetNode, cell);
        setSemanticNodeToCells(cell, getNode());
        installDeleteActions_nullable_reference(cell);
        return cell;
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ">");
    editorCell.setCellId("Constant_kquzvs_e0");
    Style style = new StyleImpl();
