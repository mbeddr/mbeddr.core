...
public class StyleClassItem_MakeUserConfigurable extends IntentionsFactory {
  public StyleClassItem_MakeUserConfigurable() {
  }
  ...
  private SNodePointer implementationNode = new SNodePointer("r:ce9b23f9-5c4e-478f-aa73-a04bc92698ce(com.mbeddr.mpsutil.userstyles.intentions)", "8170319964141072632");
  ...
  public Collection<NodeTransformer> getTreeTransformers(SNode node, SNode child, EditorContext editorContext) {
    ...
    CollectionSequence.fromCollection(result).addElement(new BaseNodeTransformer(this, node, editorContext, NodeTransformer.Kind.INTENTION, implementationNode) {
      protected void execute(SNode node, EditorContext editorContext) {
        StyleClassItem_MakeUserConfigurable.this.execute(node, editorContext);
      }
      protected String getDescription(SNode node, EditorContext editorContext) {
        return StyleClassItem_MakeUserConfigurable.this.description(node, editorContext);
      }
    });
    return result;
  }
