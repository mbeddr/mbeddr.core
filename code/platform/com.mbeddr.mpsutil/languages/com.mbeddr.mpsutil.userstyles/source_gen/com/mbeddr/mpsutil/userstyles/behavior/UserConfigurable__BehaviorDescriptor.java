...
public final class UserConfigurable__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x62a3babb5d404920L, 0x897fd4144dc99c9dL, 0x7162ceb81be6536dL, "com.mbeddr.mpsutil.userstyles.structure.UserConfigurable");
  ...
  /*package*/ static SNode getFor_id1gJuyfgBEVW(@NotNull SAbstractConcept __thisConcept__, SNode styleItem) {
    return ((SNode) UserConfigurable__BehaviorDescriptor.getForClass_idVx4CqFL0da.invoke(__thisConcept__, SNodeOperations.getNodeAncestor(styleItem, CONCEPTS.StyleClass$_L, false, false)));
  }
  /*package*/ static SNode getForClass_idVx4CqFL0da(@NotNull SAbstractConcept __thisConcept__, SNode styleClass) {
    return ListSequence.fromList(SNodeOperations.getNodeAncestors(styleClass, CONCEPTS.StyleClass$_L, true)).select((it) -> new IAttributeDescriptor.NodeAttribute(CONCEPTS.UserConfigurable$b0).get(it)).findFirst((it) -> (it != null));
  }

  /*package*/ UserConfigurable__BehaviorDescriptor() {
  }
