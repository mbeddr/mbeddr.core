...
public class GraphUtil_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCache(GraphUtil_Test.class, "${mbeddr.github.core.home}/code/platform/com.mbeddr.mpsutil", "r:a68423c3-5b3b-473a-89a3-7910cb495020(com.mbeddr.mpsutil.common.graphTest@tests)", false));
