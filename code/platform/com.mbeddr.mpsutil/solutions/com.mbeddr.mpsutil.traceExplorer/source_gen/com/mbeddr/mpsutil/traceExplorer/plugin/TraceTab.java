...
public class TraceTab extends SimpleToolWindowPanel {
  ...
  protected class ClearTraceInformationFromCodeAction extends AnAction {
  ...
  protected class NavDownAction extends AnAction {
  ...
  protected class FilterAction extends AnAction {
    public FilterAction() {
  ...
  protected class HighlightCodeAction extends ToggleActionButton {
    public HighlightCodeAction() {
      super("Highlight in Editor", AllIcons.Actions.Annotate);
    }
    @Override
  ...
  protected class GoToSourceAction extends AnAction {
  ...
  protected class ExpandAll extends AnAction {
    public ExpandAll() {
  ...
  protected class ExpandAsSaved extends AnAction {
  ...
  protected class CollapseAll extends AnAction {
    public CollapseAll() {
  ...
  protected class RerunTraceAction extends AnAction {
