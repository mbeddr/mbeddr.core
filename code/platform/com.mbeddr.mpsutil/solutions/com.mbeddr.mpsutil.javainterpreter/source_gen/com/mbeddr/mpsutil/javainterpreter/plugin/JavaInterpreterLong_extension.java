...
public class JavaInterpreterLong_extension extends Extension.Default<IInterpreter> {
  public JavaInterpreterLong_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterJavaInterpreterLong();
  }
}
