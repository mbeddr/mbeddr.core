...
public class JavaInterpreterStatement_extension extends Extension.Default<IInterpreter> {
  public JavaInterpreterStatement_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterJavaInterpreterStatement();
  }
}
