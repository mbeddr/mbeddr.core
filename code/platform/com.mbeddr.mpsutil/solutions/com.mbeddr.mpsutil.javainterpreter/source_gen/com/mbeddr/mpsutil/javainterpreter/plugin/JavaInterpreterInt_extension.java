...
public class JavaInterpreterInt_extension extends Extension.Default<IInterpreter> {
  public JavaInterpreterInt_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterJavaInterpreterInt();
  }
}
