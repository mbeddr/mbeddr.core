...
public class JavaInterpreterString_extension extends Extension.Default<IInterpreter> {
  public JavaInterpreterString_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterJavaInterpreterString();
  }
}
