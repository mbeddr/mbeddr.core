...
public class JavaInterpreterFloat_extension extends Extension.Default<IInterpreter> {
  public JavaInterpreterFloat_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterJavaInterpreterFloat();
  }
}
