...
public class JavaInterpreterMethod_extension extends Extension.Default<IInterpreter> {
  public JavaInterpreterMethod_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterJavaInterpreterMethod();
  }
}
