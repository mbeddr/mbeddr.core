...
public class JavaInterpreterBoolean_extension extends Extension.Default<IInterpreter> {
  public JavaInterpreterBoolean_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterJavaInterpreterBoolean();
  }
}
