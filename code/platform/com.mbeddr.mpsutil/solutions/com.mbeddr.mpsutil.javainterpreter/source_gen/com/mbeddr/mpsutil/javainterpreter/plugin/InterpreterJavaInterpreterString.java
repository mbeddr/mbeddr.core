  ...
  protected void populateEvaluators(List<? extends IEvaluator> evaluators) {
    ListSequence.fromList(((List<IEvaluator>) evaluators)).addElement(new ConceptEvaluatorBase(CONCEPTS.StringLiteral$xu, "r:6de0fec9-28ce-4092-a00d-c37c6ae81d03(com.mbeddr.mpsutil.javainterpreter.plugin)/902624672044062200", true) {
      ...
      public EvaluatorInfo getInfo() {
        return new EvaluatorInfo("StringLiteral", "http://127.0.0.1:63320/node?ref=79c46783-73d8-4d0c-bc49-d408e326d24f%2Fi%3A10000001%28com.mbeddr.mpsutil.javainterpreter%40transient128%2Fcom.mbeddr.mpsutil.javainterpreter.plugin%400%29%2F902624672044062200");
      }
    ...
    ListSequence.fromList(((List<IEvaluator>) evaluators)).addElement(new ConceptEvaluatorBase(CONCEPTS.PlusExpression$k0, "r:6de0fec9-28ce-4092-a00d-c37c6ae81d03(com.mbeddr.mpsutil.javainterpreter.plugin)/902624672044063504", true, new TypedChildConstraintImpl(LINKS.leftExpression$sEj, SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(CONCEPTS.StringType$uX)))) {
      ...
      public EvaluatorInfo getInfo() {
        return new EvaluatorInfo("PlusExpression", "http://127.0.0.1:63320/node?ref=79c46783-73d8-4d0c-bc49-d408e326d24f%2Fi%3A10000001%28com.mbeddr.mpsutil.javainterpreter%40transient128%2Fcom.mbeddr.mpsutil.javainterpreter.plugin%400%29%2F902624672044063504");
      }
