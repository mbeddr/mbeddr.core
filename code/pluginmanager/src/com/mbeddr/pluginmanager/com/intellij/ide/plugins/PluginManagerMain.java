...
import com.mbeddr.pluginmanager.com.intellij.ide.plugins.sorters.SortByStatusAction;
...
public abstract class PluginManagerMain implements Disposable {
  ...
  protected PluginManagerUISettings_mbeddr myUISettings;
  private boolean myDisposed = false;
  private boolean myBusy = false;

  public PluginManagerMain(
    PluginManagerUISettings_mbeddr uiSettings) {
  ...
  public static boolean downloadPlugins(final List<PluginNode> plugins,
    ...
    try {
      ProgressManager.getInstance().run(new Task.Backgroundable(null, IdeBundle.message("progress.download.plugins"), true, PluginManagerUISettings_mbeddr.getInstance()) {
        @Override
